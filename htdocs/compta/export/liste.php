 ...
 *
 * $Id: liste.php,v 1.8 2007/06/16 13:56:09 eldy Exp $
...
if ($result)
{
	...
	while ($i < min($num,$conf->liste_limit))
	{
		...
		print '<td><a href="index.php?action=export&amp;type=rebuild&amp;id='.$obj->rowid.'">'.$langs->trans("ReBuild").'</a></td>';
		print "</tr>\n";
		$i++;
	}
	print "</table>";
...
llxFooter('$Date: 2007/06/16 13:56:09 $ - $Revision: 1.8 $');
?>
