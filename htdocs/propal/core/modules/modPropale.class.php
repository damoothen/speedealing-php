...
//        $this->rights[$r][5] = 'send';
        ...
        $this->menus[$r]->_id = "menu:propale";
        $this->menus[$r]->type = "top";
        $this->menus[$r]->position = 79;
        $this->menus[$r]->langs = "propal";
        $this->menus[$r]->perms = '$user->rights->propale->lire';
        $this->menus[$r]->enabled = '$conf->propale->enabled';
        ...
        $this->menus[$r]->langs = "propal";
        $this->menus[$r]->perms = '$user->rights->propale->creer';
        $this->menus[$r]->enabled = '$conf->propale->enabled';
        $this->menus[$r]->usertype = 2;
        $this->menus[$r]->title = "NewPropal";
        $this->menus[$r]->fk_menu = "menu:propale";
        $r++;
