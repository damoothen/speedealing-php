...
if ($action == 'specimen') {
	...
	foreach ($dirmodels as $reldir) {
		$file = dol_buildpath($reldir . "propal/core/modules/propale/doc/pdf_" . $modele . ".modules.php");
		if (file_exists($file)) {
			$filefound = 1;
...
foreach ($dirmodels as $reldir) {
	$dir = dol_buildpath($reldir . "propal/core/modules/propale/");
...
foreach ($dirmodels as $reldir) {
	foreach (array('', '/doc') as $valdir) {
		$dir = dol_buildpath($reldir . "propal/core/modules/propale" . $valdir);
