...
class modPayBox extends DolibarrModules {
	...
	function modPayBox($db) {
		...
		$this->values->numero = 50000;
		// Key text used to identify module (for permissions, menus, etc...)
		$this->values->rights_class = 'paybox';
		...
		$this->values->description = "Module to offer an online payment page by credit card with PayBox";
		...
		$this->values->picto = 'paybox@paybox';

		// Data directories to create when module is enabled.
		$this->values->dirs = array('/paybox/temp');

		// Config pages. Put here list of php page names stored in admmin directory used to setup module.
		$this->values->config_page_url = array("paybox.php@paybox");
		...
		$this->values->need_dolibarr_version = array(2, 6); // Minimum version of Dolibarr required by module
		$this->values->langfiles = array("paybox");
	...
	function load_tables() {
		return $this->values->_load_tables('');
	}
