...
class modSociete extends DolibarrModules {
	...
	function modSociete($db) {
		...
		// Dependances
		$this->depends = array();
		$this->requiredby = array("Expedition", "Facture", "Fournisseur", "Ficheinter", "Propale", "Contrat", "Commande");
...
*/
		...
		$this->menus[$r]->url = "/societe/index.php";
		...
		$this->menus[$r]->url = "/comm/list.php";
		$this->menus[$r]->langs = "companies";
		...
		$this->menus[$r]->enabled = '$conf->societe->enabled';
		$this->menus[$r]->usertype = 2;
		$this->menus[$r]->title = 'ContactsAddresses||Contacts@$conf->global->SOCIETE_ADDRESSES_MANAGEMENT';
		$this->menus[$r]->fk_menu = "menu:companies";
		$r++;
		$this->menus[$r]->_id = "menu:newcontactaddress";
		$this->menus[$r]->url = "/contact/fiche.php?action=create";
		$this->menus[$r]->langs = "companies";
		$this->menus[$r]->perms = '$user->rights->societe->creer';
		$this->menus[$r]->enabled = '$conf->societe->enabled';
		$this->menus[$r]->usertype = 2;
		$this->menus[$r]->title = 'NewContactAddress||NewContact@$conf->global->SOCIETE_ADDRESSES_MANAGEMENT';
		$this->menus[$r]->fk_menu = "menu:contactsaddresses";
		$r++;
		...
		$this->menus[$r]->fk_menu = "menu:contactsaddresses";
		$r++;
		$this->menus[$r]->_id = "menu:menunewthirdparty";
