...
class modCategorie extends DolibarrModules {
	...
	function modCategorie($db) {
		...
		// Menus
		$r = 0;
		$this->menus[$r]->_id = "menu:supplierscategoriesshort";
		$this->menus[$r]->position = 3;
		$this->menus[$r]->url = "/categories/index.php?type=1";
		$this->menus[$r]->langs = "categories";
		$this->menus[$r]->perms = '$user->rights->categorie->lire';
		$this->menus[$r]->enabled = '$conf->societe->enabled && $conf->categorie->enabled';
		$this->menus[$r]->usertype = 2;
		$this->menus[$r]->title = "SuppliersCategoriesShort";
		$this->menus[$r]->fk_menu = "menu:companies";
		$r++;
		$this->menus[$r]->_id = "menu:customersprospectscategoriesshort";
		$this->menus[$r]->position = 4;
		$this->menus[$r]->url = "/categories/index.php?type=2";
		$this->menus[$r]->langs = "categories";
		$this->menus[$r]->perms = "$user->rights->categorie->lire";
		$this->menus[$r]->enabled = '$conf->fournisseur->enabled && $conf->categorie->enabled';
		$this->menus[$r]->usertype = 2;
		$this->menus[$r]->title = "CustomersProspectsCategoriesShort";
		$this->menus[$r]->fk_menu = "menu:companies";
		$r++;
		$this->menus[$r]->_id = "menu:newcategory";
		$this->menus[$r]->url = "/categories/fiche.php?action=create&amp;type=1";
		$this->menus[$r]->langs = "categories";
		$this->menus[$r]->perms = '$user->rights->categorie->creer';
		$this->menus[$r]->enabled = '$conf->societe->enabled && $conf->categorie->enabled';
		$this->menus[$r]->usertype = 2;
		$this->menus[$r]->title = "NewCategory";
		$this->menus[$r]->fk_menu = "menu:supplierscategoriesshort";
		$r++;
		$this->menus[$r]->_id = "menu:newcategory0";
		$this->menus[$r]->url = "/categories/fiche.php?action=create&amp;type=2";
		$this->menus[$r]->langs = "categories";
		$this->menus[$r]->perms = '$user->rights->categorie->creer';
		$this->menus[$r]->enabled = '$conf->fournisseur->enabled && $conf->categorie->enabled';
		$this->menus[$r]->usertype = 2;
		$this->menus[$r]->title = "NewCategory";
		$this->menus[$r]->fk_menu = "menu:customersprospectscategoriesshort";
		$r++;
