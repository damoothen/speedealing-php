...
class modPaypal extends DolibarrModules {
	...
	function modPaypal($db) {
		...
		$this->values->numero = 50200;
		// Key text used to identify module (for permissions, menus, etc...)
		$this->values->rights_class = 'paypal';
		...
		$this->values->description = "Module to offer an online payment page with PayPal";
		...
		$this->values->picto = 'paypal@paypal';

		// Data directories to create when module is enabled.
		$this->values->dirs = array('/paypal/temp');

		// Config pages. Put here list of php page names stored in admmin directory used to setup module.
		$this->values->config_page_url = array("paypal.php@paypal");

		// Dependencies
		$this->values->depends = array();	  // List of modules id that must be enabled if this module is enabled
		$this->values->requiredby = array('modPaypalPlus');  // List of modules id to disable if this one is disabled
		$this->values->phpmin = array(5, 2);	  // Minimum version of PHP required by module
		$this->values->need_dolibarr_version = array(3, 0);  // Minimum version of Dolibarr required by module
		$this->values->langfiles = array("paypal");
