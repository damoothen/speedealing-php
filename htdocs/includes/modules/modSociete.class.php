...
class modSociete extends DolibarrModules {
    ...
    function modSociete($DB) {
        ...
        $this->export_fields_array[$r] = array('c.rowid' => "IdContact", 'c.civilite' => "CivilityCode", 'c.name' => 'Lastname', 'c.firstname' => 'Firstname', 'c.poste' => "Fonction", 'c.datec' => "DateCreation", 'c.tms' => "DateLastModification", 'c.priv' => "ContactPrivate", 'c.address' => "Address", 'c.cp' => "Zip", 'c.ville' => "Town", 'c.phone' => "Phone", 'c.fax' => "Fax", 'c.email' => "EMail", 'p.libelle' => "Country", 'p.code' => "CountryCode", 's.rowid' => "IdCompany", 's.nom' => "CompanyName", 's.status' => "Status", 's.code_client' => "CustomerCode", 's.code_fournisseur' => "SupplierCode", 's.ape' => "APE", 'e.libelle' => "Effectif", 'st.libelle' => "Client/Prospect");
        $this->export_entities_array[$r] = array('s.rowid' => "company", 's.nom' => "company", 's.code_client' => "company", 's.code_fournisseur' => "company", 's.ape' => "company", 'e.libelle' => "company", 'st.libelle' => "company"); // We define here only fields that use another picto
        ...
        $this->export_sql_end[$r] .=' LEFT JOIN ' . MAIN_DB_PREFIX . 'c_effectif as e ON s.fk_effectif = e.id';
