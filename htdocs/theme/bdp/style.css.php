...
<?php } else { ?>
	/*background: #ffffff url(<?php echo DOL_URL_ROOT.'/theme/bdp/img/headbg2.jpg' ?>) 0 0 no-repeat;*/
<?php } ?>
	color: #101010;
...
.button {
    font-family: <?php print $fontlist ?>;
	background-image: url(<?php echo DOL_URL_ROOT.'/theme/bdp/img/button_bg.png' ?>);
...
<?php } else { ?>
    ...
    /*background-image: url(<?php echo DOL_URL_ROOT.'/theme/bdp/img/bg_tmenu.jpg' ?>);*/
...
a.tmenu:hover, a.tmenu:active {
    ...
    border-top-left-radius:8px;
    border-top-right-radius:8px;
    border-right: 1px solid #e3494f;
    border-bottom: 0px solid #e3494f;
    border-left: 1px solid #e3494f;
    border-top: 1px solid #e3494f;
    background: #ae1b21; /* old browsers */
}
...
div.mainmenu.home{
	background-image: url(<?php echo DOL_URL_ROOT.'/theme/bdp/img/menus/home.png' ?>);
}

div.mainmenu.companies {
	background-image: url(<?php echo DOL_URL_ROOT.'/theme/bdp/img/menus/company.png' ?>);
}

div.mainmenu.products {
	background-image: url(<?php echo DOL_URL_ROOT.'/theme/bdp/img/menus/products.png' ?>);
	margin-left: 10px;
}

div.mainmenu.commercial {
	background-image: url(<?php echo DOL_URL_ROOT.'/theme/bdp/img/menus/commercial.png' ?>);
}

div.mainmenu.accountancy {
	background-image: url(<?php echo DOL_URL_ROOT.'/theme/bdp/img/menus/money.png' ?>);
}

div.mainmenu.bank {
    background-image: url(<?php echo DOL_URL_ROOT.'/theme/bdp/img/menus/bank.png' ?>);
}

div.mainmenu.project {
	background-image: url(<?php echo DOL_URL_ROOT.'/theme/bdp/img/menus/project.png' ?>);
}

div.mainmenu.tools {
	background-image: url(<?php echo DOL_URL_ROOT.'/theme/bdp/img/menus/tools.png' ?>);
}
...
div.mainmenu.members {
	background-image: url(<?php echo DOL_URL_ROOT.'/theme/bdp/img/menus/members.png' ?>);
}

div.mainmenu.shop {
	background-image: url(<?php echo DOL_URL_ROOT.'/theme/bdp/img/menus/shop.png' ?>);
}

div.mainmenu.agenda {
	background-image: url(<?php echo DOL_URL_ROOT.'/theme/bdp/img/menus/agenda.png' ?>);
}

div.mainmenu.ecm {
	background-image: url(<?php echo DOL_URL_ROOT.'/theme/bdp/img/menus/ecm.png' ?>);
}

div.mainmenu.cashdesk {
	background-image: url(<?php echo DOL_URL_ROOT.'/theme/bdp/img/menus/pointofsale.png' ?>);
}
...
div.mainmenu.google {
	background-image: url(<?php echo DOL_URL_ROOT.'/theme/bdp/img/menus/globe.png' ?>);
}
...
foreach($mainmenuusedarray as $key => $val)
{
	...
	if (! $found && $generic <= 4)
	{
		$url=DOL_URL_ROOT."/theme/bdp/img/menus/generic".$generic.".png";
		$found=1;
		$generic++;
	}
	if ($found)
...
a.vmenu:link        { font-size:14px; text-align:left; font-weight: normal; color: #FFFFFF; margin: 1px 1px 1px 4px; }
a.vmenu:visited     { font-size:14px; text-align:left; font-weight: normal; color: #FFFFFF; margin: 1px 1px 1px 4px; }
a.vmenu:active      { font-size:14px; text-align:left; font-weight: normal; color: #FFFFFF; margin: 1px 1px 1px 4px; }
a.vmenu:hover       { font-size:14px; text-align:left; font-weight: normal; color: #efe9dd; margin: 1px 1px 1px 4px; }
font.vmenudisabled  { font-size:14px; text-align:left; font-weight: normal; color: #FFFFFF; margin: 1px 1px 1px 4px; }
...
a.vsmenu:hover      { font-size:11px; text-align:left; font-weight: normal; color: #ae1b21; margin: 1px 1px 1px 4px; }
...
div.blockvmenupair
{
	...
	padding: 0px;
	width: 100%;
    background-image: url(<?php echo DOL_URL_ROOT.'/theme/bdp/img/bg_leftCategorie2.jpg' ?>);
...
div.blockvmenusearch
{
    ...
    width: 200px;
    background-image: url(<?php echo DOL_URL_ROOT.'/theme/bdp/img/bg_leftMenu.jpg' ?>);
    background-position: top right;
    background-repeat: no-repeat;
}
...
div.blockvmenubookmarks
{
	...
	padding: 0px;
	width: 100%;
    background-image: url(<?php echo DOL_URL_ROOT.'/theme/bdp/img/bg_leftCategorie.jpg' ?>);
...
div.tabBar {
    ...
    border-left: 1px solid #D0D0D0;
    border-top: 1px solid #D8D8D8;
    /*background: url(<?php echo DOL_URL_ROOT.'/theme/bdp/img/tab_background.png' ?>) repeat-x;*/
...
/*
#undertopmenu {
background-image: url("<?php echo DOL_URL_ROOT.'/theme/bdp/img/gradient.gif' ?>");
background-repeat: repeat-x;
}
*/
...
table.noborder {
    ...
    background: #FFF url(<?php echo DOL_URL_ROOT.'/theme/bdp/img/bg_liste_titremenu.jpg' ?>);
    background-repeat: repeat-x;
    background-position: top right;
...
table.liste {
background-image: url(<?php echo DOL_URL_ROOT.'/theme/bdp/img/bg_liste_titremenu.jpg' ?>);
background-repeat: repeat-x;
background-position: top right;
    vertical-align: text-top;
    /*border-right: 1px solid #555555;
...
input.liste_titre {
background: #FFF;
/*background-image: url(<?php echo DOL_URL_ROOT.'/theme/bdp/img/bg_centerBlock-title.jpg' ?>);
background-repeat: no-repeat;
background-position: top right;*/
border: 0px;
}
...
tr.box_titre {
/*background-image: url(<?php echo DOL_URL_ROOT.'/theme/bdp/img/liste_titre2.png' ?>);*/
background-repeat: repeat-x;
color: #842F00;
font-weight: normal;
font-family: <?php print $fontlist ?>;
...
.dpReg:Hover,.dpToday:Hover{background-color:#ae1b21;color:#FEF4AE; /*font-weight: bold;*/}

/* Jour courant */
.dpSelected {
    color:white;
    font-weight:bold;
    background-color: #ae1b21; /* old browsers */
}
...
.cal_past_month    { background: #efe9dd; border: solid 1px #ACBCBB; padding-<?php print $left; ?>: 2px; padding-<?php print $right; ?>: 1px; padding-top: 0px; padding-bottom: 0px; }
...
.ui-autocomplete-loading { background: white url(<?php echo DOL_URL_ROOT.'/theme/bdp/img/working.gif' ?>) right center no-repeat; }
.ui-autocomplete {
	       position:absolute;
	       width:auto;
	       font-size: 1.0em;
