...
abstract class ActionsAdherentCardCommon
{
    ...
    function assign_values(&$action, $id)
    {
        ...
        if ($action == 'view' || $action == 'edit' || $action == 'delete')
        {
			...
			else $this->tpl['dolibarr_user'] = $langs->trans("NoSpeedealingAccess");
        }
        ...
        if ($action == 'create_user')
        {
        	...
        	$this->tpl['action_create_user'] = $form->formconfirm($_SERVER["PHP_SELF"]."?id=".$this->object->id,$langs->trans("CreateSpeedealingLogin"),$langs->trans("ConfirmCreateAdherent"),"confirm_create_user",$formquestion,'no');
        }
    }
