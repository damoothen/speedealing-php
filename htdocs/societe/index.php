...
$couchDb = new Nov_CouchDb('127.0.0.1', 5984);
...
// Different outputs
$data = $couchDb->db('users')->select('view')->asArray();
print_r($data);

$data = $couchDb->db('users')->select('gonzalo')->asObject();
print_r($data);

print "<br>";

$data = $couchDb->db('users')->select('gonzalo')->asJson();
print_r($data);
