...
$members = array(
		...
		'SetLinkToUser' => 'وصلة إلى مستخدم Speedealing',
		'SetLinkToThirdParty' => 'وصلة إلى طرف ثالث Speedealing',
		...
		'FollowingLinksArePublic' => 'الارتباطات التالية تفتح صفحة لا يحمي أي Speedealing تصريح. فهي ليست formated صفحة ، تقدم مثالا على الكيفية التي تظهر في قائمة الأعضاء في قاعدة البيانات.',
		'PublicMemberList' => 'عضو في لائحة عامة',
		'BlankSubscriptionForm' => 'استمارة الاشتراك',
		'BlankSubscriptionFormDesc' => 'يمكن أن توفر لك Speedealing URL العام للسماح للزوار خارجي لطرح للاكتتاب للمؤسسة. إذا تم تمكين وحدة الدفع عبر الإنترنت، سيتم أيضا نموذج الدفع سيتم توفيرها تلقائيا.',
		...
		'Entreprises' => 'الشركات',
		'DOLIBARRFOUNDATION_PAYMENT_FORM' => 'أن يسدد الاشتراك باستخدام حوالة مصرفية، راجع صفحة <a target="_blank" href="http://wiki.speedealing.org/index.php/Subscribe#To_subscribe_making_a_bank_transfer">http://wiki.speedealing.org/index.php/Subscribe</a> . <br> الدفع باستخدام بطاقة ائتمان أو باي بال، وانقر على زر في أسفل هذه الصفحة. <br>',
