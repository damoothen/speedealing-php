...
$agenda = array(
		...
		'ListOfEvents' => 'قائمة الأحداث Speedealing',
		...
		'AgendaAutoActionDesc' => 'هنا تعريف الأحداث التي تريد Speedealing لخلق عمل تلقائيا في جدول الأعمال. إذا لم فحصها (افتراضي) ، إلا دليل الإجراءات التي ستدرج في جدول الأعمال.',
		'AgendaSetupOtherDesc' => 'وتسمح هذه الصفحة لتكوين البارامترات الأخرى من جدول الأعمال وحدة.',
		'AgendaExtSitesDesc' => 'هذه الصفحة تسمح لاعلان مصادر خارجية من التقويمات لمعرفة المناسبات الخاصة بهم في جدول أعمال Speedealing.',
		'ActionsEvents' => 'الأحداث التي ستخلق Speedealing عمل تلقائيا في جدول الأعمال',
