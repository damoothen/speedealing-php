...
$errors = array(
		...
		'ErrorUserCannotBeDelete' => 'المستخدم لا يمكن حذفها. قد يكون ذلك مرتبطا Speedealing على الكيانات.',
		'ErrorFieldsRequired' => 'تتطلب بعض المجالات لم تملأ.',
		'ErrorFailedToCreateDir' => 'فشل إنشاء دليل. تأكد من أن خادم الويب المستخدم أذونات لكتابة وثائق Speedealing في الدليل. إذا تم تمكين المعلم <b>safe_mode</b> على هذا PHP ، تحقق من أن ملفات Speedealing php تملك لخدمة الويب المستخدم (أو مجموعة).',
		...
		'ErrorLDAPSetupNotComplete' => 'Speedealing - LDAP المطابقة وليس كاملا.',
		...
		'ErrorDatabaseParameterWrong' => 'قاعدة بيانات المعلمة الإعداد <b>\'%s\'</b> يحتوي على قيمة غير متوافق لاستخدام Speedealing (يجب أن يكون قيمة <b>\'%s\').</b>',
		...
		'ErrorForbidden2' => 'ويمكن تعريف إذن لهذا الدخول من قبل المسؤول Speedealing الخاص بك من القائمة %s-> %s.',
		'ErrorForbidden3' => 'يبدو أن لا يتم استخدام Speedealing خلال جلسة المصادقة. نلقي نظرة على وثائق الإعداد Speedealing لمعرفة كيفية إدارة المصادقة (تاكيس، mod_auth أو غيرها ...).',
