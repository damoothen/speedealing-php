...
$users = array(
		...
		'SubjectNewPassword' => 'كلمة المرور الجديدة لSpeedealing',
		...
		'ExportDataset_user_1' => 'Speedealing مستخدمي وممتلكاتهم',
		'DomainUser' => 'النطاق المستخدم ق ٪',
		'Reactivate' => 'تنشيط',
		'CreateInternalUserDesc' => 'هذا الشكل يتيح لك يخلق أي مستخدم الداخلي لتسجيل شركة أو مؤسسة. ليخلق خارجي المستخدم (العميل ، المورد ،...)، استخدام زر \'إنشاء مستخدم Speedealing\' من طرف ثالث بطاقة اتصال.',
		'InternalExternalDesc' => '<b>داخلي</b> المستخدم المستخدم الذي يشكل جزءا من الشركة / المؤسسة. <br> مستخدم <b>خارجي</b> هو عميل أو مورد أو غيرها. <br><br> وفي كلتا الحالتين ، ويحدد الحقوق على أذونات Speedealing ، كما يمكن للمستخدم خارجي له قائمة من مدير المستخدم الداخلي (انظر الصفحة الرئيسية -- إعداد -- عرض)',
		...
		'ConfirmCreateContact' => 'هل أنت متأكد من خلق Speedealing حساب هذا الاتصال؟',
		'ConfirmCreateLogin' => 'هل أنت متأكد من خلق Speedealing حساب هذا؟',
