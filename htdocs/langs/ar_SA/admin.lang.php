...
$admin = array(
		...
		'ConfirmLockNewSessions' => 'هل أنت متأكد أنك تريد تقييد أي اتصال Speedealing جديدة لنفسك. <b>ق ٪</b> سوف مستخدم فقط تكون قادرا على الاتصال بعد ذلك.',
		...
		'MenusEditorDesc' => 'محرر القائمة تسمح لك لتحديد شخصية القيود في القوائم. استخدامها بعناية لتجنب جعل speedealing غير مستقرة ودائمة قائمة مداخل الوصول. <br> إضافة وحدات بعض القيود في القوائم (في <b>كل</b> قائمة في معظم الحالات). إذا كنت إزالة بعض هذه القيود عن طريق الخطأ ، يمكنك ان تستعيد بها وتعطيل reenabling الوحدة.',
		...
		'PurgeAreaDesc' => 'تسمح لك هذه الصفحة لحذف كل الملفات التي بنيت أو تخزينها بوسائل Speedealing (الملفات المؤقتة ، أو كافة الملفات في الدليل <b>٪ ق).</b> استخدام هذه الميزة ليست ضرورية. ومن المقدمة للمستخدمين والتي تستضيفها Speedealing موفر الخدمات التي لا تقدم أذونات لحذف الملفات التي أقامها خادم الويب.',
		...
		'ModulesDesc' => 'Speedealing تحديد الوحدات التي تم تمكين وظيفة في مجال البرمجيات. وتتطلب بعض وحدات الأذونات ، يجب ان تمنح للمستخدمين ، وبعد أن تمكن وحدة.',
		'ModulesInterfaceDesc' => 'فإن التفاعل بين وحدات Speedealing يسمح لك بإضافة السمات الخارجية تعتمد على البرمجيات والنظم والخدمات.',
		'ModulesSpecialDesc' => 'وحدات خاصة أو محددة جدا ونادرا ما تستخدم وحدات.',
		'ModulesJobDesc' => 'توفير وحدات تجارية بسيطة ومحددة سلفا من Speedealing الإعداد لأعمال معين.',
		...
		'DoliStoreDesc' => 'DoliStore ، في السوق الرسمي لتخطيط موارد المؤسسات وحدات Speedealing / خارجي إدارة علاقات العملاء',
		...
		'InstrucToEncodePass' => 'لديك كلمة المرور المشفرة في ملف <b>conf.php</b> ، استبدال خط <br> <b>speedealing_main_db_pass $ ="..."</b> <br> من قبل <br> <b>"= $ crypted speedealing_main_db_pass : ٪ ق"</b>',
		'InstrucToClearPass' => 'لديك كلمة السر فك الشفرة (واضح) في <b>conf.php</b> الملف ، استبدال السطر <br> <b>speedealing_main_db_pass $ = ":..." crypted</b> <br> من قبل <br> <b>speedealing_main_db_pass $ = "٪ ق"</b>',
		...
		'OfficialWebSite' => 'Speedealing الدولي الموقع الرسمي',
		'OfficialWebSiteFr' => 'الفرنسية الموقع الرسمي',
		'OfficialWiki' => 'Speedealing يكي',
		'OfficialDemo' => 'Speedealing الانترنت التجريبي',
		...
		'ForDocumentationSeeWiki' => 'For user\'s or developer\'s documentation (Doc, FAQs...),<br>take a look at the Speedealing Wiki:<br><b><a href="%s" target=للمستخدم أو للتطوير وثائق (مستدات ،...)، أسئلة وأجوبة <br> إلقاء نظرة على ويكي Speedealing : <br> <a href="%s" target="_blank"><b>ق ٪</b></a>',
		'ForAnswersSeeForum' => 'For any other questions/help, you can use the Speedealing forum:<br><b><a href="%s" target=عن أي أسئلة أخرى / مساعدة ، يمكنك استخدام Speedealing المنتدى : <br> <a href="%s" target="_blank"><b>ق ٪</b></a>',
		'HelpCenterDesc1' => 'هذا المجال يمكن أن تساعدك في الحصول على مساعدة لتقديم خدمات الدعم على Speedealing.',
		...
		'SubmitTranslation' => 'إذا كان ترجمة لهذه اللغة ليست كاملة أو تجد الأخطاء ، يمكنك تصحيح هذا عن طريق تحرير الملفات إلى الدليل <b>langs / ق ٪</b> ، وإرسال ملفات تعديل على www.speedealing.org المنتدى.',
		...
		'SetupIsReadyForUse' => 'الانتهاء من تركيب وSpeedealing على استعداد لاستخدام هذا العنصر الجديد.',
		...
		'CurrentVersion' => 'Speedealing النسخة الحالية',
		...
		'KeyForWebServicesAccess' => 'مفتاح لاستخدام خدمات الشبكة العالمية (المعلمة &quot;speedealingkey&quot; في webservices)',
		...
		'Module59Desc' => 'إضافة مهمة لتوليد Bookmark4u الحساب من حساب Speedealing',
		...
		'Module100Desc' => 'وتشمل أي موقع خارجي في القوائم Speedealing ومشاهدته في إطار Speedealing',
		...
		'Module240Desc' => 'أداة لتصدير Speedealing datas (مساعدين)',
		'Module250Name' => 'بيانات الاستيراد',
		'Module250Desc' => 'أداة لاستيراد datas في Speedealing (مساعدين)',
		'Module310Name' => 'أعضاء',
		'Module310Desc' => 'أعضاء إدارة المؤسسة',
		'Module320Name' => 'تغذية RSS',
		'Module320Desc' => 'إضافة تغذية RSS داخل الشاشة صفحة Speedealing',
		...
		'Module600Desc' => 'إرسال الإشعارات عن طريق البريد الإلكتروني على بعض الفعاليات التجارية Speedealing لطرف ثالث اتصالات',
		...
		'Module2600Desc' => 'تمكين خدمات الويب Speedealing الملقم',
		...
		'SummaryConst' => 'قائمة بجميع Speedealing الإعداد البارامترات',
		...
		'SetupDescription1' => 'جميع البارامترات المتاحة في مجال الإعداد تسمح لك قبل البدء في الإعداد Speedealing استخدامه.',
		...
		'SetupDescription3' => 'البارامترات في <b>إعداد</b> القائمة <b>--> الشركة / المؤسسة</b> المطلوب لأن مدخلات تستخدم المعلومات عن Speedealing عرض وتعديل السلوك Speedealing (على سبيل المثال لخصائص تتعلق بلدكم).',
		'SetupDescription4' => 'البارامترات في <b>إعداد</b> القائمة <b>--> الوحدات</b> المطلوبة لأن Speedealing ليست ثابتة تخطيط موارد المؤسسات وإدارة علاقات العملاء ولكن مبلغ من عدة وحدات ، وكلها مستقلة بشكل أو بآخر. انه فقط بعد تفعيل وحدات للاهتمام كنت في ذلك سترى ملامح وردت في القوائم.',
		...
		'ListOfSecurityEvents' => 'قائمة الأحداث الأمنية Speedealing',
		'SecurityEventsPurged' => 'تطهير الاحداث الامنية',
		'LogEventDesc' => 'هنا يمكنك تمكين قطع الأشجار لSpeedealing الأحداث الأمنية. يمكن للمشرفين ثم انظر مضمونه عبر <b>نظام</b> القائمة <b>أدوات -- لمراجعة الحسابات.</b> محذرا من أن هذه الميزة يمكن أن تستهلك كمية كبيرة من البيانات في قاعدة البيانات.',
		...
		'SystemAreaForAdminOnly' => 'هذا المجال المتاح لمدير المستخدمين فقط. أيا من Speedealing أذونات يمكن أن تقلل من هذا الحد.',
		'CompanyFundationDesc' => 'تعديل على هذه الصفحة كل المعلومات المعروفة للشركة أو مؤسسة تحتاج لإدارة',
		'DisplayDesc' => 'يمكنك ان تختار كل معلمة إلى Speedealing هنا الشكل والمظهر',
		...
		'TriggersDesc' => 'يطلق الملفات التي سوف يتم تعديل سلوك Speedealing العمل نسخها مرة واحدة في الدليل <b>htdocs / تضم / محفزات.</b> ادركوا إجراءات جديدة ، وتفعيله على Speedealing الأحداث (انشاء الشركة الجديدة ، والمصادقة على الفواتير ،...).',
		...
		'TriggerAlwaysActive' => 'يطلق في هذا الملف هي حركة دائمة ، وتفعيل ما هي وحدات Speedealing.',
		...
		'OnceSetupFinishedCreateUsers' => 'تحذير فأنت Speedealing مدير المستخدم. مدير المستخدمين تستخدم لإعداد Speedealing. لالمعتاد استخدام Speedealing ، يوصى باستخدام غير مستخدم مدير خلق مجموعات من المستخدمين & القائمة.',
		'MiscellanousDesc' => 'هنا تعريف جميع البارامترات الأخرى ذات الصلة بالأمن.',
		'LimitsSetup' => 'حدود / الدقيقة الإعداد',
		'LimitsDesc' => 'يمكنك تحديد الحدود ، وoptimisations الايضاحات التي تستخدمها Speedealing هنا',
		...
		'BackupDesc' => 'لتقديم دعم كامل للSpeedealing ، يجب عليك :',
		...
		'RestoreDesc' => 'Speedealing لاستعادة النسخ الاحتياطي ، يجب عليك :',
		'RestoreDesc2' => '* استعادة ارشيف ملف (ملف مضغوط على سبيل المثال) للوثائق ودليل لانتزاع شجرة الملفات في دليل وثائق جديدة أو Speedealing تركيب هذه الوثائق الحالية directoy <b>(٪).</b>',
		'RestoreDesc3' => '* استعادة البيانات ، احتياطية من إلقاء الملف في قاعدة البيانات من جديد Speedealing تركيب أو في قاعدة البيانات الحالية لهذا التثبيت. تحذير ، بعد الانتهاء من اعادة ، يجب استخدام ادخل كلمة السر ، التي كانت موجودة عندما تم احتياطية ، لربط جديد. النسخ الاحتياطي لاستعادة قاعدة بيانات في هذا التركيب الحالي ، يمكنك اتباع هذه مساعدا.',
		...
		'SomeTranslationAreUncomplete' => 'قد تكون بعض اللغات مترجمة جزئيا أو قد يحتوي على أخطاء. إذا كنت الكشف عن بعض، يمكنك <b>إصلاح.</b> ملفات نصية <b>لانج</b> في <b>htdocs</b> الدليل <b>/ langs</b> ورفعها على المنتدى في <a href="http://www.speedealing.org/forum" target="_blank">http://www.speedealing.org</a> .',
		...
		'ProxyDesc' => 'بعض ملامح Speedealing في حاجة الى وصول الإنترنت إلى العمل. هنا تعريف المعلمات من أجل هذا. إذا كان الملقم Speedealing خلف ملقم وكيل، هذه المعايير يقول Speedealing كيفية الوصول إلى الإنترنت من خلال ذلك.',
		...
		'PasswordGenerationStandard' => 'عودة كلمة سر ولدت الداخلية وفقا لخوارزمية Speedealing : 8 أحرف مشتركة تتضمن الأرقام والحروف في حرف صغير.',
		...
		'NotificationsDesc' => 'إشعارات البريد الإلكتروني ميزة تسمح لك صمت إرسال البريد الآلي ، وبالنسبة لبعض الأحداث Speedealing ، لأطراف ثالثة (العملاء أو الموردين) التي هي لتهيئتها. اختيار نشط الاشعار الاتصالات واعتماد أهداف واحدة لطرف ثالث في الوقت المناسب.',
		...
		'WebCalSyncro' => 'إضافة إلى Speedealing الأحداث WebCalendar',
		...
		'LDAPSynchronizeUsers' => 'تزامن Speedealing المستخدمين LDAP',
		'LDAPSynchronizeGroups' => 'تزامن مع Speedealing مجموعات LDAP',
		'LDAPSynchronizeContacts' => 'تزامن Speedealing اتصالات مع LDAP',
		'LDAPSynchronizeMembers' => 'التزامن بين أعضاء المؤسسة وحدة Speedealing مع LDAP',
		...
		'LDAPDnSynchroActiveExample' => 'LDAP لSpeedealing أو Speedealing لتزامن LDAP',
		...
		'LDAPMemberTypeDn' => 'Speedealing عضو نوع DN',
		...
		'LDAPDescContact' => 'تسمح لك هذه الصفحة لتحديد اسم LDAP الصفات LDAP شجرة في كل البيانات التي وجدت على Speedealing الاتصالات.',
		'LDAPDescUsers' => 'تسمح لك هذه الصفحة لتحديد اسم LDAP الصفات LDAP شجرة في كل البيانات التي وجدت على Speedealing المستخدمين.',
		'LDAPDescGroups' => 'تسمح لك هذه الصفحة لتحديد اسم LDAP الصفات LDAP شجرة في كل البيانات التي وجدت على Speedealing.',
		'LDAPDescMembers' => 'تسمح لك هذه الصفحة لتحديد اسم LDAP الصفات LDAP شجرة في كل البيانات التي وجدت على Speedealing أعضاء الوحدة.',
		...
		'YouCanUseDOL_DATA_ROOT' => 'يمكنك استخدام DOL_DATA_ROOT / speedealing.log لملف الدخول في Speedealing "وثائق" دليل. يمكنك أن تحدد مسارا مختلفا لتخزين هذا الملف.',
		...
		////////// ClickToDial //////////
		'ClickToDialDesc' => 'هذا النموذج يسمح لإضافة رمز بعد رقم هاتف Speedealing الاتصالات. وهناك اضغط على هذه الأيقونة ، سوف يطلب من أحد serveur معينة مع تحديد عنوان لكم أدناه. ويمكن استخدام هذه الكلمة لدعوة من مركز نظام Speedealing التي يمكن الاتصال على رقم الهاتف هذا المسبار النظام على سبيل المثال.',
		...
		'BookmarkDesc' => 'هذا النموذج يسمح لك لإدارة العناوين. يمكنك أيضا إضافة أي Speedealing اختصارات لصفحات أو مواقع الويب externale على القائمة اليمنى.',
		'NbOfBoomarkToShow' => 'أكبر عدد ممكن من العناوين تظهر في القائمة اليمنى',
		////////// WebServices //////////
		'WebServicesSetup' => 'إعداد وحدة Webservices',
		'WebServicesDesc' => 'من خلال تمكين هذه الوحدة ، Speedealing تصبح خدمة الإنترنت لتوفير خدمات الإنترنت وخدمات متنوعة.',
		'WSDLCanBeDownloadedHere' => 'اختصار الواصفة ملف قدمت serviceses هنا يمكن التحميل',
		'EndPointIs' => 'الصابون العملاء يجب إرسال الطلبات إلى نقطة النهاية Speedealing متاحة في الموقع',
		////////// Bank //////////
