...
$banks = array(
		...
		'TransferDesc' => 'التحويل من حساب إلى آخر واحد ، وسوف يكتب Speedealing اثنين من السجلات (أ مصدر في حساب الخصم والائتمان في الاعتبار الهدف من نفس المبلغ. العلامة نفسها وحتى الآن وسيتم استخدام هذه الصفقة)',
		'TransferFrom' => 'من',
		'TransferTo' => 'إلى',
