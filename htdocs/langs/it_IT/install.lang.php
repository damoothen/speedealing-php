...
$install = array(
		'CHARSET' => 'UTF-8',
		'InstallEasy' => 'Abbiamo cercato di semplificare al massimo l\' installazione di Speedealing. Basta seguire le istruzioni passo per passo.',
		...
		'ErrorPHPDoesNotSupportSessions' => 'La tua installazione di PHP non supporta le sessioni. Speedealing non può funzionare senza. Risolvere questo problema prima di installare Speedealing.',
		...
		'ErrorPHPDoesNotSupportUTF8' => 'L\'installazione di PHP non supporta funzioni UTF-8. Speedealing non può funzionare correttamente.Risolvere questo problema prima di installare Speedealing.',
		...
		'SystemIsUpgraded' => 'Speedealing è stato aggiornato con successo.',
		'YouNeedToPersonalizeSetup' => 'Speedealing deve essere configurato per soddisfare le vostre necessità (aspetto, caratteristiche, ecc...). Per effettuare questa operazione, segui il link qui sotto:',
		...
		'UpgradeDesc' => 'Usare questo metodo per sostituire una vecchia installazione Speedealing con una versione più recente. Ciò aggiornerà il database e i dati.',
		'Start' => 'Inizio',
