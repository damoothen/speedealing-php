...
$members = array(
		...
		'SetLinkToUser' => 'Link a un utente Speedealing',
		...
		'BlankSubscriptionFormDesc' => 'Speedealing può fornire un URL pubblico per permettere ai visitatori esterni di richiedere l\'adesione alla fondazione. Se è attivo un modulo di pagamento online, le informazioni per il pagamento saranno fornite automaticamente.',
		...
		'Entreprises' => 'Imprese',
		'DOLIBARRFOUNDATION_PAYMENT_FORM' => 'Per effettuare il pagamento dell\'adesione tramite bonifico bancario, vedi <a target="_blank" href="http://wiki.speedealing.org/index.php/Subscribe#To_subscribe_making_a_bank_transfer">http://wiki.speedealing.org/index.php/Subscribe</a>.<br/>Per pagare con carta di credito o Paypal, clicca sul pulsante in fondo a questa pagina.<br/>',
