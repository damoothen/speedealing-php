...
$errors = array(
		...
		'ErrorDatabaseParameterWrong' => 'Il parametro di configurazione database <b>\'%s\'</b> ha un valore non compatibile con il funzionamento di Speedealing (deve avere un valore <b>\'%s\').</b>',
		...
		'ErrorForbidden2' => 'L\'autorizzazione all\'accesso per questi dati può essere impostata dall\'amministratore di Speedealing tramite il menu %s - %s.',
		'ErrorForbidden3' => 'Sembra che Speedealing non venga utilizzato tramite una sessione autenticata. Dai un\'occhiata alla documentazione di installazione Speedealing per sapere come gestire le autenticazioni (htaccess, mod_auth o altri...).',
