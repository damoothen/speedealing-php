...
$main = array(
		...
		'ErrorConfigParameterNotDefined' => 'Le paramètre <b>%s</b> n\'est pas défini dans le fichier de configuration Speedealing <b>conf.php</b>.',
		...
		'PrecisionUnitIsLimitedToXDecimals' => 'Speedealing a été configuré pour limiter la précision des prix unitaires à <b>%s</b> décimales.',
		'DoTest' => 'Tester',
		'ToFilter' => 'Filtrer',
		...
		'Canceled' => 'Annulé',
		'YouCanChangeValuesForThisListFromDictionnarySetup' => 'Vous pouvez changer ces valeurs depuis le menu accueil - configuration - dictionnaires',
		'Color' => 'Couleur',
		...
		'ThisLimitIsDefinedInSetup' => 'Limite Speedealing (Menu accueil-configuration-sécurité): %s Ko, Limite PHP: %s Ko',
