...
$admin = array(
		...
		'ConfirmLockNewSessions' => 'Êtes-vous sûr de vouloir restreindre l\'accès Speedealing à votre utilisateur. Seul le login <b>%s</b> pourra se connecter après cela.',
		'UnlockNewSessions' => 'Lever blocage des connexions',
		'YourSession' => 'Votre session',
		'Sessions' => 'Sessions utilisateurs',
		'WebUserGroup' => 'Web serveur utilisateur/group',
		...
		'CurrentTimeZone' => 'Time Zone PHP (serveur)',
		'Space' => 'Espace',
		'Fields' => 'Champs',
		'Mask' => 'Masque',
		...
		'PurgeAreaDesc' => 'Cette page vous permet d\'effacer tous les fichiers construits ou stockés par Speedealing (fichiers temporaires ou tous les fichiers du répertoire <b>%s</b>). L\'utilisation de cette fonction n\'est pas nécessaire. Elle est fournie pour les utilisateurs qui hébergent Speedealing chez un hébergeur qui n\'offre pas les permissions de supprimer les fichiers sauvegardés par le serveur Web.',
		...
		'ModulesDesc' => 'Les modules Speedealing définissent les fonctionnalités disponibles dans l\'application. Certains modules nécessitent des droits qu\'il vous faudra affecter aux utilisateurs pour qu\'ils puissent accéder à leurs fonctionnalités. Cliquez sur le bouton on/off de la colonne "Etat" pour activer un module/fonctionnalité.',
		'ModulesInterfaceDesc' => 'Les modules d\'interfaces sont des modules qui permettent de lier Speedealing à des systèmes, applications ou services externes.',
		...
		'ModulesJobDesc' => 'Les modules métiers très spécifiques permettent une préconfiguration simplifiée de Speedealing pour un métier spécifique.',
		...
		'DoliStoreDesc' => 'DoliStore, la place de marché officielle des modules et extensions complémentaires pour Speedealing ERP/CRM',
		...
		'OfficialWiki' => 'Wiki de documentation Speedealing',
		'OfficialDemo' => 'Démo en ligne Speedealing',
		...
		'ForDocumentationSeeWiki' => 'Pour la documentation utilisateur, développeur ou les FAQs,<br>consultez le wiki Speedealing:<br><b><a href="%s" target="_blank">%s</a></b>',
		'ForAnswersSeeForum' => 'Pour tout autre question/aide, vous pouvez utiliser le forum Speedealing:<br><b><a href="%s" target="_blank">%s</a></b>',
		'HelpCenterDesc1' => 'Cette application, indépendante de Speedealing, vous permet de vous aider à obtenir un service de support sur Speedealing.',
		...
		'SubmitTranslation' => 'Si la traduction pour cette langue est incomplète ou si vous trouvez des erreurs, vous pouvez les corriger en éditant les fichiers dans le répertoire <b>langs/%s</b> et soumettre les modifications sur le forum www.Speedealing.fr.',
		...
		'ModuleFamilyOther' => 'Modules : Autre',
		...
		'SetupIsReadyForUse' => 'L\'installation est terminée et Speedealing est prêt à être utilisé avec le nouveau composant.',
		'NotExistsDirect' => 'Il n\'y a pas répertoire alternative.<br>',
		'InfDirAlt' => 'Depuis la version 3 est possible de définir un répertoire alternatif qui vous permet de stocker dans le même endroit les modules et thèmes personnalisés.<br>Il suffit de créer un répertoire à la racine de Speedealing (par exemple: custom).<br>',
		...
		'CurrentVersion' => 'Version en cours de Speedealing',
		...
		'UMaskExplanation' => 'Ce paramètre permet de définir les droits des fichiers créés sur le serveur par Speedealing (lors d\'upload par exemple).<br>Ce doit être la valeur octale (par exemple 0666 signifie lecture/écriture pour tous).<br>Ce paramètre n\'a aucun effet sur un serveur Windows.',
		...
		'ConfirmPurge' => 'Êtes vous sûr de vouloir réaliser cette purge ?<br>Ceci effacera définitivement toutes vos données fichier (espace GED, pièces jointes, etc...).',
		...
		'FollowingSubstitutionKeysCanBeUsed' => '<br>Pour savoir comment rédiger ses modèles de document odt avant de les placer dans un de ces répertoires, consulter la documentation du wiki:',
		...
		'Module59Desc' => 'Ajoute fonction pour générer un compte Bookmark4u depuis un compte Speedealing',
		...
		'Module100Desc' => 'Ajoute un site Web externe dans les menus Speedealing et l\'affiche dans un frame Speedealing',
		...
		'Module240Desc' => 'Outil d\'export de données Speedealing (via un assistant)',
		'Module250Name' => 'Imports de données',
		'Module250Desc' => 'Outil d\'import de données dans Speedealing (via un assistant)',
		'Module310Name' => 'Adhérents',
		'Module310Desc' => 'Gestion des adhérents d\'une association',
		'Module320Name' => 'Fils RSS',
		'Module320Desc' => 'Ajout de fils d\'informations RSS dans les écrans Speedealing',
		...
		'Module600Desc' => 'Envoi de notifications (par mail) sur certains événements métiers Speedealing, aux contacts de tiers',
		'Module700Name' => 'Dons',
		...
		'Module2600Desc' => 'Active le serveur de Web Services de Speedealing',
		...
		'Permission171' => 'Lire les déplacements',
		...
		'DatabaseServer' => 'Host de la base de données',
		'DatabaseName' => 'Nom de la base de données',
		'DatabasePort' => 'Port de la base de données',
		'DatabaseUser' => 'Login de la base de données',
		...
		'SummarySystem' => 'Résumé des informations systèmes Speedealing',
		'SummaryConst' => 'Liste de tous les paramètres de configuration Speedealing',
		...
		'SetupDescription3' => 'Les données du menu <b>Configuration -> Société/institution</b> sont requises car les informations saisies sont utilisées dans la plupart des écrans, en affichage, ou pour modifier le comportement de Speedealing (comme par exemple des fonctions qui dépendent de votre pays).',
		'SetupDescription4' => 'Les données du menu <b>Configuration -> Modules</b> sont indispensables car Speedealing ERP/CRM est constitué d\'un ensemble de modules tous plus ou moins indépendants. C\'est après avoir activé les modules qui vous intéressent que vous verrez apparaitre les fonctionnalités dans les menus.',
		...
		'ListOfSecurityEvents' => 'Liste des événements de sécurité Speedealing',
		...
		'SystemAreaForAdminOnly' => 'Cet espace n\'est accessible qu\'aux utilisateurs de type administrateurs. Aucune permission Speedealing ne permet d\'étendre le cercle des utilisateurs autorisés à cet espace.',
		...
		'DisplayDesc' => 'Vous pouvez choisir ici tous les paramètres liés à l\'apparence de Speedealing',
		...
		'TriggersDesc' => 'Les triggers sont des fichiers qui, une fois déposés dans le répertoire <b>htdocs/core/triggers</b>, modifient le comportement du workflow de Speedealing. Ils réalisent des actions supplémentaires, déclenchées par les événements Speedealing (création société, validation facture, clôture contrat...).',
		...
		'TriggerAlwaysActive' => 'Triggers de ce fichier toujours actifs, quelque soient les modules Speedealing activés.',
		...
		'OnceSetupFinishedCreateUsers' => 'Attention, vous êtes sous un compte administrateur de Speedealing. Les administrateurs sont utilisés pour configurer Speedealing. Pour une utilisation courante de Speedealing, il est recommandé d\'utiliser un compte non administrateur créé depuis le menu "Utilisateurs & Groupes".',
		...
		'LimitsDesc' => 'Vous pouvez définir ici les limites, précisions et optimisations utilisées par Speedealing',
		...
		'BackupDesc' => 'Pour réaliser une sauvegarde complète de Speedealing, vous devez:',
		...
		'RestoreDesc' => 'Pour restaurer une sauvegarde de Speedealing, vous devez:',
		'RestoreDesc2' => '* Reprendre le fichier archive (fichier zip par exemple) du répertoire documents et en extraire l\'arborescence dans le répertoire documents d\'une nouvelle installation de Speedealing ou dans le répertoire documents de cette installation (<b>%s</b>).',
		'RestoreDesc3' => '* Recharger depuis le fichier dump sauvegardé, la base de données d\'une nouvelle installation de Speedealing ou de cette installation. Attention, une fois la restauration faite, il faudra utiliser un login/mot de passe administrateur existant à l\'époque de la sauvegarde pour se connecter. Pour restaurer la base dans l\'installation actuelle, vous pouvez utiliser l\'assistant suivant.',
		...
		'ProxyDesc' => 'Certaines fonctions de Speedealing nécessitent que le serveur ait accès à internet. Définissez ici les paramètres de ces accès. Si le serveur Speedealing est derrière un proxy, ces paramètres indiquent à Speedealing comment le traverser.',
		...
		'ModuleCompanyCodeAquarium' => 'Renvoie un code compta composé de :<br>%s suivi du code tiers fournisseur pour le code compta fournisseur,<br>%s suivi du code tiers client pour le code compta client.',
		...
		'NotificationsDesc' => 'La fonction des notifications par emails permet d\'envoyer automatiquement un email, pour certains événements Speedealing, aux tiers (sociétés clients, prospects ou fournisseurs) configurés pour. Le choix des notifications et contacts destinataires se fait tiers par tiers.',
		...
		'WebCalSyncro' => 'Intégrer les événements Speedealing dans WebCalendar',
		...
		'WebCalAddEventOnCreateActions' => 'Ajouter un événement dans le calendrier sur création d\'actions',
		'WebCalAddEventOnCreateCompany' => 'Ajouter un événement dans le calendrier sur création de sociétés',
		'WebCalAddEventOnStatusPropal' => 'Ajouter un événement dans le calendrier sur changement de statut des propositions commerciales',
		'WebCalAddEventOnStatusContract' => 'Ajouter un événement dans le calendrier sur changement de statut des contrats',
		'WebCalAddEventOnStatusBill' => 'Ajouter un événement dans le calendrier sur changement de statut des factures',
		'WebCalAddEventOnStatusMember' => 'Ajouter un événement dans le calendrier sur changement de statut des adhérents',
		...
		'LDAPDescContact' => 'Cette page permet de définir le nom des attributs de l\'arbre LDAP pour chaque information des contacts Speedealing.',
		'LDAPDescUsers' => 'Cette page permet de définir le nom des attributs de l\'arbre LDAP pour chaque information des utilisateurs Speedealing.',
		'LDAPDescGroups' => 'Cette page permet de définir le nom des attributs de l\'arbre LDAP pour chaque information des groupes utilisateurs Speedealing.',
		...
		'YouCanUseDOL_DATA_ROOT' => 'Vous pouvez utiliser DOL_DATA_ROOT/dolibarr.log pour un log dans le répertoire "documents" de Speedealing. Vous pouvez néanmoins définir un chemin différent pour stocker ce fichier.',
		...
		'BookmarkDesc' => 'Ce module vous permet de gérer des liens et raccourcis. Il permet aussi d\'ajouter n\'importe quelle page de Speedealing ou lien web dans le menu d\'accès rapide sur la gauche.',
		...
		'WebServicesDesc' => 'En activant ce module, Speedealing devient aussi serveur de web services offrant des web services divers.',
		'WSDLCanBeDownloadedHere' => 'Les descripteurs WSDL des services fournis peuvent être récupéré ici',
		'EndPointIs' => 'Les clients SOAP doivent envoyer leur requêtes vers l\'endpoint Speedealing à l\'URL',
		////////// Bank //////////
