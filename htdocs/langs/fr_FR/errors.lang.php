...
$errors = array(
		...
		'ErrorUserCannotBeDelete' => 'L\'utilisateur ne peut pas être supprimé. Peut-être est-il associé à des éléments de Speedealing.',
		'ErrorFieldsRequired' => 'Des champs obligatoires n\'ont pas été renseignés',
		'ErrorFailedToCreateDir' => 'Echec à la création d\'un répertoire. Vérifiez que le user du serveur Web a bien les droits d\'écriture dans les répertoires documents de Speedealing. Si le paramètre <b>safe_mode</b> a été activé sur ce PHP, vérifier que les fichiers php Speedealing appartiennent à l\'utilisateur du serveur Web.',
		...
		'ErrorLDAPSetupNotComplete' => 'Le matching Speedealing-LDAP est incomplet.',
		...
		'ErrorDatabaseParameterWrong' => 'Le paramètre de configuration de la base de donnée \'<b>%s</b>\' a une valeur non compatible pour une utilisation de Speedealing (doit avoir la valeur \'<b>%s</b>\').',
		...
		'ErrorForbidden2' => 'Les permissions pour ce login peuvent être attribuées par l\'administrateur Speedealing via le menu %s -> %s.',
		'ErrorForbidden3' => 'Speedealing ne semble pas fonctionner au sein d\'une session authentifiée. Consultez la documentation d\'installation de Speedealing pour savoir comment gérer les authentifications (htaccess, mod_auth ou autre...).',
		...
		'WarningPassIsEmpty' => 'Attention, le mot de passe de la base de données Speedealing est vide. Cela représente une faille de sécurité. Il est recommandé d\'ajouter manuellement un mot de passe à la base et de modifier le fichier conf.php pour refléter ce changement.',
