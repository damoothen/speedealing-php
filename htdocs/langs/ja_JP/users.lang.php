...
$users = array(
		...
		'Reactivate' => '再アクティブ化',
		'CreateInternalUserDesc' => 'このフォームは、あなたの会社/財団への内部ユーザを設けることができます。外部ユーザー（顧客、サプラ​​イヤ、...）creatを、サードパーティの連絡先カードからボタンの作成Dolibarrユーザー \'を使用します。',
		'InternalExternalDesc' => '<b>内部</b>ユーザは、あなたの会社/基礎の一部であるユーザーです。 <br> <b>外部</b>ユーザーは顧客、サプライヤーまたは他のです。 <br><br>両方のケースでは、権限も、Dolibarrの権限を定義する外部ユーザー（ホームを参照してください - セットアップ - ディスプレイ）は、内部ユーザーとは異なるメニューマネージャを持つことができます',
