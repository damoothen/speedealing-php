...
$errors = array(
		...
		'ErrorUserCannotBeDelete' => 'ユーザーを削除することはできません。それはSpeedealingエンティティに関連付けられているかもしれません。',
		'ErrorFieldsRequired' => 'いくつかの必須フィールドが満たされていませんでした。',
		'ErrorFailedToCreateDir' => 'ディレクトリの作成に失敗しました。そのWebサーバのユーザがSpeedealingのドキュメントディレクトリに書き込む権限を持って確認してください。パラメータの<b>safe_modeが</b>このPHPが有効になっている場合、Speedealing PHPファイルは、Webサーバーのユーザー（またはグループ）に所有していることを確認してください。',
		...
		'ErrorExportDuplicateProfil' => 'このプロファイリングの名前は、このエクスポート·セットにすでに存在しています。',
		'ErrorLDAPSetupNotComplete' => 'Speedealing-LDAPのマッチングは完全ではありません。',
		...
		'ErrorDatabaseParameterWrong' => 'データベースの設定パラメータ<b>\'%s</b> &quot; <b>は</b> Speedealing（値&quot; <b>%s</b> &quot; <b>を</b>持っている必要があります）を使用するために互換性がない値を持っています。',
		...
		'ErrorForbidden' => 'アクセスが拒否されました。 <br>あなたがページにアクセスしようとすると、認証されたセッションまたはそのにいない領域や機能は、ユーザーに許可されていません。',
		'ErrorForbidden2' => 'このログインの許可は、メニュー%s  - &gt; %sからSpeedealing管理者によって定義することができます。',
		'ErrorForbidden3' => 'そのSpeedealingが認証セッションを介して使用されていないようです。認証を（htaccessファイルは、mod_authまたは他の...）を管理する方法を知ってSpeedealingセットアップドキュメントを見てみましょう。',
		'ErrorNoImagickReadimage' => 'クラスImagickが、このPHPで発見さ​​れていません。なしプレビューは利用できません。管理者は、メニューのSetupから、このタブを無効にすることができます - 表示します。',
