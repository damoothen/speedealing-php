...
$exports = array(
		...
		'SelectImportFields' => 'アンカー%sでダウンしてそれらを移動してデータベースにインポートするソース·ファイルのフィールドとそのターゲットフィールドを選択するか、または事前に定義されたインポートプロファイリングを選択します。',
		...
		'FieldsInTargetDatabase' => 'Speedealingデータベース内のターゲット·フィールド（* =必須）',
		'Field' => 'フィールド',
		'NoFields' => 'Noフィールド',
		...
		'FieldNeedSource' => 'データベース内のこのfielsは、ソースファイルからのデータを必要と',
		...
		'DataLoadedWithId' => '<b>%s：</b>すべてのデータは、次のimport IDでロードされます',
		...
		'DataComeFromIdFoundFromRef' => 'ソース·ファイルのフィールド番号<b>%s</b>から来ている値が（だからrefを持つオブジェ<b>%s。</b>ソースファイルからはSpeedealingに存在する必要があります）を使用して、親オブジェクトのIDを見つけるために使用されます。',
		'DataComeFromIdFoundFromCodeId' => 'ソース·ファイルのフィールド番号<b>%s</b>から来ているコードが（だからソースファイルからコードがdictionnary <b>%s</b>に存在する必要があります）を使用して、親オブジェクトのIDを見つけるために使用されます。あなたがIDを知っていれば、あなたもソースファイルの代わりにコードにそれを使用することができます。インポートでは、両方のケースで動作する必要があります。',
