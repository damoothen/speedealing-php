...
$other = array(
		...
		'DemoDesc' => 'Speedealingは、いくつかの機能モジュールで構成されるコンパクトなERP / CRMです。これが発生しないようにすべてのモジュールが含まれているデモは、何の意味もない。ので、いくつかのデモのプロファイルが用意されています。',
		...
		'AuthenticationDoesNotAllowSendNewPassword' => '認証モードは<b>%s</b>です。 <br>このモードでは、Speedealingは知ってもパスワードを変更することはできません。 <br>あなたのパスワードを変更する場合は、システム管理者に問い合わせてください。',
