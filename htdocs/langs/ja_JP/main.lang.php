...
$main = array(
		...
		'ErrorConfigParameterNotDefined' => 'パラメータ<b>%sは</b> Speedealing configファイル<b>conf.php</b>内で定義されていません。',
		...
		'Administrator' => '管理者',
		'Undefined' => '未定義',
		'PasswordForgotten' => 'パスワードを忘れましたか？',
		'SeeAbove' => '上記参照',
		'HomeArea' => 'ホームエリア',
		'LastConnexion' => '最後の接続',
		...
		'PrecisionUnitIsLimitedToXDecimals' => 'Speedealingは<b>%s</b>進数に単価の精度を制限するためにセットアップした。',
		'DoTest' => 'テスト',
		'ToFilter' => 'フィルタ',
		...
		'Close2' => '閉じる',
		'Confirm' => '確認する',
		'ConfirmSendCardByMail' => 'あなたは本当に<b>%s</b>にメールでこのカードの内容を送信しますか？',
		'Delete' => '削除する',
		'Remove' => '削除する',
		'Resiliate' => 'Resiliate',
		'Cancel' => 'キャンセル',
		...
		'ThisLimitIsDefinedInSetup' => 'Speedealing制限（メニューホームセットアップ·セキュリティ）：%s KB、PHP制限：%s KB',
