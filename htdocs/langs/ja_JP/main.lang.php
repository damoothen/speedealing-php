...
$main = array(
		...
		'IsNotDefined' => '未定義',
		'DolibarrInHttpAuthenticationSoPasswordUseless' => 'Dolibarr認証モードは、コンフィギュレーションファイルの<b>conf.php</b>で<b>%s</b>にセットアップされます。 <br>これは、パスワードデータベースがDolibarrにはexternであることを意味しますので、このフィールドを変更しても効果がない場合があります。',
		'Administrator' => '管理者',
		'Undefined' => '未定義',
