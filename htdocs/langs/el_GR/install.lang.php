...
$install = array(
		...
		'AdminLoginAlreadyExists' => 'Speedealing administrator account \'<b>%s</b>\' already exists.',
		...
		'KeepDefaultValuesDeb' => 'You use the Speedealing setup wizard from an Ubuntu or Debian package, so values proposed here are already optimized. Only the password of the database owner to create must be completed. Change other parameters only if you know what you do.',
		...
		'KeepDefaultValuesProxmox' => 'Μπορείτε να χρησιμοποιήσετε τον οδηγό ρυθμίσεων Speedealing από μια συσκευή Proxmox εικονική, οπότε οι τιμές που προτείνονται εδώ ήδη βελτιστοποιηθεί. Αλλάξτε τους μόνο εάν ξέρετε τι κάνετε.',
