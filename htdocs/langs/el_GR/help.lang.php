...
$help = array(
		...
		'ToGetHelpGoOnSparkAngels3' => 'Μπορείτε επίσης να πάτε στη λίστα όλων των διαθέσιμων προπονητών για Speedealing, γι \'αυτό κάντε κλικ στο κουμπί',
		...
		'LinkToGoldMember' => 'Μπορείτε να καλέσετε ένα από τα πούλμαν που έχουν επιλέξει Speedealing για τη γλώσσα σας (%s) κάνοντας κλικ Widget του (κατάσταση και μέγιστη τιμή ενημερώνονται αυτόματα):',
		'PossibleLanguages' => 'Υποστηριζόμενες γλώσσες',
		'MakeADonation' => 'Βοήθεια Speedealing έργο, κάνουν μια δωρεά',
