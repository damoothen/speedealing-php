...
$errors = array(
		...
		'ErrorUserCannotBeDelete' => 'Ο χρήστης μπορεί να διαγραφεί. Μπορεί να συνδέεται με Speedealing οντότητες.',
		'ErrorFieldsRequired' => 'Ορισμένα από τα απαιτούμενα πεδία δεν είχαν πληρωθεί.',
		'ErrorFailedToCreateDir' => 'Απέτυχε να δημιουργήσει έναν κατάλογο. Βεβαιωθείτε ότι το Web server χρήστης έχει δικαιώματα να γράψει στο κατάλογο Speedealing έγγραφα. Αν <b>safe_mode</b> παράμετρος είναι ενεργοποιημένη για το PHP, ελέγξτε ότι Speedealing αρχεία php κατέχει σε web server χρήστη (ή ομάδα).',
		...
		'ErrorLDAPSetupNotComplete' => 'Speedealing-LDAP αντιστοίχιση δεν είναι πλήρης.',
		...
		'ErrorDatabaseParameterWrong' => '<b>«%s&quot;</b> Database παράμετρος ρύθμισης έχει μια αξία δεν είναι συμβατή με τη χρήση Speedealing (πρέπει να έχει <b>«%s</b> &#39;αξία).',
		...
		'ErrorForbidden2' => 'Η άδεια για αυτή τη σύνδεση μπορεί να οριστεί από το διαχειριστή σας Speedealing από το μενού %s-> %s.',
		'ErrorForbidden3' => 'Φαίνεται ότι Speedealing δεν χρησιμοποιείται μέσω επικυρωμένο συνεδρία. Ρίξτε μια ματιά στην τεκμηρίωση της εγκατάστασης Speedealing να ξέρει πώς να διαχειριστεί authentications (htaccess, mod_auth ή άλλα ...).',
