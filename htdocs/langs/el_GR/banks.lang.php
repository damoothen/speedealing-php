...
$banks = array(
		...
		'TransferDesc' => 'Μεταφορά από έναν λογαριασμό σε άλλον. Το  Speedealing θα γράψει δύο βιβλία (χρεωστικό στον λογαριασμό πηγή και πιστωτικό στο λογαριασμό στόχο,με το ίδιο ποσό. Η ίδια ετικέτα και ημερομηνία θα χρησιμοποιηθούν για αυτή τη συναλλαγή)',
		'TransferFrom' => 'Από',
		'TransferTo' => 'Προς',
