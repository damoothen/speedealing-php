...
$members = array(
		...
		'SetLinkToUser' => 'Σύνδεση σε ένα χρήστη του Speedealing',
		'SetLinkToThirdParty' => 'Σύνδεση σε ένα στοιχείο του Speedealing',
		...
		'FollowingLinksArePublic' => 'The following links are open pages not protected by any Speedealing permission. They are not formated pages, provided as example to show how to list members database.',
		'PublicMemberList' => 'Λίστα δημόσιων μελών',
		'BlankSubscriptionForm' => 'Subscription form',
		'BlankSubscriptionFormDesc' => 'Speedealing μπορεί να σας παρέχει μια δημόσια διεύθυνση URL για να επιτρέψουν σε εξωτερικούς επισκέπτες να ζητήσει να εγγραφεί στο ίδρυμα. Εάν μια ηλεκτρονική πληρωμή μονάδα είναι ενεργοποιημένη, μια μορφή πληρωμής θα πρέπει επίσης να παρέχονται αυτόματα.',
