...
$agenda = array(
		...
		'OrderApprovedInDolibarr' => '%s Παραγγελία εγκριθεί',
		'OrderBackToDraftInDolibarr' => '%s Τάξης να επιστρέψετε στην κατάσταση σχέδιο',
		'OrderCanceledInDolibarr' => '%s για ακυρώσεις',
