...
$main = array(
		...
		'ErrorConfigParameterNotDefined' => 'Η παράμετρος <b>%s</b> δεν είναι καθορισμένη στο αρχείο ρυθμίσεων του Speedealing <b>conf.php</b>.',
		...
		'PrecisionUnitIsLimitedToXDecimals' => 'Το Speedealing ρυθμίστηκε να περιορίζει την ακρίβεια των τιμών σε <b>%s</b> δεκαδικά ψηφία.',
		'DoTest' => 'Δοκιμή',
		'ToFilter' => 'Φίλτρο',
		...
		'ThisLimitIsDefinedInSetup' => 'Όριο Speedealing (Μενού Ρυθμίσεις-Ασφάλεια): %s Kb, Όριο PHP: %s Kb',
