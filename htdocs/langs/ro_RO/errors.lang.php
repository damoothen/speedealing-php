...
$errors = array(
		...
		'ErrorUserCannotBeDelete' => 'Utilizatorul nu poate fi şters. Mai fi ce este asociată pe Speedealing entităţi.',
		'ErrorFieldsRequired' => 'Unele campuri obligatorii nu au fost ocupate.',
		'ErrorFailedToCreateDir' => 'Nu a reuşit să creeze un director. Verificaţi ca server Web utilizator are permisiuni pentru a scrie în directorul de Speedealing documente. Dacă <b>safe_mode</b> parametru este activat pe această PHP, Speedealing verifica faptul că fişierele PHP detine la server web utilizator (sau grup).',
		...
		'ErrorLDAPSetupNotComplete' => 'Speedealing-LDAP de potrivire nu este completă.',
		...
		'ErrorDatabaseParameterWrong' => 'parametru de configurare baza de date <b>\'%s</b> "are o valoare care nu este compatibil de a folosi Speedealing (valoarea trebuie să aibă" <b>%s</b> ").',
		...
		'ErrorForbidden2' => 'Permisiunea pentru acest login poate fi definită de către administratorul dvs. Speedealing din meniul %s-> %s.',
		'ErrorForbidden3' => 'Se pare că Speedealing nu este utilizat autentificate printr-o sesiune. Aruncati o privire la documentaţia de instalare Speedealing să ştie cum să gestioneze authentications (htaccess, mod_auth sau alte ...).',
