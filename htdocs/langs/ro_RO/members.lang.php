...
$members = array(
		...
		'SetLinkToUser' => 'Link de la un utilizator Speedealing',
		'SetLinkToThirdParty' => 'Link de la o terţă parte Speedealing',
		...
		'FollowingLinksArePublic' => 'Link-urile următoare sunt deschise pagini nu protejate de orice Speedealing permisiunea. Ele nu sunt formated pagini, cu condiţia ca exemplu pentru a demonstra modul de a lista membrilor de baze de date.',
		'PublicMemberList' => 'Publică lista membru',
		'BlankSubscriptionForm' => 'Abonamente forma',
		'BlankSubscriptionFormDesc' => 'Speedealing poate oferi un URL publicului pentru a permite vizitatorilor externe pentru a cere să se aboneze la fundaţie. Dacă un modul de plata online este activat, un formular de plată va fi, de asemenea, furnizate în mod automat.',
		...
		'DOLIBARRFOUNDATION_PAYMENT_FORM' => 'Pentru a face plata abonamentului folosind un transfer bancar, a se vedea pagina <a target="_blank" href="http://wiki.speedealing.org/index.php/Subscribe#To_subscribe_making_a_bank_transfer">http://wiki.speedealing.org/index.php/Subscribe</a> . <br> Pentru a plăti cu un card de credit sau Paypal, faceţi clic pe butonul de la partea de jos a acestei pagini. <br>',
