...
$banks = array(
		...
		'TransferDesc' => 'Siirtäminen tililtä toiselle yhden, Speedealing kirjoittaa kaksi tietuetta (luottotililtä vuonna lähdetiliksi ja luottoa tavoite huomioon, että sama määrä. Sama merkki ja päivämäärä voidaan käyttää tästä tapahtumasta)',
		'TransferFrom' => 'Mistä',
