...
$errors = array(
		...
		'ErrorUserCannotBeDelete' => 'Käyttäjä ei voi poistaa. Voi olla se liittyy annetun Speedealing yhteisöjä.',
		'ErrorFieldsRequired' => 'Jotkin vaaditut kentät eivät ole täytetty.',
		'ErrorFailedToCreateDir' => 'Luominen epäonnistui hakemiston. Tarkista, että Web-palvelin käyttäjällä on oikeudet kirjoittaa Speedealing asiakirjat hakemistoon. Jos parametri <b>safe_mode</b> on käytössä tämän PHP, tarkista, että Speedealing php tiedostot omistaa web-palvelimen käyttäjä (tai ryhmä).',
		...
		'ErrorLDAPSetupNotComplete' => 'Speedealing-LDAP yhteensovitus ei ole täydellinen.',
		...
		'ErrorDatabaseParameterWrong' => 'Tietokannan asetukset parametri <b>"%s"</b> on arvo ei ole yhteensopiva käyttää Speedealing (on arvo <b>"%s).</b>',
		...
		'ErrorForbidden2' => 'Lupa tämän sisäänkirjoittautumissivuksesi voidaan määritellä oma Speedealing järjestelmänvalvoja valikkopalkki %s-> %s.',
		'ErrorForbidden3' => 'Vaikuttaa siltä, että Speedealing ei käytetä kautta autentikoitu istunnossa. Tutustu Speedealing setup asiakirjat tietää, miten hallita authentications (htaccess, mod_auth tai muita ...).',
