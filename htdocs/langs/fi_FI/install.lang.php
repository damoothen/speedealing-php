...
$install = array(
		'CHARSET' => 'UTF-8',
		'InstallEasy' => 'Me yritimme tehdä Speedealing setup mahdollisimman helppoa. Seuraa ohjeita vaihe vaiheelta.',
		...
		'ErrorPHPDoesNotSupportSessions' => 'Sinun PHP asennus ei tue istunnoissa. Tämä ominaisuus on velvollisuus tehdä Speedealing toimi. Tarkista PHP-asetukset.',
		'ErrorPHPDoesNotSupportGD' => 'Sinun PHP asennus ei tue graafisia toiminto GD. N: o kaavio on saatavilla.',
		'ErrorPHPDoesNotSupportUTF8' => 'Sinun PHP asennus ei tue UTF8 toimintoja. Speedealing ei toimi oikein. Ratkaise tämä ennen asennusta Speedealing.',
		...
		'SystemIsUpgraded' => 'Speedealing on päivitetty onnistuneesti.',
		'YouNeedToPersonalizeSetup' => 'You need to configure Speedealing vastaamaan tarpeisiin (ulkonäkö, ominaisuudet, ...). Voit tehdä tämän alla olevasta linkistä:',
		'AdminLoginCreatedSuccessfuly' => 'Speedealing ylläpitäjä sisäänkirjoittautumissivuksesi <b>\' %s\'</b> on luotu onnistui.',
		'GoToSpeedealing' => 'Go to Speedealing',
		'GoToSetupArea' => 'Siirry Speedealing (setup-alue)',
		...
		'AdminLoginAlreadyExists' => 'Speedealing järjestelmänvalvojan tili <b>\' %s\'</b> on jo olemassa.',
		...
		'Upgrade' => 'Päivitys',
		'UpgradeDesc' => 'Käytä tätä tilaa, jos sinulla on korvattu vanha Speedealing tiedostoja tiedostot uudemmalla versiolla. Tämä päivittää tietokantaan ja tietoja.',
		'Start' => 'Alku',
		...
		'KeepDefaultValuesDeb' => 'Voit käyttää Speedealing ohjatun peräisin Ubuntu tai Debian-pakettien, joten ehdottamat arvot tässä on jo optimoitu. Vain salasanan tietokannan omistajan luoda on täytettävä. Muuta muut parametrit vain, jos tiedät mitä teet.',
		...
		'KeepDefaultValuesProxmox' => 'Käytät Speedealing ohjatun päässä Proxmox virtuaalinen laite, joten ehdotetut arvot tässä on jo optimoitu. Muuta niitä vain, jos tiedät mitä teet.',
