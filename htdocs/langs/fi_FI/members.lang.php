...
$members = array(
		...
		'SetLinkToUser' => 'Linkki on Speedealing käyttäjä',
		'SetLinkToThirdParty' => 'Linkki on Speedealing kolmannen osapuolen',
		...
		'FollowingLinksArePublic' => 'Seuraavat linkit ovat avoinna sivua ei ole suojattu millään Speedealing lupaa. Ne eivät ole formated sivua, jos esimerkkinä osoittaakseen, miten listan jäsenille tietokantaan.',
		'PublicMemberList' => 'Julkiset jäsenluetteloa',
		'BlankSubscriptionForm' => 'Merkintälomake',
		'BlankSubscriptionFormDesc' => 'Speedealing voi tarjota sinulle julkista URL jotta ulkopuolisia vierailijoita pyytää tilata perusta. Jos online-maksu moduuli on käytössä, maksuvälineenä myös automaattisesti säädetään.',
		...
		'DOLIBARRFOUNDATION_PAYMENT_FORM' => 'Voit tehdä tilauksen maksun avulla pankkisiirrolla sivulla <a target="_blank" href="http://wiki.speedealing.org/index.php/Subscribe#To_subscribe_making_a_bank_transfer">http://wiki.speedealing.org/index.php/Subscribe</a> . <br> Voit maksaa luottokortilla tai PayPal, klikkaa painiketta sivun alalaidassa. <br>',
