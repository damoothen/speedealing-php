...
$agenda = array(
		...
		'ListOfEvents' => 'Luettelo Speedealing tapahtumat',
		...
		'AgendaAutoActionDesc' => 'Määritä tässä tapahtumia joihin haluat Speedealing luoda automaattisesti toimia asialistalla. Jos mitään ei tarkastettu (oletuksena), vain ruumiillisen toimien on oltava mukana esityslistalla.',
		'AgendaSetupOtherDesc' => 'Tämän sivun avulla määrittää muita muuttujia Esityslistan moduuli.',
		'AgendaExtSitesDesc' => 'Tällä sivulla voit ilmoittaa ulkoisten kalenterien näkemään tapahtumiin otetaan Speedealing asialistalle.',
		'ActionsEvents' => 'Tapahtumat, joista Speedealing luo toimia esityslistan automaattisesti',
