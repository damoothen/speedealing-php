...
$users = array(
		...
		'SubjectNewPassword' => 'Uusi salasana Speedealing',
		...
		'ExportDataset_user_1' => 'Speedealing käyttäjille ja ominaisuudet',
		'DomainUser' => 'Domain käyttäjän %s',
		'Reactivate' => 'Uudelleenaktivoi',
		'CreateInternalUserDesc' => 'Tämän lomakkeen avulla voit luotu käyttäjän sisäinen yrityksenne / perusta. Voit luotu ulkopuolinen käyttäjä (asiakas, toimittaja, ...), käytä painiketta Luo Speedealing käyttäjä "kolmannen osapuolen yhteystiedot kortin.',
		'InternalExternalDesc' => '<b>Sisäinen</b> käyttäjä on käyttäjä, joka on osa yrityksen / perusta. <br> <b>Ulkoinen</b> käyttäjä on asiakas, toimittaja tai muu. <br><br> Molemmissa tapauksissa, oikeudet määritellään oikeuksia Speedealing myös ulkoinen käyttäjä voi olla eri valikosta johtaja kuin sisäinen käyttäjä (Katso etusivu - Asetukset - Display)',
		...
		'ConfirmCreateContact' => 'Oletko varma yu haluamme luoda Speedealing huomioon tässä yhteydessä?',
		'ConfirmCreateLogin' => 'Oletko varma, että haluat luoda Speedealing huomioon tämän jäsen?',
