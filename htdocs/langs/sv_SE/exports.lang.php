...
$exports = array(
		...
		'FieldsInTargetDatabase' => 'Mål fält i Speedealing databas (*= obligatoriska)',
		'Field' => 'Fält',
		'NoFields' => 'Inga fält',
		...
		'DataComeFromIdFoundFromRef' => 'Värde som kommer från flera <b>%s</b> på källfil kommer att användas för att hitta ID förälder motsätta sig att använda (Så objet <b>%s</b> som har ref. Från källfilen måste finns i Speedealing).',
