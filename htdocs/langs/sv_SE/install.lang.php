...
$install = array(
		...
		'ErrorPHPDoesNotSupportSessions' => 'Din PHP-installation inte stöd sessioner. Denna funktion är skyldig att Speedealing fungerar. Kolla din PHP-konfiguration.',
		...
		'ErrorPHPDoesNotSupportUTF8' => 'Din PHP-installation inte stöd för UTF8 funktioner. Speedealing kan inte fungera korrekt. Lösa det här innan du installerar Speedealing.',
		...
		'SystemIsUpgraded' => 'Speedealing har uppgraderats med framgång.',
		'YouNeedToPersonalizeSetup' => 'Du måste konfigurera Speedealing till era behov (utseende, funktioner, ...). För att göra detta, följ länken nedan:',
		'AdminLoginCreatedSuccessfuly' => 'Speedealing administratören logik <b>&quot;%s&quot;</b> skapade successfuly.',
		'GoToSpeedealing' => 'Go to Speedealing',
		'GoToSetupArea' => 'Gå till Speedealing (setup-området)',
		...
		'AdminLoginAlreadyExists' => 'Speedealing administratörskonto <b>&quot;%s&quot;</b> finns redan.',
		...
		'Upgrade' => 'Uppgradera',
		'UpgradeDesc' => 'Använd detta läge om du har ersatt gamla Speedealing filer med filer från en nyare version. Detta kommer att uppgradera din databas och data.',
		'Start' => 'Start',
		...
		'KeepDefaultValuesWamp' => 'Du använder Speedealing inställningsguiden från DoliWamp, värden så som här föreslås är redan optimerade. Ändra dem bara om du vet vad du gör.',
		'KeepDefaultValuesDeb' => 'Du använder Speedealing inställningsguiden från en Ubuntu eller Debian, så värden som här föreslås är redan optimerade. Endast lösenord i databasen ägaren för att skapa måste fyllas. Ändra andra parametrar om du vet vad du gör.',
		'KeepDefaultValuesMamp' => 'Du använder Speedealing inställningsguiden från DoliMamp, värden så som här föreslås är redan optimerade. Ändra dem bara om du vet vad du gör.',
		'KeepDefaultValuesProxmox' => 'Du använder Speedealing inställningsguiden från en Proxmox virtuell apparat, så som föreslås här är redan optimerade. Ändra dem bara om du vet vad du gör.',
