...
$users = array(
		...
		'SubjectNewPassword' => 'Ditt nya lösenord för Speedealing',
		...
		'ExportDataset_user_1' => 'Speedealing-användarnas behov och egenskaper',
		'DomainUser' => 'Domän användare %s',
		'Reactivate' => 'Återaktivera',
		'CreateInternalUserDesc' => 'Detta formulär låter dig creat en användare internt på ditt företag / stiftelse. För att creat en extern användare (kund, leverantör, ...), använda knappen &quot;Skapa Speedealing användare&quot; från tredje parts kontaktkort.',
		'InternalExternalDesc' => 'En <b>intern</b> användare är en användare som är en del av ert företag / stiftelse. <br> En <b>extern</b> användare är en kund, leverantör eller annan. <br><br> I båda fallen definierar behörigheter rättigheter Speedealing, även externa användare kan ha en annan meny manager än interna användare (Se startsida - Setup - Display)',
		...
		'ConfirmCreateContact' => 'Är du säker på att du vill skapa en Speedealing konto för denna kontakt?',
		'ConfirmCreateLogin' => 'Är du säker på att du vill skapa en Speedealing konto för denna medlem?',
