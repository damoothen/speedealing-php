...
$errors = array(
		...
		'ErrorUserCannotBeDelete' => 'Användaren kan inte tas bort. Får den hör samman på Speedealing enheter.',
		'ErrorFieldsRequired' => 'Vissa obligatoriska fält inte fylls.',
		'ErrorFailedToCreateDir' => 'Misslyckades med att skapa en katalog. Kontrollera att webbservern användaren har rättigheter att skriva till Speedealing dokument katalogen. Om parametern <b>safe_mode</b> är aktiv på PHP, kontrollera att Speedealing php-filer äger till webbserver användare (eller grupp).',
		...
		'ErrorLDAPSetupNotComplete' => 'Speedealing-LDAP matchning inte är fullständig.',
		...
		'ErrorDatabaseParameterWrong' => 'Database setup parameter <b>&quot;%s&quot;</b> har ett värde som inte är förenligt att använda Speedealing (måste ha värdet <b>&quot;%s).</b>',
		...
		'ErrorForbidden2' => 'Tillstånd för den här inloggningen kan definieras av din Speedealing administratör från menyn %s-> %s.',
		'ErrorForbidden3' => 'Det verkar som Speedealing inte används genom en bestyrkt session. Ta en titt på Speedealing setup dokumentation för att veta hur man ska hantera verifieringar (htaccess, mod_auth eller andra ...).',
