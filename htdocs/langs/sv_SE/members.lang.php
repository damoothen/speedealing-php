...
$members = array(
		...
		'SetLinkToUser' => 'Länk till en Speedealing användare',
		'SetLinkToThirdParty' => 'Länk till en Speedealing tredje part',
		...
		'FollowingLinksArePublic' => 'Följande länkar är öppna sidor som inte skyddas av någon Speedealing tillstånd. De är inte formaterad sidor, ges som exempel som visar hur man kan lista medlemmar databasen.',
		'PublicMemberList' => 'Offentliga medlemslista',
		'BlankSubscriptionForm' => 'Anmälningssedel',
		'BlankSubscriptionFormDesc' => 'Speedealing kan ge dig en offentlig URL till tillåta externa besökare att be att prenumerera på stiftelsen. Om en online-betalning modulen är aktiverad, kommer en inbetalningskort även lämnas ut automatiskt.',
		...
		'GlobalConfigUsedIfNotDefined' => 'Text som anges i stiftelsen modulen installationen kommer att användas om inte definieras här',
		'MayBeOverwrited' => 'Denna text kan overwrited i värde definieras för medlemmens typ',
		...
		'MoreActions' => 'Kompletterande åtgärder för inspelning',
		'MoreActionBankDirect' => 'Skapa en direkt transaktionsregister på grund',
		'MoreActionBankViaInvoice' => 'Skapa en faktura och delbetalning',
		'MoreActionInvoiceOnly' => 'Skapa en faktura utan betalning',
		'LinkToGeneratedPages' => 'Generera besök kort',
		...
		'SubscriptionsStatistics' => 'Statistik om abonnemang',
		'NbOfSubscriptions' => 'Antal abonnemang',
		'AmountOfSubscriptions' => 'Mängd abonnemang',
		...
		'Entreprises' => 'Företag',
		'DOLIBARRFOUNDATION_PAYMENT_FORM' => 'För att göra din prenumeration betalning via en banköverföring, se sidan <a target="_blank" href="http://wiki.speedealing.org/index.php/Subscribe#To_subscribe_making_a_bank_transfer">http://wiki.speedealing.org/index.php/Subscribe</a> . <br> Att betala med kreditkort eller Paypal, klicka på knappen längst ner på denna sida. <br>',
