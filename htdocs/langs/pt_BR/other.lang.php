...
$other = array(
		...
		'DemoDesc' => 'Speedealing não é um ERP monolítico, mas está composto de módulos funcionais simples e opcionais. Uma demonstração que inclua todos estes módulos não tem sentido, já que nunca mais todos os módulos são utilizados. De todas maneras existe disponíveis muitos perfis de demonstração',
		...
		'AuthenticationDoesNotAllowSendNewPassword' => 'o modo de autentificação de Speedealing está configurado como "<b>%s</b>".<br>neste modo Speedealing não pode conhecer nem modificar a sua senha<br>Contacte com a sua administrador para conhecer as modalidades de alterar.',
