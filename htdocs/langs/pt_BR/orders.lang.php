...
$orders = array(
		...
		//// Fazer a programa��o da NFE dentro do m�dulo de Pedidos. � o jeito indo pelos status. Ir pesquisando no src code pelo status Processado (StatusOrderProcessedShort)
		//// Incluir o src code da NFE como os pedidos e propostasanexas na negocia��o.
