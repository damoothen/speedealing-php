...
$errors = array(
		...
		'ErrorUserCannotBeDelete' => 'o usuário não pode ser eliminado. Quizá esé associado a elementos de Speedealing.',
		'ErrorFieldsRequired' => 'não se indicaron Alguns campos obrigatórios',
		'ErrorFailedToCreateDir' => 'Error na creação de uma carpeta. Compruebe que 0 usuario del servidor Web tiene derechos de escritura en las carpetas de documentos de Speedealing. Si 0  parámetro <b>safe_mode</b> está ativo en este PHP, Compruebe que los archivos php speedealing pertencen ao usuario del servidor Web.',
		...
		'ErrorForbidden2' => 'Os permissões para este usuário podem ser designados por o administrador Speedealing mediante o menu %s-> %s.',
		'ErrorForbidden3' => 'Speedealing não parece funcionar em uma Sessão autentificada. Consulte a documentação de Instalação de Speedealing para saber cómo administrar as autenticaciones (htaccess, mod_auth u outro...).',
