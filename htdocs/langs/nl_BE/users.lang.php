...
$users = array(
		...
		'ExportDataset_user_1' => 'Speedealing gebruikers en eigenschappen',
		'DomainUser' => 'Domeingebruikersaccount %s',
		'Reactivate' => 'Reactiveren',
		'CreateInternalUserDesc' => 'Dit formulier laat u toe om een interne gebruiker te maken binnen uw bedrijf. Als u een externe gebruiker (klant, leverancier, ...) wil maken, gebruik de knop "Creëer Speedealing gebruiker" uit derde partij contactkaart.',
		'InternalExternalDesc' => 'Een <b>interne</b> gebruiker is een gebruiker die deel uitmaakt van uw bedrijf. <br> Een <b>externe</b> gebruiker is een klant, leverancier of andere. <br><br> In beide gevallen, machtigingen omschrijft de rechten op Speedealing, ook externe gebruiker kan beschikken over een ander menu manager dan een interne gebruiker (Zie Home - Opstelling - Display)',
