...
$agenda = array(
		...
		'ListOfEvents' => 'Lijst van Speedealing evenementen',
		...
		'AgendaAutoActionDesc' => 'Definieer hier evenementen waarvoor u wilt dat Speedealing automatisch een actie op de agenda creëert. Als er niets is aangevinkt (standaard), alleen handmatige acties zullen worden opgenomen in de agenda.',
		'AgendaSetupOtherDesc' => 'This page provides options to allow export of your Speedealing events into an external calendar (thunderbird, google calendar, ...)',
		'AgendaExtSitesDesc' => 'This page allows to declare external sources of calendars to see their events into Speedealing agenda.',
		'ActionsEvents' => 'Evenementen waarvan Speedealing automatisch een actie in de agenda zal creëren',
