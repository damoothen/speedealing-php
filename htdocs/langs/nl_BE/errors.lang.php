...
$errors = array(
		...
		'ErrorFailedToCreateDir' => 'Mislukt om een directory te creëren. Check that Web server user has permissions to write into Speedealing documents directory. If parameter <b>safe_mode</b> is enabled on this PHP, check that Speedealing php files owns to web server user (or group).',
		...
		'ErrorLDAPSetupNotComplete' => 'Speedealing LDAP-matching is niet compleet.',
		...
		'ErrorForbidden2' => 'De machtigingen voor deze aanmelding kan worden verleend door de beheerder van Speedealing via menu %s -> %s.',
		'ErrorForbidden3' => 'Speedealing lijkt niet te werken binnen een geauthentiseerde sessie. Raadpleeg de installatie documentatie voor Speedealing over hoe de authenticatie te beheren (htaccess, mod_auth of andere ...).',
