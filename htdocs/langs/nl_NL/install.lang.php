...
$install = array(
		...
		'ErrorPHPDoesNotSupportSessions' => 'Uw PHP installatie ondersteund geen sessies. Dit is vereist voor een goede werking van Speedealing. Controleer uw PHP instellingen.',
		'ErrorPHPDoesNotSupportGD' => 'Uw PHP installatie ondersteund geen grafische functies. Grafieken zullen niet beschikbaar zijn.',
		'ErrorPHPDoesNotSupportUTF8' => 'Uw PHP installatie ondersteund geen UTF8 functies. Speedealing kan daardoor niet goed werken. Los dit op voordat u verder gaat met de installatie van Speedealing.',
		...
		'SystemIsUpgraded' => 'Speedealing is succesvol bijgewerkt.',
		'YouNeedToPersonalizeSetup' => 'U dient Speedealing naar eigen behoefte in te richten (uiterlijk, functionaliteit, etc). Volgt u om dit te doen de onderstaande link:',
		'AdminLoginCreatedSuccessfuly' => 'Speedealing beheerdersaccount <b>\'%s\'</b> succesvol gecreëerd.',
		'GoToSpeedealing' => 'Go to Speedealing',
		'GoToSetupArea' => 'Ga naar Speedealing (instellingsomgeving)',
		...
		'WarningRemoveInstallDir' => 'Waarschuwing, om veiligheidsredenen, dient u de <b>install</b> map na de installatie of upgrade te verwijderen of maak een bestand genaamd <b>install.lock</b> aan in de Speedealing root map.',
		...
		'FreshInstallDesc' => 'Kies deze optie wanneer dit de eerste keer is dat u Speedealing installeert of wanneer u een voorgaande incomplete installatie wilt repareren. Wanneer u uw versie wilt bijwerken, kiest u dan voor de optie "Upgrade".',
		'Upgrade' => 'Upgrade',
		'UpgradeDesc' => 'Gebruik deze optie wanneer u oude Speedealing bestanden wilt vervangen met bestanden van een nieuwe versie. Dit zal uw database en bestanden bijwerken.',
		'Start' => 'Start',
		...
		'KeepDefaultValuesWamp' => 'U gebruikt de Speedealing installatiewizard van DoliWamp, dus de hier voorgestelde waarden zijn al geoptimaliseerd. Wijzig ze alleen wanneer u weet wat u doet.',
		'KeepDefaultValuesDeb' => 'U gebruikt de Speedealing installatiewizard uit een Ubuntu of Debian pakket, dus de hier voorgestelde waarden zijn al geoptimaliseerd. Alleen het wachtwoord van de te creëren database-eigenaar moeten worden ingevuld. Wijzig de andere waarden alleen als u weet wat u doet.',
		'KeepDefaultValuesMamp' => 'U gebruikt de Speedealing installatiewizard van DoliMamp, dus de hier voorgestelde waarden zijn al geoptimaliseerd. Wijzig ze alleen wanneer u weet wat u doet.',
		'KeepDefaultValuesProxmox' => 'U gebruikt de Speedealing installatiewizard van een Proxmox virtueel systeem, dus de hier voorgestelde waarden zijn al geoptimaliseerd. Wijzig ze alleen wanneer u weet wat u doet.',
