...
$errors = array(
		...
		'ErrorUserCannotBeDelete' => 'Gebruiker kan niet worden verwijderd. Misschien is het gekoppeld aan Speedealing entiteiten.',
		'ErrorFieldsRequired' => 'Enkele verplichte velden zijn niet ingevuld.',
		'ErrorFailedToCreateDir' => 'Creëren van een map mislukt. Controleer of de Webservergebruiker toestemming heeft om te schrijven in Speedealing documentenmap. Wanneer de parameter <b>safe_mode</b> is ingeschakeld in PHP, controleer dan dat de Speedealing php bestanden eigendom zijn van de de webserve gebruiker (of groep).',
		...
		'ErrorLDAPSetupNotComplete' => 'De Speedealing-LDAP installatie is niet compleet.',
		...
		'ErrorDatabaseParameterWrong' => 'Database instelling <b>%s</b> heeft een waarde die niet compatibel is met het gebruik Speedealing (moet de waarde \'<b>%s</b>\' hebben).',
		...
		'ErrorProductWithRefNotExist' => 'Product met referentie <i>%s</i> bestaan ​​niet',
		...
		'ErrorForbidden2' => 'Toestemming voor deze aanmelding kan worden ingesteld door de Speedealing-beheerder vanaf het menu %s -> %s.',
		'ErrorForbidden3' => 'Het lijkt erop dat Speedealing niet wordt gebruikt met een geverifieerde sessie. Kijk eens naar de Speedealing installatiedocumentatie om te weten hoe het beheer van verificaties (htaccess, mod_auth of andere) werkt.',
