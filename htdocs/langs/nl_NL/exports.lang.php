...
$exports = array(
		...
		'FieldsInTargetDatabase' => 'Doelvelden in de Speedealing database (*=verplicht)',
		'Field' => 'veld',
		...
		'DataComeFromIdFoundFromRef' => 'De waarde van het veld verkregen vanaf regel <b>%s</b> uit het bronbestand zal worden gebruikt om het id van het bovenliggende object te vinden, zodat dit object gebruikt kan worden (Dus het object met id <b>%s</b> moet bestaan in Speedealing).',
		'DataComeFromIdFoundFromCodeId' => 'Code die afkomstig is van veldnummer <b>%s</b> van de bron-bestand wordt gebruikt om de id van bovenliggend object te vinden om te gebruiken (dus de code van de bron-bestand moet bestaan ​​in de woordenboek <b>%s).</b> Merk op dat als je weet id, kunt u ook het gebruik in plaats daarvan in het bronbestand van de code. Import zou moeten werken in beide gevallen.',
