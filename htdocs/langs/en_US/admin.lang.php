...
$admin = array(
		...
		'ConfirmLockNewSessions' => 'Are you sure you want to restrict any new Speedealing connection to yourself. Only user <b>%s</b> will be able to connect after that.',
		...
		'MenusEditorDesc' => 'The menu editor allow you to define personalized entries in menus. Use it carefully to avoid making speedealing unstable and menu entries permanently unreachable.<br>Some modules add entries in the menus (in menu <b>All</b> in most cases). If you removed some of these entries by mistake, you can restore them by disabling and reenabling the module.',
		...
		'PurgeAreaDesc' => 'This page allows you to delete all files built or stored by Speedealing (temporary files or all files in <b>%s</b> directory). Using this feature is not necessary. It is provided for users whose Speedealing is hosted by a provider that does not offer permissions to delete files built by the web server.',
		...
		'ModulesDesc' => 'Speedealing modules define which functionality is enabled in software. Some modules require permissions you must grant to users, after enabling module. Click on button on/off in column "Status" to enable a module/feature.',
		'ModulesInterfaceDesc' => 'The Speedealing modules interface allows you to add features depending on external software, systems or services.',
		'ModulesSpecialDesc' => 'Special modules are very specific or seldom used modules.',
		'ModulesJobDesc' => 'Business modules provide simple predefined setup of Speedealing for a particular business.',
		...
		'DoliStoreDesc' => 'DoliStore, the official market place for Speedealing ERP/CRM external modules',
		...
		'InstrucToEncodePass' => 'To have password encoded into the <b>conf.php</b> file, replace the line <br><b>$speedealing_main_db_pass="..."</b><br>by<br><b>$speedealing_main_db_pass="crypted:%s"</b>',
		'InstrucToClearPass' => 'To have password decoded (clear) into the <b>conf.php</b> file, replace the line <br><b>$speedealing_main_db_pass="crypted:..."</b><br>by<br><b>$speedealing_main_db_pass="%s"</b>',
		...
		'OfficialWebSite' => 'Speedealing international official web site',
		'OfficialWebSiteFr' => 'French official web site',
		'OfficialWiki' => 'Speedealing documentation on Wiki',
		'OfficialDemo' => 'Speedealing online demo',
		'OfficialMarketPlace' => 'Official market place for external modules/addons',
		'OfficialWebHostingService' => 'Official web hosting service (Cloud hosting)',
		'ForDocumentationSeeWiki' => 'For user or developer documentation (Doc, FAQs...),<br>take a look at the Speedealing Wiki:<br><b><a href="%s" target="_blank">%s</a></b>',
		'ForAnswersSeeForum' => 'For any other questions/help, you can use the Speedealing forum:<br><b><a href="%s" target="_blank">%s</a></b>',
		'HelpCenterDesc1' => 'This area can help you to get a Help support service on Speedealing.',
		...
		'SubmitTranslation' => 'If translation for this language is not complete or you find errors, you can correct this by editing files into directory <b>langs/%s</b> and submit modified files on www.speedealing.com forum.',
		...
		'SetupIsReadyForUse' => 'Install is finished and Speedealing is ready to use with this new component.',
		'NotExistsDirect' => 'The alternative root directory is not defined.<br>',
		'InfDirAlt' => 'Since version 3 it is possible to define an alternative root directory.This allows you to store, same place, plug-ins and custom templates.<br>Just create a directory at the root of Speedealing (eg: custom).<br>',
		'InfDirExample' => '<br>Then declare it in the file conf.php<br> $speedealing_main_url_root_alt=\'http://myserver/custom\'<br>$speedealing_main_document_root_alt=\'/path/of/speedealing/htdocs/custom\'<br>*These lines are commented with "#", to uncomment only remove the character.',
		'YouCanSubmitFile' => 'Select module:',
		'CurrentVersion' => 'Speedealing current version',
		...
		'UMaskExplanation' => 'This parameter allow you to define permissions set by default on files created by Speedealing on server (during upload for example).<br>It must be the octal value (for example, 0666 means read and write for everyone).<br>This parameter is useless on a Windows server.',
		...
		'KeyForWebServicesAccess' => 'Key to use Web Services (parameter "securekey" in webservices)',
		...
		'Module59Desc' => 'Add function to generate Bookmark4u account from a Speedealing account',
		...
		'Module100Desc' => 'Include any external web site into Speedealing menus and view it into a Speedealing frame',
		...
		'Module240Desc' => 'Tool to export Speedealing datas (with assistants)',
		'Module250Name' => 'Data imports',
		'Module250Desc' => 'Tool to import datas in Speedealing  (with assistants)',
		'Module310Name' => 'Members',
		'Module310Desc' => 'Foundation members management',
		'Module320Name' => 'RSS Feed',
		'Module320Desc' => 'Add RSS feed inside Speedealing screen pages',
		...
		'Module600Desc' => 'Send notifications by email on some Speedealing business events to third party contacts',
		...
		'Module2600Desc' => 'Enable the Speedealing web services server',
		...
		'SummaryConst' => 'List of all Speedealing setup parameters',
		...
		'SetupDescription1' => 'All parameters available in the setup area allow you to setup Speedealing before starting using it.',
		...
		'SetupDescription3' => 'Parameters in menu <a href="%s">Setup -> Company/foundation</a> are required because input information is used on Speedealing displays and to modify Speedealing behaviour (for example for features related to your country).',
		'SetupDescription4' => 'Parameters in menu <a href="%s">Setup -> Modules</a> are required because Speedealing is not a fixed ERP/CRM but a sum of several modules, all more or less independant. It\'s only after activating modules you\'re interesting in that you will see features appeared in menus.',
		...
		'ListOfSecurityEvents' => 'List of Speedealing security events',
		'SecurityEventsPurged' => 'Security events purged',
		'LogEventDesc' => 'You can enable here the logging for Speedealing security events. Administrators can then see its content via menu <b>System tools - Audit</b>. Warning, this feature can consume a large amount of data in database.',
		'AreaForAdminOnly' => 'Those features can be used by <b>administrator users</b> only.',
		'SystemInfoDesc' => 'System information is miscellaneous technical information you get in read only mode and visible for administrators only.',
		'SystemAreaForAdminOnly' => 'This area is available for administrator users only. None of the Speedealing permissions can reduce this limit.',
		...
		'DisplayDesc' => 'You can choose each parameter related to the Speedealing look and feel here',
		...
		'TriggersDesc' => 'Triggers are files that will modify the behaviour of Speedealing workflow once copied into the directory <b>htdocs/core/triggers</b>. They realised new actions, activated on Speedealing events (new company creation, invoice validation, ...).',
		...
		'TriggerAlwaysActive' => 'Triggers in this file are always active, whatever are the activated Speedealing modules.',
		...
		'OnceSetupFinishedCreateUsers' => 'Warning, you are a Speedealing administrator user. Administrator users are used to setup Speedealing. For a usual usage of Speedealing, it is recommended to use a non administrator user created from Users & Groups menu.',
		'MiscellanousDesc' => 'Define here all other parameters related to security.',
		'LimitsSetup' => 'Limits/Precision setup',
		'LimitsDesc' => 'You can define limits, precisions and optimisations used by Speedealing here',
		...
		'BackupDesc' => 'To make a complete backup of Speedealing, you must:',
		...
		'RestoreDesc' => 'To restore a Speedealing backup, you must:',
		'RestoreDesc2' => '* Restore archive file (zip file for example) of documents directory to extract tree of files in documents directory of a new Speedealing installation or into this current documents directoy (<b>%s</b>).',
		'RestoreDesc3' => '* Restore the data, from a backup dump file, into the database of the new Speedealing installation or into the database of this current installation. Warning, once restore is finished, you must use a login/password, that existed when backup was made, to connect again. To restore a backup database into this current installation, you can follow this assistant.',
		...
		'ProxyDesc' => 'Some features of Speedealing need to have an Internet access to work. Define here parameters for this. If the Speedealing server is behind a Proxy server, those parameters tells Speedealing how to access Internet through it.',
		...
		'SendmailOptionMayHurtBuggedMTA' => 'Feature to send mails using method "PHP mail direct" will generate a mail message that might be not correctly parsed by some receiving mail servers. Result is that some mails can\'t be read by people hosted by thoose bugged platforms. It\'s case for some Internet providers (Ex: Orange in France). This is not a problem into Speedealing nor into PHP but onto receiving mail server. You can however add option MAIN_FIX_FOR_BUGGED_MTA to 1 into setup - other to modify Speedealing to avoid this. However, you may experience problem with other servers that respect strictly the SMTP standard. The other solution (recommanded) is to use the method "SMTP socket library" that has no disadvantages.',
		...
		'PasswordGenerationStandard' => 'Return a password generated according to internal Speedealing algorithm: 8 characters containing shared numbers and characters in lowercase.',
		...
		'NotificationsDesc' => 'EMails notifications feature allows you to silently send automatic mail, for some Speedealing events, to third parties (customers or suppliers) that are configured to. Choice of active notification and targets contacts is made one third party at time.',
		...
		'WebCalSyncro' => 'Add Speedealing events to WebCalendar',
		...
		'LDAPDnSynchroActiveExample' => 'LDAP to Speedealing or Speedealing to LDAP synchronization',
		...
		'LDAPContactDn' => 'Speedealing contacts\' DN',
		'LDAPContactDnExample' => 'Complete DN (ex: ou=contacts,dc=society,dc=com)',
		'LDAPMemberDn' => 'Speedealing members DN',
		...
		'LDAPMemberTypeDn' => 'Speedealing members type DN',
		...
		'LDAPConnectToDNSuccessfull' => 'Connection au DN (%s) rï¿½ussie',
		...
		'LDAPDescContact' => 'This page allows you to define LDAP attributes name in LDAP tree for each data found on Speedealing contacts.',
		'LDAPDescUsers' => 'This page allows you to define LDAP attributes name in LDAP tree for each data found on Speedealing users.',
		'LDAPDescGroups' => 'This page allows you to define LDAP attributes name in LDAP tree for each data found on Speedealing groups.',
		'LDAPDescMembers' => 'This page allows you to define LDAP attributes name in LDAP tree for each data found on Speedealing members module.',
		...
		'YouCanUseDOL_DATA_ROOT' => 'You can use DOL_DATA_ROOT/speedealing.log for a log file in Speedealing "documents" directory. You can set a different path to store this file.',
		...
		////////// ClickToDial //////////
		'ClickToDialDesc' => 'This module allows to add an icon after phone numbers. A click on this icon will call a server with a particular URL you define below. This can be used to call a call center system from Speedealing that can call the phone number on a SIP system for example.',
		...
		'BookmarkDesc' => 'This module allows you to manage bookmarks. You can also add shortcuts to any Speedealing pages or externale web sites on your left menu.',
		'NbOfBoomarkToShow' => 'Maximum number of bookmarks to show in left menu',
		////////// WebServices //////////
		'WebServicesSetup' => 'Webservices module setup',
		'WebServicesDesc' => 'By enabling this module, Speedealing become a web service server to provide miscellaneous web services.',
		'WSDLCanBeDownloadedHere' => 'WSDL descriptor files of provided services can be download here',
		'EndPointIs' => 'SOAP clients must send their requests to the Speedealing endpoint available at Url',
		////////// Bank //////////
