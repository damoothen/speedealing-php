...
$companies = array(
		...
		'ProfId2TN' => 'Проф Id 2 (Финансовый matricule)',
		...
		'CompanyHasAbsoluteDiscount' => 'Этот клиент все еще имеет дисконтный кредит за <b>%s %s</b>',
		'CompanyHasCreditNote' => 'Этот клиент все еще имеет кредитовые авизо или предыдущие взносы за <b>%s %s</b>',
		...
		'AddContact' => 'Добавить контакт/адрес',
		...
		'AddThirdParty' => 'Добавить контрагента',
		...
		'ExportDataset_company_1' => 'Контрагенты (Компании/Организации) и свойства',
		...
		'AddDeliveryAddress' => 'Добавить адрес',
		...
		'ThirdPartiesArea' => 'Область контрагентов',
