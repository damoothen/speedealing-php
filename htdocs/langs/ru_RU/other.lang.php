...
$other = array(
		...
		'DemoDesc' => 'Speedealing является компактным ERP / CRM составе нескольких функциональных модулей. В демо, что включает в себя все модули, не означает ничего, как этого никогда не происходит. Так, несколько демо-профилей доступны.',
		...
		'AuthenticationDoesNotAllowSendNewPassword' => 'Аутентификация <b>режим %s.</b> <br> В этом режиме Speedealing можете не знать, ни изменить свой пароль. <br> Обратитесь к системному администратору, если вы хотите изменить свой пароль.',
