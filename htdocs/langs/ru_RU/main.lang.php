...
$main = array(
		...
		'ErrorConfigParameterNotDefined' => 'Параметр <b>%s</b> не определен внутри конфигурационного файла Speedealing <b>conf.php</b>.',
		...
		'PrecisionUnitIsLimitedToXDecimals' => 'Speedealing был настроен на ограничение точности цены единицы до <b>%s</b> десятых.',
		'DoTest' => 'Проверка',
		'ToFilter' => 'Фильтр',
		...
		'ThisLimitIsDefinedInSetup' => 'Лимит Speedealing (Меню Начало-Настройки-Безопасность): %s Кб, лимит PHP: %s Кб',
