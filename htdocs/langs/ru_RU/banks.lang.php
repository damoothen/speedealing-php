...
$banks = array(
		...
		'BankTransactionForCategory' => 'Банковские операции по <b>категории %s</b>',
		...
		'TransferDesc' => 'Перевод с одного счета на другой, Speedealing запишет две записи (в дебет счета источник и целевой кредит в счете, на ту же сумму. В тот же ярлык и даты будут использоваться для этой сделке)',
		'TransferFrom' => 'От',
		'TransferTo' => 'К',
