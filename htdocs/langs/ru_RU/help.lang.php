...
$help = array(
		'CHARSET' => 'UTF-8',
		'CommunitySupport' => 'Поддержка через Форум/Wiki',
		...
		'TypeOfHelp' => 'Тип',
		'NeedHelpCenter' => 'Нужна помощь или поддержка?',
		...
		'ToGetHelpGoOnSparkAngels3' => 'Вы также можете перейти к списку всех доступных тренеров Speedealing, для этого нажмите на кнопку',
		...
		'LinkToGoldMember' => 'Вы можете позвонить одному из отобранных тренеров Speedealing на вашем языке (%s), выбрав его Виджет (статус и максимальная цена звонка обновляются автоматически):',
		'PossibleLanguages' => 'Поддерживаемые языки',
		'MakeADonation' => 'Помогите проекту Speedealing, сделайте пожертвование',
