...
$members = array(
		...
		'SetLinkToUser' => 'Ссылка на Speedealing пользователя',
		'SetLinkToThirdParty' => 'Ссылка на Speedealing третья сторона',
		...
		'FollowingLinksArePublic' => 'Следующие ссылки открытых страниц не защищены какими-либо Speedealing разрешения. Они не отформатированный страниц при условии, что в качестве примера, чтобы показать, как в списке членов данных.',
		'PublicMemberList' => 'Общественная член списка',
		'BlankSubscriptionForm' => 'Форма подписки',
		'BlankSubscriptionFormDesc' => 'Speedealing может предоставить вам на общедоступный ресурс, чтобы позволить внешним посетителям попросить, чтобы подписаться на фундамент. Если модуль онлайн оплаты включена, форма оплаты будет автоматически предоставляется.',
		...
		'DOLIBARRFOUNDATION_PAYMENT_FORM' => 'Чтобы сделать вашу подписку оплаты с помощью банковского перевода, см. стр. <a target="_blank" href="http://wiki.speedealing.org/index.php/Subscribe#To_subscribe_making_a_bank_transfer">http://wiki.speedealing.org/index.php/Subscribe</a> . <br> Для оплаты с помощью кредитной карты или Paypal, нажмите на кнопку в нижней части этой страницы. <br>',
