...
$admin = array(
		...
		'SpeedealingSetup' => 'установка или обновление Speedealing',
		'SpeedealingUser' => 'пользователь Speedealing',
		...
		'ErrorModuleRequireSpeedealingVersion' => 'Ошибка, этот модуль требует Speedealing версии %s или выше',
		...
		'ParameterInSpeedealing' => 'Параметр %s',
		'LanguageParameter' => 'Язык параметр %s',
		'LanguageBrowserParameter' => 'Параметр %s',
		'LocalisationSpeedealingParameters' => 'Параметры локализации',
		...
		'Feature' => 'Особенность',
		'SpeedealingLicense' => 'Лицензия',
		'SpeedealingProjectLeader' => 'Руководитель проекта',
		...
		'UnpackPackageInSpeedealingRoot' => 'Распакуйте пакет в корневую директорию Speedealings: <b>%s</b>',
		...
		'Audit' => 'Аудит',
		'InfoSpeedealing' => 'Информации о Speedealing',
		'InfoOS' => 'Infos OS',
		...
		'LDAPToSpeedealing' => 'LDAP((облегчённый протокол доступа к каталогам)) -> Speedealing',
		'SpeedealingToLDAP' => 'Speedealing -> LDAP(облегчённый протокол доступа к каталогам)',
		...
		'LDAPSpeedealingMapping' => 'Карта Speedealing',
