...
$admin = array(
		...
		'ActivityStateToSelectCompany' => '添加一个过滤器的选项，以显示/隐藏thirdparties，这是在目前的活动或已停止',
		'SearchFilter' => '搜索过滤选项',
		'NumberOfKeyToSearch' => 'NBR的字符来触发搜索：%s',
		...
		'ClientOffsetWithGreenwich' => '客户机/浏览器偏移宽度格林威治时间（秒）',
		...
		'RunCommandSummaryToLaunch' => '可以用下面的命令启动备份',
		...
		'ImportPostgreSqlDesc' => '导入备份文件，你必须使用命令行pg_restore的命令：',
		...
		'FullPathToPostgreSQLdumpCommand' => 'pg_dump命令的完整路径',
		'ExportOptions' => '导出选项',
		...
		'NoLockBeforeInsert' => '周围的INSERT没有锁定命令',
		'DelayedInsert' => '延迟插入',
		...
		'CurrentSmartphoneMenuHandler' => '当前智能手​​机的菜单处理',
		'MeasuringUnit' => '计量单位',
		'Emails' => '电子邮件',
		'EMailsSetup' => '电子邮件设置',
		...
		'MAIN_MAIL_ERRORS_TO' => '错误回报电子邮件的发件人电子邮件发送',
		...
		'MAIN_DISABLE_ALL_SMS' => '禁用所有的短信sendings（用于测试目的或演示）',
		'MAIN_SMS_SENDMODE' => '使用方法发送短信',
		'MAIN_MAIL_SMS_FROM' => '默认发件人的电话号码发送短信',
		...
		'FollowingSubstitutionKeysCanBeUsed' => '<br>要知道如何创建您的ODT文档模板存储在这些目录，读取wiki文档：',
		'FullListOnOnlineDocumentation' => 'http://wiki.dolibarr.org/index.php/Create_an_ODT_document_template',
		'FirstnameNamePosition' => '的名字位置/名称',
		'DescWeather' => '下面的图片将会显示在仪表盘时，晚行动的数量达到以下值：',
		'KeyForWebServicesAccess' => '键来使用Web服务（在WebServices的参数“dolibarrkey”）',
		'TestSubmitForm' => '输入测试表',
		'ThisForceAlsoTheme' => '使用此菜单管理器，也将使用它自己的主题，无论是用户的选择。此菜单经理还专门为智能手机并不适用于所有的智能手机。使用另一个菜单管理器，如果你遇到你的问题。',
		'ThemeDir' => 'skins目录',
		'ConnectionTimeout' => '联接超时',
		'ResponseTimeout' => '响应超时',
		'SmsTestMessage' => '测试消息从_ PHONEFROM__ __ PHONETO__',
		'ModuleMustBeEnabledFirst' => '第一次使用此功能前，必须启用模块<b>%s。</b>',
		'SecurityToken' => '安全网址的关键',
		'NoSmsEngine' => '没有SMS发件人经理。短信发件人经理没有安装默认分配（因为他们依赖外部供应商），但你可以找到一些http://www.dolistore.com',
		'PDF' => 'PDF格式',
		'PDFDesc' => '你可以设置PDF生成有关的每个全局选项',
		'PDFAddressForging' => '伪造地址框的规则',
		'HideAnyVATInformationOnPDF' => '隐藏所有有关增值税生成的PDF信息',
		'HideDescOnPDF' => 'Hide products description on generated PDF',
		'HideRefOnPDF' => 'Hide products ref. on generated PDF',
		'HideDetailsOnPDF' => 'Hide products lines details on generated PDF',
		'UrlGenerationParameters' => '参数，以确保网址',
		'SecurityTokenIsUnique' => '每个URL使用独特的securekey参数',
		'EnterRefToBuildUrl' => '输入参考对象%s',
		'GetSecuredUrl' => '获取计算网址',
		...
		'Module105Name' => '梅尔曼和SIP',
		'Module105Desc' => '邮递员或SPIP成员模块接口',
		'Module200Name' => 'LDAP的',
		...
		'Module50000Name' => '出纳',
		'Module50000Desc' => '模块提供信用卡网上支付页面与出纳',
		'Module50100Name' => '销售点',
		...
		'Permission342' => '创建/修改自己的用户信息',
		'Permission343' => '修改自己的密码',
		'Permission344' => '修改其自己的权限',
		'Permission351' => '阅读群体',
		...
		'DictionnaryStaff' => '员工',
		'DictionnaryAvailability' => '迟延交付',
		'DictionnaryOrderMethods' => '排列方法',
		'DictionnarySource' => '建议/订单的起源',
		...
		'SomeTranslationAreUncomplete' => '有些语言可能被部分翻译或可能包含错误。如果您发现了一些，你可以修复<b>。郎</b>文本文件到目录<b>的htdocs / langs</b>他们在论坛上提交<a href="http://www.dolibarr.org/forum" target="_blank">http://www.dolibarr.org</a> 。',
		'MenuUseLayout' => '请垂直菜单hidable（选项不能被禁用的JavaScript）',
		'MAIN_DISABLE_METEO' => '禁用气象局认为',
		'TestLoginToAPI' => '测试登录到API',
		'ProxyDesc' => 'Dolibarr的某些功能需要有一个上网工作。这里定义为这个参数。 ，如果Dolibarr服务器代理服务器后面的是，那些参数告诉Dolibarr的如何通过它来访问互联网。',
		'ExternalAccess' => '外部访问',
		...
		'DefineHereComplementaryAttributes' => '这里定义的所有atributes，不是已经默认提供的，而且你要为%s支持。',
		'ExtraFields' => '互补的属性',
		'ExtraFieldsThirdParties' => 'Complementary attributes (thirdparty)',
		'ExtraFieldsContacts' => 'Complementary attributes (contact/address)',
		'ExtraFieldHasWrongValue' => 'attribut %s有一个错误的值。',
		'AlphaNumOnlyCharsAndNoSpace' => 'only alphanumericals characters without space',
		'SendingMailSetup' => '通过电子邮件的设置sendings',
		'SendmailOptionNotComplete' => '警告，在某些Linux系统，从您的电子邮件发送电子邮件，必须conatins sendmail的执行设置选项-BA（参数mail.force_extra_parameters到你的php.ini文件）。如果收件人没有收到电子邮件，尝试编辑mail.force_extra_parameters =-BA）这个PHP参数。',
		...
		'ViewProductDescInThirdpartyLanguageAbility' => '产品在第三方语言描述的可视化',
		...
		'ListOfAvailableNotifications' => '可用的通知名单（此名单上激活的模块依赖）',
		////////// Sendings //////////
		'SendingsSetup' => '发送模块设置',
		'SendingsReceiptModel' => '发送接收模式',
		'SendingsNumberingModules' => 'sendings编号模块',
		...
		'FreeLegalTextOnShippings' => '自由文本上shippings',
		////////// Deliveries //////////
		...
		'SupposedToBeInvoiceDate' => '使用的发票日期',
		'Buy' => '购买',
		'Sell' => '出售',
		'InvoiceDateUsed' => '使用的发票日期',
		'YourCompanyDoesNotUseVAT' => '贵公司已被定义为不使用增值税（首页 - 安装 - 公司/基金会），所以没有设置增值税的选择。',
		'AccountancyCode' => '会计守则',
