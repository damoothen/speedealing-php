...
$exports = array(
		...
		'FieldsInTargetDatabase' => '在Speedealing数据库（*=强制性目标字段）',
		'Field' => '场',
		'NoFields' => '没有字段',
		...
		'DataComeFromIdFoundFromRef' => '值<b>％</b>来自外地号码文件<b>的</b> S来源将被用来找到父对象的ID使用（因此，客体<b>％s的</b>具有参考。Speedealing从源文件必须存在到）。',
