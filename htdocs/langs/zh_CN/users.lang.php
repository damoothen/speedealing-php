...
$users = array(
		...
		'SubjectNewPassword' => '您的新密码Speedealing',
		...
		'InternalUser' => '内部用户',
		'MyInformations' => '我的资料',
		'ExportDataset_user_1' => 'Speedealing的用户和属性',
		'DomainUser' => '域用户％s',
		'Reactivate' => '重新启用',
		'CreateInternalUserDesc' => '这种形式可以让您创造一个用户对贵公司内部/基础。为了创造一个外部用户（客户，供应商，...),使用按钮\'创建Speedealing用户从第三方的名片\'。',
		'InternalExternalDesc' => '<b>内部</b>用户是一个用户是公司的一部分，你的/基础。 <br> <b>外部</b>用户是一个客户，供应商或其他。 <br><br>在这两种情况下，权限定义了Speedealing权利，也有外部用户可以比内部用户（见首页 - 设置 - 显示不同的菜单经理）',
		...
		'GroupModified' => '集团修改成功',
		'GroupDeleted' => '群组％s删除',
		'ConfirmCreateContact' => '你确定要为此创造联系Speedealing帐户？',
		'ConfirmCreateLogin' => '你确定要创建该成员成为Speedealing帐户？',
