...
$members = array(
		...
		'CardContent' => '内容您的会员卡',
		'SetLinkToUser' => '用户链接到Speedealing',
		'SetLinkToThirdParty' => '链接到第三方Speedealing',
		'MembersCards' => '议员打印卡',
		'MembersList' => '成员名单',
		...
		'FollowingLinksArePublic' => '下面的链接是没有任何Speedealing权限保护打开的网页。他们不是格式化网页，提供的例子，说明如何列出成员数据库。',
		'PublicMemberList' => '公共成员名单',
		'BlankSubscriptionForm' => '认购表格',
		'BlankSubscriptionFormDesc' => 'speedealing可以为您提供一个公共URL允许外部访问者问到订阅的基础。如果启用在线支付模块，付款方式也将被自动提供。',
		...
		'DocForAllMembersCards' => '成员（名片格式生成所有输出实际上设置<b>：%s）</b>',
		'DocForOneMemberCards' => '设置<b>：%s</b>生成名片输出实际上是一个特定的成员（格式）',
		...
		'Particuliers' => '个人',
		'Entreprises' => '公司',
		'DOLIBARRFOUNDATION_PAYMENT_FORM' => '为了使您的订阅使用银行转帐支付，请参阅页<a target="_blank" href="http://wiki.speedealing.org/index.php/Subscribe#To_subscribe_making_a_bank_transfer">http://wiki.speedealing.org/index.php/Subscribe</a> 。 <br>使用信用卡或PayPal支付，点击此页底部的按钮。 <br>',
