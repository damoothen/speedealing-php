...
$main = array(
		...
		'ErrorConfigParameterNotDefined' => '参数<b>％s</b>是没有定义的配置文件里面Speedealing <b>conf.php。</b>',
		...
		'NotePublic' => '注（公开）',
		'NotePrivate' => '注（私人）',
		'PrecisionUnitIsLimitedToXDecimals' => 'Speedealing是安装精度的限制价格单位为<b>％s</b>小数。',
		'DoTest' => '测试',
		'ToFilter' => '过滤器',
		...
		'ThisLimitIsDefinedInSetup' => 'Speedealing限制（菜单家庭安装安全）：％s的Kb的，PHP的限制：％s的Kb的',
