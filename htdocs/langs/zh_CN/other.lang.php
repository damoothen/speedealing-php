...
$other = array(
		...
		'DemoDesc' => 'Speedealing是紧凑型的ERP / CRM的几个功能模块组成。一个演示，其中包括所有模块并不意味着什么，因为这永远不会发生。因此，一些演示配置文件都可用。',
		...
		'AuthenticationDoesNotAllowSendNewPassword' => '认证模式为<b>％s。</b> <br>在这种模式下，Speedealing不能知道，也不更改密码。 <br>联系您的系统管理员，如果您想更改您的密码。',
