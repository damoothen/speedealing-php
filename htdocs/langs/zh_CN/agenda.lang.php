...
$agenda = array(
		...
		'AutoActions' => '全自动灌装议程',
		'AgendaAutoActionDesc' => '在此事件定义为要Speedealing自动创建一个议程的行动。如果没有被选中（默认情况下），只有手动操作将被列入议程。',
		'AgendaSetupOtherDesc' => '这页允许配置议程模块其他参数。',
		'AgendaExtSitesDesc' => '此页面允许申报日历的外部来源，以他们的活动看到到Speedealing议程。',
		'ActionsEvents' => '为此Speedealing活动将创建一个自动行动议程',
