...
$members = array(
		...
		'SetLinkToUser' => 'Link til en Speedealing bruger',
		'SetLinkToThirdParty' => 'Link til en Speedealing tredjepart',
		...
		'FollowingLinksArePublic' => 'De følgende links er åbne sider ikke er beskyttet af nogen Speedealing tilladelse. De er ikke formated sider, gives som eksempel for at vise, hvordan man listen medlemmer database.',
		'PublicMemberList' => 'Offentlige medlem liste',
		'BlankSubscriptionForm' => 'Subscription form',
		'BlankSubscriptionFormDesc' => 'Speedealing kan give dig en offentlig webadresse for at give eksterne besøgende til at anmode om abonnere på fundamentet. Hvis en online betaling modulet er aktiveret, vil en betaling form også udleveres automatisk.',
		...
		'DOLIBARRFOUNDATION_PAYMENT_FORM' => 'For at gøre dit abonnement betaling med en bankoverførsel, se side <a target="_blank" href="http://wiki.speedealing.org/index.php/Subscribe#To_subscribe_making_a_bank_transfer">http://wiki.speedealing.org/index.php/Subscribe</a> . <br> At betale med kreditkort eller Paypal, klik på knappen nederst på denne side. <br>',
