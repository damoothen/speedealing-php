...
$users = array(
		...
		'SubjectNewPassword' => 'Din nye adgangskode for Speedealing',
		...
		'ExportDataset_user_1' => 'Speedealing brugere og egenskaber',
		'DomainUser' => 'Domænebruger %s',
		'Reactivate' => 'Genaktiver',
		'CreateInternalUserDesc' => 'Denne form giver dig mulighed for at oprettet en bruger interne til din virksomheds / fundament. At oprettet en ekstern bruger (kunde, leverandør, ...), bruge knappen \'Opret Speedealing bruger\' fra tredjepartens kontaktkort.',
		'InternalExternalDesc' => 'En <b>intern</b> bruger er en bruger, der er en del af din virksomhed / fundament. <br> En <b>ekstern</b> bruger er en kunde, leverandør eller andre. <br><br> I begge tilfælde permissions definerer rettigheder på Speedealing, også eksterne bruger kan have en anden menu manager end intern bruger (Se Home - Setup - Display)',
		...
		'ConfirmCreateContact' => 'Er du sikker yu ønsker at skabe et Speedealing højde for denne kontakt?',
		'ConfirmCreateLogin' => 'Er du sikker på at du vil oprette en Speedealing højde for dette medlem?',
