...
$errors = array(
		...
		'ErrorUserCannotBeDelete' => 'Bruger kan ikke slettes. Kan det er knyttet til den Speedealing enheder.',
		'ErrorFieldsRequired' => 'Nogle krævede felter ikke var fyldt.',
		'ErrorFailedToCreateDir' => 'Det lykkedes ikke at oprette en mappe. Kontroller, at web-serveren bruger har tilladelse til at skrive i Speedealing dokumenter bibliotek. Hvis parameter <b>safe_mode</b> er aktiveret på dette PHP, kontrollere, at Speedealing php filer ejer til web-serveren bruger (eller gruppe).',
		...
		'ErrorLDAPSetupNotComplete' => 'Speedealing-LDAP matchende er ikke komplet.',
		...
		'ErrorDatabaseParameterWrong' => 'Database setup parameter <b>\'%s\'</b> har en værdi ikke er forenelige at bruge Speedealing (skal have værdi <b>\'%s</b> «).',
		...
		'ErrorForbidden2' => 'Tilladelse til dette login kan defineres af din Speedealing administrator fra menuen %s-> %s.',
		'ErrorForbidden3' => 'Det lader til, at Speedealing ikke anvendes gennem en authenticated session. Tag et kig på Speedealing setup dokumentation for at vide, hvordan man forvalter authentications (htaccess, mod_auth eller andre ...).',
