...
$exports = array(
		...
		'FieldsInTargetDatabase' => 'Markmál reiti Speedealing gagnasafn (*= skylda)',
		'Field' => 'Field',
		...
		'FileWasImported' => 'Skrá var flutt með <b>%s</b> tala.',
		...
		'DataComeFromIdFoundFromRef' => 'Gildi sem koma frá svæði <b>númer %s </b> af skrá fengið verða notaðar til að finna kt foreldris andmæla notkun (Svo <b>objet %s </b> sem hefur dómari. Frá frumskrár verða til staðar í Speedealing).',
		'DataComeFromIdFoundFromCodeId' => 'Kóða sem kemur af akri tala <b>%s</b> á skrá uppspretta verður notað til að finna auðkenni hlut foreldra til að nota (Svo kóðinn frá frumskrár verður til í dictionnary <b>%s).</b> Athugaðu að ef þú veist persónuskilríki, þú getur líka notað það í skrá uppspretta stað kóða. Innflutningur ætti að vinna í báðum tilvikum.',
