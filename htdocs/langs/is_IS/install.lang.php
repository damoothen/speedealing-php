...
$install = array(
		...
		'ErrorPHPDoesNotSupportSessions' => 'PHP uppsetningu þinn styður ekki fundur. Þessi eiginleiki er nauðsynlegt til að gera Speedealing vinna. Athugaðu PHP uppsetningu þína.',
		'ErrorPHPDoesNotSupportGD' => 'PHP uppsetningu þinn styður ekki myndrænt fall GD. Nei línurit verður í boði.',
		'ErrorPHPDoesNotSupportUTF8' => 'PHP uppsetningu þinn styður ekki UTF8 virka. Speedealing get ekki virka rétt. Leysa þetta áður installing Speedealing.',
		...
		'SystemIsUpgraded' => 'Speedealing hefur verið uppfærð með góðum árangri.',
		'YouNeedToPersonalizeSetup' => 'Þú þarft að stilla Speedealing til föt þinn af nauðsyn (útlit, lögun, ...). Til að gera þetta, vinsamlegast fylgdu tenglinum hér að neðan:',
		'AdminLoginCreatedSuccessfuly' => 'stjórnandi tenging <b>\'%</b> Speedealing <b>s\'</b> skapa successfuly.',
		'GoToSpeedealing' => 'Go to Speedealing',
		'GoToSetupArea' => 'Fara til Speedealing (skipulag svæði)',
		...
		'AdminLoginAlreadyExists' => 'reikningur <b>\' %s </b> Speedealing stjórnandi\' er þegar til.',
		...
		'Upgrade' => 'Uppfærsla',
		'UpgradeDesc' => 'Notaðu þessa stillingu ef þú hefur skipt út gömlum Speedealing skrár með skrá úr nýrri útgáfu. Þetta mun uppfæra gagnagrunninn og gögn.',
		'Start' => 'Byrja',
		...
		'KeepDefaultValuesWamp' => 'Þú notar Speedealing skipulag töframaður frá DoliWamp, svo gildi lagt hér eru nú þegar bjartsýni. Breyta þeim aðeins ef þú veist hvað þú gerir.',
		'KeepDefaultValuesDeb' => 'Þú notar Speedealing skipulag töframaður frá Ubuntu eða Debian pakka, þannig gildi lagt hér eru nú þegar bjartsýni. Aðeins lykilorð gagnagrunninum eigandi að búa verður að vera lokið. Breyta aðrar breytur aðeins ef þú veist hvað þú gerir.',
		'KeepDefaultValuesMamp' => 'Þú notar Speedealing skipulag töframaður frá DoliMamp, svo gildi lagt hér eru nú þegar bjartsýni. Breyta þeim aðeins ef þú veist hvað þú gerir.',
		'KeepDefaultValuesProxmox' => 'Þú notar Speedealing uppsetningarhjálpina frá Proxmox raunverulegur tæki, svo gildi lagt hér eru nú þegar bjartsýni. Breyta þeim aðeins ef þú veist hvað þú gerir.',
