...
$members = array(
		...
		'SetLinkToUser' => 'Tengill á Speedealing notanda',
		'SetLinkToThirdParty' => 'Tengill á Speedealing þriðja aðila',
		...
		'FollowingLinksArePublic' => 'Eftirfarandi tenglar eru opin síður ekki vernda með öllum Speedealing leyfi. Þau eru ekki snið síður, enda eins og fordæmi til að sýna hvernig á lista meðlimir gagnagrunninum.',
		'PublicMemberList' => 'Almenn listann yfir meðlimi',
		'BlankSubscriptionForm' => 'Áskrift mynd',
		'BlankSubscriptionFormDesc' => 'Speedealing getur veitt þér almennings slóð til að leyfa utanaðkomandi gestir að biðja til að gerast áskrifandi að grunni. Ef netinu greiðslu mát er virkt, mun greiðsla mynd einnig sjálfkrafa veitt.',
		...
		'DOLIBARRFOUNDATION_PAYMENT_FORM' => 'Til að gera áskrift greiðslu með millifærslu, sjá síðu <a target="_blank" href="http://wiki.speedealing.org/index.php/Subscribe#To_subscribe_making_a_bank_transfer">http://wiki.speedealing.org/index.php/Subscribe~~dobj</a> . <br> Til að greiða með kreditkorti eða PayPal, smelltu á hnappinn neðst á síðunni. <br>',
