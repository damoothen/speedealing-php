...
$users = array(
		...
		'SubjectNewPassword' => 'Nýja lykilorðið fyrir Speedealing',
		...
		'ExportDataset_user_1' => 'notendur Speedealing og eignir',
		'DomainUser' => 'Lén notanda %s',
		'Reactivate' => 'Endurvekja',
		'CreateInternalUserDesc' => 'Þetta form gerir þér kleift að creat notanda innri fyrirtæki þitt / grunni. Til creat ytri notanda (viðskiptavinur, birgir, ...), nota hnappinn \'Stofna Speedealing notandi\' af kort samband þriðja aðila.',
		'InternalExternalDesc' => '<b>Innri</b> notandi er notandi sem er hluti af þínu fyrirtæki / stofnun. <br> <b>Ytri</b> notandi er a viðskiptavinur, birgir eða öðrum. <br><br> Í báðum tilfellum, leyfi skilgreinir réttindi á Speedealing, einnig ytri notendur geta haft mismunandi matseðill framkvæmdastjóri en innri notanda (Sjá Heim - Skipulag - Skoða)',
		...
		'ConfirmCreateContact' => 'Ertu viss um að þú viljir búa til Speedealing reikning fyrir þennan tengilið?',
		'ConfirmCreateLogin' => 'Ertu viss um að þú viljir búa til Speedealing reikning fyrir þennan notanda?',
