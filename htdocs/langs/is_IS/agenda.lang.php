...
$agenda = array(
		...
		'ListOfEvents' => 'Listi yfir Speedealing viðburðir',
		...
		'AgendaAutoActionDesc' => 'Veldu hér viðburðir sem þú vilt Speedealing að búa sjálfvirkt til aðgerða á dagskrá. Ef ekkert er valið (sjálfgefið), verður eingöngu handvirk aðgerð að koma fram í dagskrá.',
		'AgendaSetupOtherDesc' => 'Þessi síða leyfir að stilla aðrar breytur græju dagskrá.',
		'AgendaExtSitesDesc' => 'Þessi síða leyfir þér að lýsa ytri uppsprettur dagatal til að sjá atburði í Speedealing dagskrá.',
		'ActionsEvents' => 'Viðburðir sem Speedealing vilja búa til aðgerða á dagskrá sjálfkrafa',
