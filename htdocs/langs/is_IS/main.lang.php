...
$main = array(
		...
		'ErrorConfigParameterNotDefined' => '<b>Viðfang %s </b> er ekki skilgreind innan Speedealing config skrá <b>conf.php.</b>',
		...
		'PrecisionUnitIsLimitedToXDecimals' => 'Speedealing var skipulag að takmarka nákvæmni verði eining <b>í %s </b> brotum.',
		'DoTest' => 'Próf',
		'ToFilter' => 'Sía',
		...
		'ThisLimitIsDefinedInSetup' => 'Speedealing takmörk (Valmynd heim-skipulag-öryggi): %s  KB, PHP takmörk: %s  Kb',
