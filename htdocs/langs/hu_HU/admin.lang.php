...
$admin = array(
		...
		'ConfirmPurgeSessions' => 'Nem akarja megtisztítani az összes ülés? Ez megszakítja a kapcsolatot az összes felhasználó (kivéve magad).',
		...
		'ConfirmLockNewSessions' => 'Biztos akarod, hogy korlátozza az új Dolibarr kapcsolatot magad. Csak a felhasználó <b>%s</b> képes lesz csatlakozni után.',
		...
		'NoSessionFound' => 'A PHP úgy tűnik, hogy nem engedi a lista aktív ülés. Directory mentéséhez használt ülés <b>(%s)</b> lehet védeni (Például úgy, hogy OS engedélyek vagy PHP direktíva open_basedir).',
		...
		'WarningModuleNotActive' => 'Modul <b>%s</b> engedélyezni kell',
		...
		'IfModuleEnabled' => 'Megjegyzés: igen csak akkor eredményes, ha a modul engedélyezve van <b>%s</b>',
		'RemoveLock' => 'Fájl eltávolítása <b>%s,</b> ha az létezik, hogy használata a frissítő eszköz.',
		'RestoreLock' => 'Csere file <b>%s,</b> a csak olvasási engedéllyel, hogy kikapcsolt minden használat frissítő eszköz.',
		...
		'MustBeLowerThanPHPLimit' => 'Megjegyzés: A PHP minden fájlt feltölteni korlátozza a méretet <b>%s</b> %s, amit ez a paraméter értéke',
		...
		'AntiVirusCommandExample' => 'Példa ClamWin: c: \ progra ~ 1 \ ClamWin \ bin \ clamscan.exe <br> Példa a ClamAV: / usr / bin / clamscan',
		...
		'PurgeAreaDesc' => 'Ez az oldal lehetővé teszi, hogy törölje az összes fájlt épített vagy tárolt Dolibarr (ideiglenes fájlokat vagy az összes fájl <b>%s</b> könyvtárban). A szolgáltatás használata nem szükséges. Ez biztosítja a felhasználók számára, akiknek Dolibarr ad otthont, amelyet a szolgáltató, amely nem kínál jogosultságokat törölni fájlokat épített a web szerver.',
		'PurgeDeleteLogFile' => 'Log fájl törlése <b>%s</b> meg a Syslog modul (nem veszélyezteti a laza adatok)',
		...
		'InstrucToEncodePass' => 'Ahhoz, hogy a jelszót kódolva a fájlba <b>conf.php,</b> cserélje ki a sort <br> <b>Dolibarr_main_db_pass $ = &quot;...&quot;</b> <br> által <br> <b>Dolibarr_main_db_pass $ = &quot;titkosított: %s&quot;</b>',
		'InstrucToClearPass' => 'Ahhoz, hogy a jelszó dekódolt (átlátszó) a <b>conf.php</b> fájlt, cserélje ki a sort <br> <b>Dolibarr_main_db_pass $ = &quot;kódolják: ...&quot;</b> <br> által <br> <b>Dolibarr_main_db_pass $ = &quot;%s&quot;</b>',
		...
		'SubmitTranslation' => 'Ha a fordítást e nyelvhez nem teljes, vagy hibát talál, akkor korrigálni szerkesztésével fájlokat a könyvtárba <b>langs / %s</b> és benyújtja módosított fájlokat www.dolibarr.org fórum.',
		...
		'GenericMaskCodes2' => '<b>{Cccc}</b> az ügyfél kód <br> <b>{} Cccc000</b> az ügyfél kód n karakter követi az ügyfél ref számláló nélkül, ofszet-és zeroized a globális számláló. <br> <b>{}</b> A kód <b>tttt</b> társasági formának n karaktereket (lásd dictionnary vállalati típusok). <br>',
		...
		'GenericMaskCodes5' => '<b>ABC éé {} {} mm - {000000}</b> ad <b>ABC0701-000099</b> <br> <b>{100} 0000-ZZZ / dd {} / XXX</b> ad <b>0199-ZZZ/31/XXX</b>',
		...
		'ListOfDirectoriesForModelGenODT' => 'Listáját tartalmazó könyvtárak template fájlokat OpenDocument formátumban. <br><br> Tedd ide a teljes elérési út könyvtárat. <br> Add a kocsivissza között EAH könyvtárban. <br> Ahhoz, hogy egy könyvtárat a GED modul, add ide <b>DOL_DATA_ROOT / ECM / yourdirectoryname.</b> <br><br> Fájlok ezeket a könyvtárakat kell <b>végződnie. ODT.</b>',
		...
		'Permission75' => 'Beállítás típusok és attribútumok tagok',
		...
		'Permission113' => 'Beállítás financiel számlák (létrehozására, kezelésére kategóriák)',
		'Permission114' => 'Konszolidálása tranzakciók',
		...
		'Permission1102' => 'Létrehozza / módosítja szállítóleveleket',
		...
		'UpdateRequired' => 'A rendszer frissíteni kell. Ehhez kattintsunk a <a href="%s">Frissítés most</a> .',
		'Upgrade' => 'Upgrade',
		...
		'SetupDescription4' => 'Paraméterek menüben <b>Setup -> Modul</b> van szükség, mert Dolibarr nem egy fix ERP / CRM, hanem egy bizonyos összeget, több modulból, melyek többé-kevésbé független. Csak modulok aktiválása után te érdekes, hogy látni fogja vonások a menükben.',
		...
		'LogEventDesc' => 'Tudod hogy itt a naplózás Dolibarr biztonsági eseményeket. A rendszergazdák láthatja annak tartalmát menün keresztül <b>Rendszereszközök - Audit.</b> Figyelem, ez a funkció fogyasztanak nagy mennyiségű adat az adatbázisban.',
		...
		'BackupDesc2' => '* Mentsd dokumentumok tartalmának könyvtár <b>(%s),</b> amely tartalmazza az összes feltöltött és generált fájlok (lehet, hogy egy zip például).',
		...
		'RestoreDesc2' => '* Visszaállítása archív fájl (zip file például) a dokumentumok könyvtárat kivonat könyvtárakon a dokumentumok könyvtárban egy új létesítmény Dolibarr vagy oda ez a jelenlegi dokumentumok directoy <b>(%s).</b>',
		...
		'SomeTranslationAreUncomplete' => 'Néhány nyelv lehet fordítani részben vagy hibákat tartalmaz. Ha mutatni néhány, meg tudod <b>oldani. Lang</b> szöveges fájlokat könyvtár <b>htdocs / langs</b> és benyújtja azokat a fórum <a href="http://www.dolibarr.org/forum" target="_blank">http://www.dolibarr.org</a> .',
		...
		'WebCalTestOk' => 'Csatlakozás a szerverhez &quot;%s&quot; az adatbázis &quot;%s&quot; felhasználói &quot;%s&quot; sikeres.',
		...
		'LDAPBindOK' => 'Csatlakozás / Authentificate az LDAP-szerver sucessfull (Server = %s, Port = %s, Admin = %s, Password = %s)',
		'LDAPBindKO' => 'Csatlakozás / Authentificate az LDAP-kiszolgáló nem (Server = %s, Port = %s, Admin = %s, Password = %s)',
		'LDAPUnbindSuccessfull' => 'Húzza sikeres',
		...
		'UseSearchToSelectProduct' => 'Használja a keresési forma, hogy válasszon egy terméket (helyett egy lista). <br> Akkor is, ha van egy nagy számú termék (&gt; 100 000), akkor a sebesség növelése azáltal, hogy állandó PRODUCT_DONOTSEARCH_ANYWHERE 1. Beállítás-> Egyéb. Keresés csak ezután kezdeni a húr.',
		...
		'SendingsAbility' => 'Támogatás küldések lapok átadások',
		...
		'FreeLegalTextOnShippings' => 'Szabad szöveg shippings',
		////////// Deliveries //////////
		...
		'FCKeditorForProductDetails' => 'WYSIWIG létrehozása / kiadás termékek részleteit vonalak összes egységben (pályázatok, megrendelések, számlák, stb ..). <font class="warning">Figyelem: Ha ezt a lehetőséget ebben az esetben súlyosan not javasolták, mivel ez problémát okozhat a speciális karakterek és az oldal formátolás kiépítése során PDF fájlokat.</font>',
		...
		'SummaryOfVatExigibilityUsedByDefault' => 'Idő HÉA-alapból exigibility A választott opció szerint:',
		...
		'PathToGeoIPMaxmindCountryDataFile' => 'Path to tartalmazó fájl MaxMind ip országra fordítást. <br> Példa: / usr / local / share / GeoIP / GeoIP.dat',
