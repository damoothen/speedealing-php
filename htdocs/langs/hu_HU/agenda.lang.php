...
$agenda = array(
		...
		'ListOfEvents' => 'Speedealing események listája',
		...
		'AgendaAutoActionDesc' => 'Define here events for which you want Speedealing to create automatically an action in agenda. If nothing is checked (by default), only manual actions will be included in agenda.',
		'AgendaSetupOtherDesc' => 'Ez az oldal lehetővé teszi a napirend modul konfigurálását.',
		'AgendaExtSitesDesc' => 'Ez az oldal lehetővé teszi, hogy nyilvánítsa külső forrásokat naptárak látják eseményeket Speedealing napirenden.',
