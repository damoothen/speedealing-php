...
$members = array(
		...
		'ThisIsContentOfYourCard' => 'Ez a kártya adatait',
		'CardContent' => 'Tartalma a kártya tagja',
		'SetLinkToUser' => 'Link a Speedealing felhasználó',
		'SetLinkToThirdParty' => 'Link egy harmadik fél Speedealing',
		...
		'MembersListResiliated' => 'Resiliated tagok listája',
		...
		'ResiliateMember' => 'Resiliate tagja',
		'ConfirmResiliateMember' => 'Biztosan meg akarja resiliate ezt a tagja?',
		'DeleteMember' => 'Törlés tagja',
		'ConfirmDeleteMember' => 'Biztosan törölni kívánja a tag (tag törlése törli minden előfizetés)?',
		'DeleteSubscription' => 'Törlés előfizetés',
		'ConfirmDeleteSubscription' => 'Biztosan törölni szeretné ezt az előfizetést?',
		'Filehtpasswd' => 'htpasswd fájl',
		'ValidateMember' => 'Érvényesítése tagja',
		'ConfirmValidateMember' => 'Biztosan meg akarja érvényesíteni ezt a tagja?',
		'FollowingLinksArePublic' => 'A következő linkek vannak nyitva oldalakat nem védi semmilyen Speedealing engedélyt. Ezek nem formázott oldal, feltéve, példaként megmutatni, hogy miképpen lista tagjai adatbázisban.',
		'PublicMemberList' => 'Nyilvános lista tagja',
		'BlankSubscriptionForm' => 'Nyilvános jegyzési ív auto-',
		'BlankSubscriptionFormDesc' => 'Speedealing lehet az Ön számára egy nyilvános URL-t, hogy külső látogatók kérni, iratkozz fel az alapítvány. Ha egy online fizetési modul engedélyezve van, a fizetési forma is automatikusan rendelkezésre kell bocsátani.',
		...
		'Entreprises' => 'Cégek',
		'DOLIBARRFOUNDATION_PAYMENT_FORM' => 'Ahhoz, hogy az előfizetés befizetését a banki átutalást, lásd <a target="_blank" href="http://wiki.speedealing.org/index.php/Subscribe#To_subscribe_making_a_bank_transfer">http://wiki.speedealing.org/index.php/Subscribe</a> . <br> Fizetni hitelkártyával vagy PayPal, kattintson gombra a lap alján. <br>',
