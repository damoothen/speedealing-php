...
$install = array(
		...
		'ErrorPHPDoesNotSupportSessions' => 'Ez a PHP verzió NEM támogatja a munkameneteket. Erre szükség van a Speedealing futtatásához. Kérjük ellenõrizze a PHP beállításait.',
		'ErrorPHPDoesNotSupportGD' => 'Ez a PHP verzió NEM támogatja a GD grafikai funkciókat. A grafikonok nem lesznek elérhetõek.',
		'ErrorPHPDoesNotSupportUTF8' => 'Ez a PHP verzió NEM támogatja az UTF8 funkciókat. A Speedealing így nem tud rendesen mûködni. Kérjük oldaj meg mielött végrehajtaná a telepítést.',
		...
		'SystemIsUpgraded' => 'Speedealing sikeresen frissítve lett.',
		'YouNeedToPersonalizeSetup' => 'Most már konfiguálhatja a Speedealing-t az igényei szerint (megjelenés, funkciók, ...). Ehhez kérjük kövesse az alábbi linket:',
		'AdminLoginCreatedSuccessfuly' => 'Speedealing adminisztrátor bejelentkezés \'<b>%s</b>\' sikeresen létrehozva.',
		'GoToSpeedealing' => 'Go to Speedealing',
		'GoToSetupArea' => 'Ugrás a Speedealing-ba (beállítási terültre)',
		...
		'AdminLoginAlreadyExists' => '\'<b>%s</b>\' Speedealing adminisztrátor fiók már létezik.',
		...
		'KeepDefaultValuesWamp' => 'A DoliWamp-ot használja a Speedealing telepítéséhez, az itt lévõ értékek már optimalizálva vannak. Csak saját felelõsségre módosítsa ezeket.',
		...
		'KeepDefaultValuesMamp' => 'A DoliMamp-ot használja a Speedealing telepítéséhez, az itt lévõ értékek már optimalizálva vannak. Csak saját felelõsségre módosítsa ezeket.',
		'KeepDefaultValuesProxmox' => 'Ön használja az Speedealing Setup Wizard egy Proxmox virtuális készüléket, így az itt javasolt értékek már optimalizálva. Megváltoztatni őket, ha tudod, mit csinálsz.',
