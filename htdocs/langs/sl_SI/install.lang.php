...
$install = array(
		...
		'ErrorPHPDoesNotSupportSessions' => 'Vaša PHP instalacija ne podpira sej. Ta funkcija je zahtevana za delovanje Speedealing. Preverite vaše PHP nastavitve.',
		'ErrorPHPDoesNotSupportGD' => 'Vaša PHP instalacija ne podpira grafične funkcije GD. Grafi ne bodo na voljo.',
		'ErrorPHPDoesNotSupportUTF8' => 'Vaša PHP instalacija ne podpira funkcij UTF8. Speedealing zato ne bo mogel pravilno delovati. Zadevo rešite pred namestitvijo Speedealing.',
		...
		'SystemIsUpgraded' => 'Speedealing Je bil uspešno nadgrajen.',
		'YouNeedToPersonalizeSetup' => 'Speedealing morate konfigurirati, da bi ustrezal vašim potrebam (izgled, funkcije, ...). Prosim, sledite spodnji povezavi:',
		'AdminLoginCreatedSuccessfuly' => 'Uporabniško ime Speedealing administratorja \'<b>%s</b>\' je bilo uspešno ustvarjeno.',
		'GoToSpeedealing' => 'Go to Speedealing',
		'GoToSetupArea' => 'Zaženi Speedealing (področje nastavitev)',
		...
		'AdminLoginAlreadyExists' => 'Račun Speedealing administratorja \'<b>%s</b>\' že obstaja.',
		...
		'Upgrade' => 'Nadgraditev',
		'UpgradeDesc' => 'Ta način uporabite, če ste zamenjali stare Speedealing datoteke z datotekami iz novejše različice. S tem boste nadgradili vašo bazo podatkov in podatke.',
		'Start' => 'Start',
		...
		'KeepDefaultValuesWamp' => 'Za namestitev Speedealing uporabljate čarovnika DoliWamp, zato so predlagane vrednosti že optimizirane. Spremenite jih le, če veste kaj počnete.',
		'KeepDefaultValuesDeb' => 'Za namestitev Speedealing uporabljate čarovnika iz paketov, podobnih Ubuntu ali Debian, zato so predlagane vrednosti že optimizirane. Spremenite jih le, če veste kaj počnete.',
		'KeepDefaultValuesMamp' => 'Za namestitev Speedealing uporabljate čarovnika DoliMamp, zato so predlagane vrednosti že optimizirane. Spremenite jih le, če veste kaj počnete.',
		'KeepDefaultValuesProxmox' => 'Za namestitev Speedealing uporabljate čarovnika Proxmox virtual appliance, zato so predlagane vrednosti že optimizirane. Spremenite jih le, če veste kaj počnete.',
