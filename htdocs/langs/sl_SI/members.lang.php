...
$members = array(
		...
		'SetLinkToUser' => 'Povezava z Speedealing uporabnikom',
		'SetLinkToThirdParty' => 'Povezava z Speedealing partnerjem',
		...
		'FollowingLinksArePublic' => 'Naslednje povezave so odprte strani, ki niso zaščitene z Speedealing dovoljenji. Strani niso formatirane, ponujajo le primer prikaza seznama članske baze podatkov.',
		'PublicMemberList' => 'Javni seznam članov',
		'BlankSubscriptionForm' => 'Obrazec za vpis',
		'BlankSubscriptionFormDesc' => 'Speedealing vam lahko zagotovi javni URL, ki omogoča zunanjim obiskovalcem vlogo za vpis v združenje. Če je omogočen modul plačil, bo avtomatsko posredovan obrazec za plačilo.',
		...
		'DOLIBARRFOUNDATION_PAYMENT_FORM' => 'Če želite plačati članarino z bančnim nakazilom, glejte stran <a target="_blank" href="http://wiki.speedealing.org/index.php/Subscribe#To_subscribe_making_a_bank_transfer">http://wiki.speedealing.org/index.php/Subscribe</a>.<br>Za plačilo s kreditno kartico ali Paypal, kliknite na gumb na dnu te strani.<br>',
