...
$exports = array(
		...
		'FieldsInTargetDatabase' => 'Ciljna polja v Speedealing bazi podatkov (*=obvezno)',
		'Field' => 'Polje',
		'NoFields' => 'Ni polj',
		...
		'DataComeFromIdFoundFromRef' => 'Vrednost, ki prihaja iz polja <b>%s</b> izvorne datoteke bo uporabljena za iskanje id nadrejenega objekta (Torej mora objekt <b>%s</b> , ki ima referenco v izvorni datoteki, obstajati v Speedealing).',
		'DataComeFromIdFoundFromCodeId' => 'Kodo, ki prihaja iz <b>%s</b> številka polja izvorne datoteke se bodo uporabile za iskanje ID objekta matične uporabiti (torej mora oznaka iz izvorne datoteke ne obstaja v dictionnary <b>%s).</b> Upoštevajte, da če veš, id, lahko jo uporabite tudi v izvorni namesto kode. Uvoz morajo delovati v obeh primerih.',
