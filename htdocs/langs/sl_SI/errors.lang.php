...
$errors = array(
		...
		'ErrorUserCannotBeDelete' => 'Uporabnika se ne da izbrisati. Morda je povezan z drugimi Speedealing entitetami.',
		'ErrorFieldsRequired' => 'Nekatera zahtevana polja niso izpolnjena.',
		'ErrorFailedToCreateDir' => 'Kreiranje mape ni uspelo. Preverite, če ima uporabnik internetne strani dovoljenje za pisanje v mapo z Speedealing dokumenti. Če je parameter <b>safe_mode</b> v tem PHP omogočen, preverite če je lastnik Speedealing php datotek uporabnik web strežnika (ali skupina).',
		...
		'ErrorLDAPSetupNotComplete' => 'Speedealing-LDAP združevanje ni popolno.',
		...
		'ErrorDatabaseParameterWrong' => 'Parameter nastavitve baze podatkov \'<b>%s</b>\' ima vrednost, ki ni kompatibilna z Speedealing (vrednost mora biti \'<b>%s</b>\').',
		...
		'ErrorForbidden2' => 'Dovoljenje za to prijavo se lahko opredeli skrbnik Speedealing iz menija %s-> %s.',
		'ErrorForbidden3' => 'Zdi se, da je Speedealing ne uporablja prek overjeno sejo. Oglejte si namestitveno dokumentacijo Speedealing vedeti, kako upravljati authentications (htaccess, mod_auth ali drugo ...).',
