...
$members = array(
		...
		'SetLinkToUser' => 'Vincular a un usuari Speedealing',
		'SetLinkToThirdParty' => 'Vincular a un tercer Speedealing',
		...
		'FollowingLinksArePublic' => 'Els enllaços següents són pàgines accessibles a tothom i no protegides per cap habilitació Speedealing.',
		'PublicMemberList' => 'Llistat públic de membres',
		'BlankSubscriptionForm' => 'Formulari públic d\'auto-inscripció',
		'BlankSubscriptionFormDesc' => 'Speedealing pot proporcionar una URL de pàgina pública perquè els visitants externs demanin afiliar-se. Si es troba actiu un mòdul de pagament en línia, es proposarà automàticament un formulari de pagament.',
