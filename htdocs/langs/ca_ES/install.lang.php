...
$install = array(
		...
		'ErrorPHPDoesNotSupportSessions' => 'La seva instal·lació de PHP no suporta les sessions. Aquesta funcionalitat és necessària per fer funcionar a Speedealing. Comprovi la seva configuració de PHP.',
		'ErrorPHPDoesNotSupportGD' => 'Aquest PHP no suporta les funcions gràfiques GD. Cap gràfic estarà disponible.',
		'ErrorPHPDoesNotSupportUTF8' => 'Aquest PHP no suporta les funcions UTF8. Resolgui el problema abans d\'instal lar Speedealing ja que no funcionarà correctamete.',
		...
		'SystemIsUpgraded' => 'S\'ha actualitzat Speedealing correctament.',
		'YouNeedToPersonalizeSetup' => 'Ara ha de configurar Speedealing segons les seves necessitats (Elecció de l\'aparença, de les funcionalitats, etc). Per això, feu clic en el següent link:',
		'AdminLoginCreatedSuccessfuly' => 'Creació del compte gestor Speedealing \'<b>%s </b>\' realitzat.',
		'GoToSpeedealing' => 'Go to Speedealing',
		'GoToSetupArea' => 'Accés a Speedealing (àrea de configuració)',
		...
		'AdminLoginAlreadyExists' => 'El compte d\'administrador Speedealing \'<b>%s</b>\' ja existeix. Torneu enrere si voleu crear una altra.',
		'WarningRemoveInstallDir' => 'Atenció, per raons de seguretat, amb la finalitat de bloquejar un nou ús de les eines d\'instal·lació/actualització, és aconsellable crear en el directori arrel de Speedealing un arxiu anomenat <b>install.lock </b> en només lectura.',
		...
		'UpgradeDesc' => 'Utilitzeu aquest mètode després d\'haver actualitzat els fitxers d\'una instal·lació Speedealing antiga pels d\'una versió més recent. Aquesta elecció permet posar al dia la base de dades i les seves dades per a aquesta nova versió.',
		'Start' => 'Començar',
		...
		'KeepDefaultValuesProxmox' => 'Està utilitzant l\'assistent d\'instal·lació Speedealing des d\'una màquina virtual Proxmox, els valors proposats aquí estan optimitzats. Canviels només si està segur d\'això.',
