...
$agenda = array(
		...
		'ListOfEvents' => 'Llistat d\'esdeveniments Speedealing',
		...
		'AgendaAutoActionDesc' => 'Indiqueu en aquesta pestanya els esdeveniments per els que desitja que Speedealing creu automàticament una acció a l\'agenda. Si no es marca cap cas (per defecte), només les accions manuals s\'han d\'incloure en l\'agenda.',
		...
		'AgendaExtSitesDesc' => 'Aquesta pàgina permet configurar calendaris externs per a la seva visualització en l\'agenda de Speedealing.',
		'ActionsEvents' => 'Esdeveniments per a què Speedealing crei una acció de forma automàtica',
