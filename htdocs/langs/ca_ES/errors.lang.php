...
$errors = array(
		...
		'ErrorUserCannotBeDelete' => 'L\'usuari no pot ser eliminat. Potser estigui associat a elements de Speedealing.',
		'ErrorFieldsRequired' => 'No s\'han indicat alguns camps obligatoris',
		'ErrorFailedToCreateDir' => 'Error en la creació d\'una carpeta. Comprovi que l\'usuari del servidor web té drets d\'escriptura en les carpetes de documents de Speedealing. Si el paràmetre <b>safe_mode</b> està actiu en aquest PHP, Comproveu que els fitxers php speedealing pertanyen a l\'usuari del servidor web.',
		...
		'ErrorLDAPSetupNotComplete' => 'La configuració Speedealing-LDAP és incompleta.',
		...
		'ErrorDatabaseParameterWrong' => 'El paràmetre de configuració de la base de dades \'<b>%s</b>\' té un valor no compatible per una instal lació de Speedealing (ha de tenir el valor \'<b>%s</b>\').',
		...
		'ErrorForbidden2' => 'Els permisos per a aquest usuari poden ser assignats per l\'administrador Speedealing mitjançant el menú  %s-> %s.',
		'ErrorForbidden3' => 'Speedealing no sembla funcionar en una sessió autentificada. Consulteu la documentació d\'instal lació de Speedealing per saber com administrar les autenticacions (htacces, mod_auth o altre ...).',
		...
		'ErrorFileRequired' => 'Es requereix un fitxer de paquet Speedealing en format zip',
