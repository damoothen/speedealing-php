...
$errors = array(
		...
		'ErrorUserCannotBeDelete' => 'Użytkownik nie może być usunięty. Może być to związane jest na Speedealing podmiotów.',
		'ErrorFieldsRequired' => 'Niektóre pola wymagane nie były obsadzone.',
		'ErrorFailedToCreateDir' => 'Nie można utworzyć katalogu. Sprawdź, czy serwer WWW użytkownik ma uprawnienia do zapisu do katalogu dokumentów Speedealing. Jeśli parametr <b>safe_mode</b> jest włączona w tym PHP, czy posiada Speedealing php pliki do serwera internetowego użytkownika (lub grupy).',
		...
		'ErrorLDAPSetupNotComplete' => 'Speedealing-LDAP dopasowywania nie jest kompletna.',
		...
		'ErrorDatabaseParameterWrong' => 'parametr konfiguracji bazy danych <b>&quot;%s&quot;</b> ma wartość nie jest zgodna korzystać Speedealing (musi mieć wartość <b>&quot;%s&quot;).</b>',
		...
		'ErrorForbidden2' => 'Wykorzystanie tej nazwie może być zdefiniowana przez administratora z menu Speedealing %s-> %s.',
		'ErrorForbidden3' => 'Wydaje się, że Speedealing nie jest używany przez uwierzytelniane sesji. Rzuć okiem na Speedealing konfiguracji dokumentacji wiedzieć, jak zarządzać authentications (htaccess, mod_auth lub innych ...).',
