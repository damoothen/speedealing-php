...
$agenda = array(
		...
		'ListOfEvents' => 'Wykaz imprez Speedealing',
		...
		'AgendaAutoActionDesc' => 'Określ tutaj zdarzeń, dla której chcesz Speedealing aby utworzyć automatycznie działania w porządku. Jeżeli nie jest zaznaczone (domyślnie), tylko podręcznik działań będą uwzględnione w porządku obrad.',
		'AgendaSetupOtherDesc' => 'Ta strona pozwala skonfigurować inne parametry porządku modułu.',
		'AgendaExtSitesDesc' => 'Ta strona pozwala zadeklarować zewnętrznych źródeł kalendarzy, aby zobaczyć swoje imprezy do porządku obrad Speedealing.',
		'ActionsEvents' => 'Zdarzenia, za które Speedealing stworzy automatycznie działania w porządku',
