...
$users = array(
		...
		'SubjectNewPassword' => 'Twoje nowe hasło Speedealing',
		...
		'ExportDataset_user_1' => 'Speedealing Użytkownicy i właściwości',
		'DomainUser' => 'Domena użytkownika %s',
		'Reactivate' => 'Przywraca',
		'CreateInternalUserDesc' => 'Ta forma pozwala na utworzenie jeden użytkownik wewnętrzną Twojej firmy / fundacji. Aby creat zewnętrznego użytkownika (klienta, dostawcy, ...), użyć przycisku "Utwórz Speedealing użytkownika" od osoby trzeciej karcie kontaktu.',
		'InternalExternalDesc' => '<b>Wewnętrzny</b> użytkownik jest użytkownikiem, który jest częścią firmy / fundacji. <br> <b>Zewnętrzna</b> użytkownika klienta, dostawcy lub innym. <br><br> W obu przypadkach uprawnienia określa prawa Speedealing, także zewnętrznych użytkownik może mieć różne menu menedżera niż użytkownika wewnętrznego (patrz strona główna - Instalator - Display)',
		...
		'ConfirmCreateContact' => 'Czy na pewno chcesz yu Speedealing utworzyć konto dla tego kontaktu?',
		'ConfirmCreateLogin' => 'Czy na pewno chcesz, aby utworzyć konto dla tego Speedealing członkiem?',
