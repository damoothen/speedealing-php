...
$install = array(
		'CHARSET' => 'UTF-8',
		'InstallEasy' => 'Staraliśmy się by instalacja Speedealinga była tak prosta jak to możliwe. Postępuj wg instrukcji krok po kroku.',
		...
		'ErrorPHPDoesNotSupportSessions' => 'Instalacja PHP nie obsługuje sesji. Taka funkcjonalność jest wymagana do działania Speedealinga. Sprawdź swoje ustawienia PHP.',
		'ErrorPHPDoesNotSupportGD' => 'Twoja instalacji PHP nie obsługuje funkcji graficznych GD. Nr wykresie będą dostępne.',
		'ErrorPHPDoesNotSupportUTF8' => 'Twoja instalacji PHP nie obsługuje UTF8 funkcji. Speedealing może nie działać poprawnie. Rozwiązać ten problem przed instalacją Speedealing.',
		...
		'DatabasePrefix' => 'Tabela prefiksów baza danych',
		'Login' => 'Login',
		...
		'SystemIsUpgraded' => 'Speedealing został zaktualizowany pomyślnie.',
		'YouNeedToPersonalizeSetup' => 'Teraz należy ustawić Speedealinga tak by spełniał Twoje wymagania (wygląd, możliwości, ...). Kliknij w poniższy link by przejść do ustawień:',
		'AdminLoginCreatedSuccessfuly' => 'Użytkownik administracyjny Speedealinga \'<b>%s</b>\' utworzony pomyślnie.',
		'GoToSpeedealing' => 'Go to Speedealing',
		'GoToSetupArea' => 'Przejdź do ustawień Speedealinga',
		...
		'AdminLoginAlreadyExists' => 'Konto administracyjne Speedealinga \'<b>%s</b>\' już istnieje.',
		...
		'UpgradeDesc' => 'Użyj tego trybu jeśli podmieniono stare pliki Speedealinga plikami z nowszej wersji. Ten tryb uaktualni bazę danych i poprzednie dane.',
		'Start' => 'Start',
		...
		'KeepDefaultValuesProxmox' => 'Możesz skorzystać z kreatora konfiguracji Speedealing z urządzeniem wirtualnym Proxmox, więc wartościami zaproponowanymi tutaj są już zoptymalizowane. Zmieniaj je tylko jeśli wiesz co robisz.',
