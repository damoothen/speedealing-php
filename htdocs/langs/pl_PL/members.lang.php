...
$members = array(
		...
		'SetLinkToUser' => 'Link do Speedealing użytkownika',
		'SetLinkToThirdParty' => 'Link do Speedealing trzeciej',
		...
		'FollowingLinksArePublic' => 'Poniższe linki są otwarte strony nie są chronione przez jakiekolwiek Speedealing zgody. Nie są one sformtowany strony, pod warunkiem, jako przykład pokazuje jak lista użytkowników bazy danych.',
		'PublicMemberList' => 'Publicznego liście członków',
		'BlankSubscriptionForm' => 'Formularz subskrypcji',
		'BlankSubscriptionFormDesc' => 'Speedealing może zapewnić publiczny adres URL, aby osoby z zewnątrz, aby zapytać zapisać się do fundacji. Jeśli moduł płatności on-line jest włączona, forma płatności zostanie również automatycznie dostarczane.',
		...
		'Entreprises' => 'Firmy',
		'DOLIBARRFOUNDATION_PAYMENT_FORM' => 'Aby dokonać płatności abonamentu za pomocą przelewu bankowego, patrz strona <a target="_blank" href="http://wiki.speedealing.org/index.php/Subscribe#To_subscribe_making_a_bank_transfer">http://wiki.speedealing.org/index.php/Subscribe~~dobj</a> . <br> Aby zapłacić za pomocą karty kredytowej lub PayPal, kliknij przycisk na dole tej strony. <br>',
