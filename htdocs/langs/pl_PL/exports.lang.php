...
$exports = array(
		...
		'FieldsInTargetDatabase' => 'Docelowe Speedealing pól w bazie danych',
		'Field' => 'Pole',
		'NoFields' => 'Nie pól',
		...
		'DataComeFromIdFoundFromRef' => 'Wartość, która pochodzi z <b>%s</b> numer dziedzinie pliku źródłowego zostaną wykorzystane w celu znalezienia id rodzica obiektu do użytkowania (So <b>%s</b> objet że ma ref. Od pliku źródłowego musi istnieć w Speedealing).',
		'DataComeFromIdFoundFromCodeId' => 'Kod, który pochodzi z <b>%s</b> liczba terenowych pliku źródłowego zostaną użyte, by znaleźć identyfikator obiektu nadrzędnego do korzystania (So kod z pliku źródłowego musi istnieje w dictionnary <b>%s).</b> Zauważ, że jeśli wiesz, id, można też użyć go do pliku źródłowego zamiast kodu. Import powinien działać w obu przypadkach.',
