...
$errors = array(
		...
		'ErrorUserCannotBeDelete' => 'O utilizador não pode ser eliminado. Quizá esé asociado a elementos de Speedealing.',
		'ErrorFieldsRequired' => 'Não se indicaram alguns campos obrigatórios',
		'ErrorFailedToCreateDir' => 'Erro na criação de uma pasta. Verifique se o usuário do servidor Web tem acesso de escrita aos documentos Speedealing. Se o parâmetro <b> safe_mode </ b> está ativo no PHP, Verifique se os arquivos php do Speedealing são da propriedade do usuário do servidor web.',
		...
		'ErrorLDAPSetupNotComplete' => 'A configuração Speedealing-LDAP é incompleta.',
		...
		'ErrorDatabaseParameterWrong' => 'Banco de dados do parâmetro de configuração <b>&quot;%s&quot;</b> tem um valor não compatível para uso Speedealing (deve ter valor <b>&quot;%s&quot;).</b>',
		...
		'ErrorForbidden2' => 'Os permissões para este utilizador podem ser asignados pelo o administrador Speedealing mediante o menu %s-> %s.',
		'ErrorForbidden3' => 'Speedealing não parece funcionar numa Sessão autentificada. Consulte a documentação de Instalação de Speedealing para saber como administrar as autenticações (htaccess, mod_auth u outro...).',
