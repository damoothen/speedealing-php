...
$main = array(
		...
		'ErrorConfigParameterNotDefined' => 'O parâmetro <b>%s</b> não está definido ao fichero de configuração Speedealing <b>conf.php</b>.',
		...
		'PrecisionUnitIsLimitedToXDecimals' => 'Speedealing está configurado para limitar a precisão dos preços unitarios a <b>%s</b> Decimais.',
		'DoTest' => 'Teste',
		'ToFilter' => 'Filtrar',
		...
		'ThisLimitIsDefinedInSetup' => 'Límite Speedealing (menu inicio-configuração-segurança): %s Kb, PHP limit: %s Kb',
