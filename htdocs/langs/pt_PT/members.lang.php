...
$members = array(
		...
		'SetLinkToUser' => 'Link para um usuário Speedealing',
		'SetLinkToThirdParty' => 'Link para uma Speedealing terceiro',
		...
		'FollowingLinksArePublic' => 'Os vínculos seguintes são páginas acessiveis a todos e não protegidas por Nenhuma habilitação Speedealing.',
		'PublicMemberList' => 'Lista pública de Membros',
		'BlankSubscriptionForm' => 'Formulario de incrição',
		'BlankSubscriptionFormDesc' => 'Speedealing pode fornecer uma URL pública para permitir que os visitantes externos para pedir para se inscrever na fundação. Se um módulo de pagamento on-line está ativado, uma forma de pagamento também será fornecida automaticamente.',
		...
		'DOLIBARRFOUNDATION_PAYMENT_FORM' => 'Para fazer o seu pagamento de inscrição através de transferência bancária, consulte a página <a target="_blank" href="http://wiki.speedealing.org/index.php/Subscribe#To_subscribe_making_a_bank_transfer">http://wiki.speedealing.org/index.php/Subscribe</a> . <br> Para pagar com cartão de crédito ou Paypal, clique no botão na parte inferior desta página. <br>',
