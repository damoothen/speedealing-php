...
$other = array(
		...
		'DemoDesc' => 'Speedealing não é um ERP monolítico, mas está composto de módulos funcionais simples e opcionais. uma demonstração que inclua todos estes módulos não tem sentido, já que nunca mais todos Os módulos são utilizados. De todas maneiras existem disponiveis muitos perfis de demonstração',
		...
		'AuthenticationDoesNotAllowSendNewPassword' => 'o modo de autenticação de Speedealing está configurado como "<b>%s</b>".<br>em este modo Speedealing não pode conocer ni modificar a sua palavra-passe<br>Contacte com a sua administrador para conocer as modalidades de alterar.',
