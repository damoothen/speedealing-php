...
$main = array(
		...
		'ErrorConfigParameterNotDefined' => 'Параметър <b>%s</b> не е дефиниран вътре в <b>conf.php</b> Speedealing конфигурационния файл.',
		...
		'PrecisionUnitIsLimitedToXDecimals' => 'Да се ограничи точност на единичните цени за <b>%s</b> знака след десетичната запетая speedealing е настройка.',
		'DoTest' => 'Тест',
		'ToFilter' => 'Филтър',
		...
		'ThisLimitIsDefinedInSetup' => 'Speedealing граница (Меню-настройка сигурност): %s Kb, PHP лимит: %s Kb',
