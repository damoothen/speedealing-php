...
$members = array(
		...
		'SetLinkToUser' => 'Връзка с потребителя Speedealing',
		'SetLinkToThirdParty' => 'Линк към трета страна Speedealing',
		...
		'FollowingLinksArePublic' => 'Следните връзки са отворени страници, които не са защитени от всяко разрешение Speedealing. Те не са форматиран страници, като например да покаже как да списъка на членовете на база данни.',
		'PublicMemberList' => 'Обществено членския списък',
		'BlankSubscriptionForm' => 'Обществена авто-форма на абонамент',
		'BlankSubscriptionFormDesc' => 'Speedealing може да ви осигури публичен URL адрес, за да се даде възможност за външни посетители, за да поиска да се абонирате за фондацията. Ако е включен модул за онлайн плащане, плащане форма също ще бъдат автоматично.',
		...
		'Particuliers' => 'Личен',
		'Entreprises' => 'Фирми',
		'DOLIBARRFOUNDATION_PAYMENT_FORM' => 'За да направите абонамент на плащане чрез банков превод, вижте стр. <a target="_blank" href="http://wiki.speedealing.org/index.php/Subscribe#To_subscribe_making_a_bank_transfer">http://wiki.speedealing.org/index.php/Subscribe</a> . <br> За да платите чрез кредитна карта или Paypal, кликнете върху бутона в долната част на тази страница. <br>',
