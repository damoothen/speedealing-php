...
$errors = array(
		...
		'ErrorUserCannotBeDelete' => 'Потребителят не може да бъде изтрита. Може би тя е свързана върху лица Speedealing.',
		'ErrorFieldsRequired' => 'Някои задължителни полета не са запълнени.',
		'ErrorFailedToCreateDir' => 'Неуспешно създаване на директория. Уверете се, че уеб сървър потребител има разрешение да пишат в Speedealing документи. Ако параметър <b>safe_mode</b> е разрешен в тази PHP, проверете дали Speedealing PHP файлове притежава за потребителя на уеб сървъра (или група).',
		...
		'ErrorLDAPSetupNotComplete' => 'Speedealing LDAP съвпадение не е пълна.',
		...
		'ErrorDatabaseParameterWrong' => '<b>&quot;%s&quot;</b> параметър настройка на базата данни е на стойност не са съвместими, за да използвате Speedealing (трябва да има <b>&quot;%s&quot;</b> стойност).',
		...
		'ErrorForbidden2' => 'Разрешение за вход може да бъде определена от вашия администратор Speedealing от менюто %s-> %s.',
		'ErrorForbidden3' => 'Изглежда, че Speedealing не се използва чрез заверено сесия. Обърнете внимание на документация за настройка Speedealing за знаят как да управляват удостоверявания (Htaccess, mod_auth или други ...).',
		...
		'ErrorFileRequired' => 'Отнема файла пакет Speedealing',
