...
$banks = array(
		...
		'TransferDesc' => 'Се прехвърля от една сметка в друга, Speedealing ще напиша два записа (дебит в източник сметка и кредит в целева сметка, в същия размер. Същия етикет и дата ще бъдат използвани за тази сделка)',
		'TransferFrom' => 'От',
		'TransferTo' => 'За',
