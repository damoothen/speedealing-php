...
$agenda = array(
		...
		'ListOfEvents' => 'Списък на събитията Speedealing',
		...
		'AgendaAutoActionDesc' => 'Определете тук събития, за които искате Speedealing да създадете автоматично събитие в дневния ред. Ако нищо не се проверява (по подразбиране), само ръчни действия ще бъдат включени в дневния ред.',
		'AgendaSetupOtherDesc' => 'Тази страница предоставя възможности да се допусне износ на вашите събития Speedealing в външен календар (Thunderbird, Google Calendar, ...)',
		'AgendaExtSitesDesc' => 'Тази страница позволява да се обяви външните източници на календари, за да видят своите събития в дневния ред Speedealing.',
		'ActionsEvents' => 'Събития, за които Speedealing ще създаде действие в дневния ред автоматично',
