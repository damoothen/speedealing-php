...
$other = array(
		...
		'DemoDesc' => 'Speedealing е компактен ERP / CRM състои от няколко функционални модули. Демо, което включва всички модули не означава нищо, тъй като това никога не се случва. Така че, няколко демо профили са на разположение.',
		...
		'AuthenticationDoesNotAllowSendNewPassword' => 'Authentication режим е <b>%s.</b> <br> В този режим, Speedealing не може да знае, нито промените паролата си. <br> Свържете се с вашия системен администратор, ако искате да смените паролата си.',
