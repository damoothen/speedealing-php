...
$admin = array(
		...
		'ConfirmPurgeSessions' => 'Наистина ли искате да изчистите всички сесии? Това ще изключите всеки потребител (освен себе си).',
		...
		'ConfirmLockNewSessions' => 'Сигурен ли сте, че искате да ограничите всяка нова връзка Speedealing за себе си. Само <b>%s</b> потребителят ще бъде в състояние да се свърже след това.',
		...
		'ClientTZ' => 'Часова зона клиент (потребител)',
		'ClientHour' => 'Час клиент (потребител)',
		'OSTZ' => 'Часова зона OS сървъра',
		'PHPTZ' => 'Часова зона PHP сървър',
		...
		'CurrentHour' => 'Час PHP (сървър)',
		'CompanyTZ' => 'Компания Time Zone (основната компания)',
		'CompanyHour' => 'Час компания (основната компания)',
		...
		'PurgeAreaDesc' => 'Тази страница ви позволява да изтриете всички файлове, които са построени или съхраняват от Speedealing (временни файлове, или всички файлове в <b>%s</b> директория). Използването на тази функция не е необходимо. Тя е предвидена за потребители, чиито Speedealing се хоства от доставчик, който не предлага разрешения за изтриване на файлове, построени от уеб сървъра.',
		...
		'ModulesDesc' => 'Speedealing модули определят, чиято функционалност е включен софтуер. Някои модули изискват разрешения трябва да предоставят на потребителите, след активирането на модула. Кликнете върху бутона за включване / изключване в колона &quot;Статус&quot;, за да се даде възможност модул / функция.',
		'ModulesInterfaceDesc' => 'Модули Speedealing интерфейс ви позволява да добавяте функции, в зависимост от външен софтуер, системи или услуги.',
		'ModulesSpecialDesc' => 'Специални модули са много специфични и рядко се използва модули.',
		'ModulesJobDesc' => 'Бизнес модули осигуряват прост предварително зададена настройка на Speedealing за конкретен бизнес.',
		...
		'DoliStoreDesc' => 'DoliStore, официалният пазар за Speedealing ERP / CRM външни модули',
		...
		'InstrucToEncodePass' => 'За да имате парола кодирано в <b>conf.php</b> файл, замени линия <br> <b>$ Speedealing_main_db_pass = &quot;...&quot;</b> <br> от <br> <b>$ Speedealing_main_db_pass = &quot;криптирани: %s&quot;</b>',
		'InstrucToClearPass' => 'За да имате парола декодирана (ясно) в <b>conf.php</b> файл, сменете линия <br> <b>$ Speedealing_main_db_pass = &quot;криптирани: ...&quot;</b> <br> от <br> <b>$ Speedealing_main_db_pass = &quot;%s&quot;</b>',
		...
		'OfficialWebSite' => 'Speedealing международна официален уеб сайт',
		'OfficialWebSiteFr' => 'Френски официален уеб сайт',
		'OfficialWiki' => 'Speedealing документация на Wiki',
		'OfficialDemo' => 'Speedealing онлайн демо',
		...
		'ForDocumentationSeeWiki' => 'За потребител или разработчик документация (Doc, често задавани въпроси ...), <br> да погледнем в Speedealing Wiki: <br> <a href="%s" target="_blank"><b>%s</b></a>',
		'ForAnswersSeeForum' => 'За всякакви други въпроси / Помощ, можете да използвате форума Speedealing: <br> <a href="%s" target="_blank"><b>%s</b></a>',
		'HelpCenterDesc1' => 'Тази област може да ви помогне да получите Помощ подкрепа на Speedealing.',
		...
		'SubmitTranslation' => 'Ако превод за този език не е пълна или откриете грешки, можете да коригирате това, като редактиране на файлове в директорията <b>Langs / %s</b> и представя променените файлове на форума www.speedealing.org.',
		...
		'SetupIsReadyForUse' => 'Install е завършен и Speedealing е готов за използване с този нов компонент.',
		'NotExistsDirect' => 'Алтернатива главната директория не е дефинирано. <br>',
		'InfDirAlt' => 'От версия 3 е възможно да се определи алтернативен directory.This корен ви позволява да съхранявате, едно и също място, плъгини и собствени шаблони. <br> Просто създайте директория, в основата на Speedealing (напр. по поръчка). <br>',
		'InfDirExample' => '<br> След това заяви в файла conf.php <br> $ Speedealing_main_url_root_alt = \'http://myserver/custom &quot; <br> $ Speedealing_main_document_root_alt = &quot;/ път / / speedealing / htdocs / по избор&quot; <br> * Тези линии са коментирани с &quot;#&quot;, да разкоментирате само да премахнете характер.',
		'YouCanSubmitFile' => 'Изберете модул:',
		'CurrentVersion' => 'Speedealing текущата версия',
		...
		'UMaskExplanation' => 'Този параметър ви позволи да се определят правата, определени по подразбиране на файлове, създадени от Speedealing на сървъра (по време на качването например). <br> Тя трябва да бъде осмична стойност (например, 0666 средства четат и пишат за всеки). <br> Този параметър е безполезно на предприятието на сървъра на Windows.',
		...
		'FullListOnOnlineDocumentation' => 'http://wiki.speedealing.org/index.php/Create_an_ODT_document_template',
		...
		'KeyForWebServicesAccess' => 'Ключът към използване на Web Services (параметър &quot;speedealingkey&quot; в WebServices)',
		...
		'Module59Desc' => 'Добавяне на функция за генериране на Bookmark4u сметка от сметка Speedealing',
		...
		'Module100Desc' => 'Включете всякаква външна уеб сайт в менюта на Speedealing и да го видите в рамка Speedealing',
		...
		'Module240Desc' => 'Инструмент за износ Speedealing презареждане (с помощници)',
		'Module250Name' => 'Импортирането на данни',
		'Module250Desc' => 'Инструмент за внос презареждане на в Speedealing (с помощници)',
		'Module310Name' => 'Потребители',
		'Module310Desc' => 'Управлението на фондация членове',
		'Module320Name' => 'RSS Feed',
		'Module320Desc' => 'Добави RSS емисия вътре екрана страници Speedealing',
		...
		'Module600Desc' => 'Изпращане на известия по имейл на някои бизнес събития Speedealing трета контакти страни',
		...
		'Module2600Desc' => 'Активирайте Speedealing уеб услуги сървъра',
		...
		'SummaryConst' => 'Списък на всички параметри за настройка Speedealing',
		...
		'SetupDescription1' => 'Всички параметри, които са налични в зоната за настройка ви позволяват да настроите Speedealing преди да започнете да го използвате.',
		...
		'SetupDescription3' => 'Параметри в менюто <b>Setup -> Фирма / фондацията</b> се изисква, тъй като входна информация се използва на дисплеи Speedealing и да променят Speedealing поведение (например за функции, свързани с вашата страна).',
		'SetupDescription4' => 'Параметри в менюто <b>Setup -> Модулите</b> се изисква, защото Speedealing не е фиксирана ERP / CRM, но сбор от няколко модула, всички повече или по-малко независими. Това е само след активиране на модули сте интересен с това, вие ще видите, функцията се появи в менютата.',
		...
		'ListOfSecurityEvents' => 'Списък на събитията Speedealing сигурност',
		'SecurityEventsPurged' => 'Събития по сигурността прочиства',
		'LogEventDesc' => 'Можете да разрешите тук сеч за събития Speedealing сигурност. Администраторите могат да видите неговото съдържание чрез меню <b>&quot;Системни инструменти - Одит.</b> Внимание, тази функция може да се консумира голямо количество данни в база данни.',
		...
		'SystemAreaForAdminOnly' => 'Тази зона е достъпна само за администратор потребители. Нито един от Speedealing разрешения може да намали тази граница.',
		...
		'DisplayDesc' => 'Можете да изберете всеки параметър свързани с поглед Speedealing и се чувстват тук',
		...
		'TriggersDesc' => 'Тригерите са файлове, които ще променят поведението на Speedealing работния процес копират в директорията <b>htdocs / ядро / тригери.</b> Те разбраха нови действия, активирани на събития Speedealing (създаване на нова компания, фактура валидиране, ...).',
		...
		'TriggerAlwaysActive' => 'Тригерите в този файл са винаги активни,, каквото са активирани модули Speedealing.',
		...
		'OnceSetupFinishedCreateUsers' => 'Внимание, вие сте на потребителя администратор Speedealing. Администратор потребители не се използват да настроите Speedealing. За обичайна употреба на Speedealing, се препоръчва да използвате не потребителски администратора, създаден от Потребители и групи менюто.',
		'MiscellanousDesc' => 'Определете тук всички други параметри, свързани със сигурността.',
		'LimitsSetup' => 'Граници / Прецизно настройване',
		'LimitsDesc' => 'Можете да дефинирате ограничения, уточнения и оптимизации, използвани от Speedealing тук',
		...
		'BackupDesc' => 'За да направите пълно архивно копие на Speedealing, трябва да:',
		...
		'RestoreDesc' => 'За да възстановите резервно копие на Speedealing, трябва да:',
		'RestoreDesc2' => '* Възстановяване архивен файл (компресирания файл за пример) на документи, указател, за да извлечете дървото на файлове в документите директория на нова инсталация Speedealing или в тази актуални документи directoy <b>(%s).</b>',
		'RestoreDesc3' => '* Възстановяване на данни от архивния файл на сметището в базата данни на новата инсталация Speedealing или в базата данни на тази инсталация. Внимание, след като се възстанови приключи, трябва да се използва име / парола, че е съществувал, когато резервно копие е направено, за да се свържете отново. За да възстановите резервната база данни в тази инсталация, можете да следвате този помощник.',
		...
		'ProxyDesc' => 'Някои функции на Speedealing трябва да имат достъп до Интернет, за да работят. Определете тук параметри за това. Ако сървърът Speedealing е зад прокси сървър, тези параметри казва Speedealing как за достъп до интернет през него.',
		...
		'PasswordGenerationStandard' => 'Върнете парола, генерирана в съответствие с вътрешен алгоритъм Speedealing: 8 символа, съдържащи общи цифри и символи с малки.',
		...
		'NotificationsDesc' => 'Имейли уведомления функция позволява тихо изпраща автоматичен мейл, за някои събития Speedealing, на трети лица (клиенти и доставчици), които са конфигурирани да. Избор на активно уведомяване и цели контакти е направена една трета страна в момента.',
		...
		'WebCalSyncro' => 'Да Добавяне на Speedealing събития да WebCalendar',
		...
		'LDAPDnSynchroActiveExample' => 'LDAP Speedealing или Speedealing LDAP синхронизация',
		...
		'LDAPContactDn' => 'Speedealing контакти &quot;DN',
		'LDAPContactDnExample' => 'Пълна DN (бивши: ОУ = контакти, DC = общество, DC = COM)',
		'LDAPMemberDn' => 'Speedealing членове DN',
		...
		'LDAPMemberTypeDn' => 'Speedealing членове тип DN',
		...
		'LDAPDescContact' => 'Тази страница ви позволява да дефинирате LDAP атрибути име в LDAP дърво за всеки намерени данни за контактите на Speedealing.',
		'LDAPDescUsers' => 'Тази страница ви позволява да дефинирате LDAP атрибути име в LDAP дърво за всеки намерени данни на потребителите Speedealing.',
		'LDAPDescGroups' => 'Тази страница ви позволява да дефинирате LDAP атрибути име в LDAP дърво за всеки данни, намиращи се на групи Speedealing.',
		'LDAPDescMembers' => 'Тази страница ви позволява да дефинирате LDAP атрибути име в LDAP дърво за всеки намерени данни на Speedealing членове модул.',
		...
		'YouCanUseDOL_DATA_ROOT' => 'Можете да използвате DOL_DATA_ROOT / speedealing.log за лог файл в Speedealing директория &quot;документи&quot;. Можете да зададете различен път, за да се съхранява този файл.',
		...
		////////// ClickToDial //////////
		'ClickToDialDesc' => 'Този модул позволява да добавите икона след телефонни номера. Кликнете върху тази икона ще призове сървър с определен URL адрес можете да зададете по-долу. Това може да се използва, за да се обадя на кол център система от Speedealing, че да се обаждат на телефонен номер на SIP система, например.',
		...
		'BookmarkDesc' => 'Този модул ви позволява да управлявате маркери. Можете също да добавите команди за бърз достъп до всички страници Speedealing или externale уеб сайтове на лявата си меню.',
		...
		'WebServicesDesc' => 'С активирането на този модул, Speedealing се превърне в уеб сървъра на услугата за предоставяне на различни уеб услуги.',
		'WSDLCanBeDownloadedHere' => 'WSDL ЕВРОВОК файлове на предоставяните услуги може да изтеглите от тук',
		'EndPointIs' => 'SOAP клиентите трябва да изпратят своите заявки на разположение на Адреса на крайна точка Speedealing',
		////////// Bank //////////
