...
$help = array(
		...
		'SpeedealingHelpCenter' => 'Speedealing help and support center',
		'ToGoBackToSpeedealing' => 'Otherwise, click <a href="%s">here to use Speedealing</a>',
		...
		'ToGetHelpGoOnSparkAngels3' => 'Можете също да отидете към списъка на всички налични треньори за Speedealing за тази цел кликнете върху бутона',
		...
		'LinkToGoldMember' => 'Можете да се обадите на треньора, предварително подбрани от Speedealing за вашия език (%s), като щракнете върху му Widget (статус и максимална цена се актуализира автоматично):',
		'PossibleLanguages' => 'Поддържани езици',
		'MakeADonation' => 'Помощ Speedealing проекта, направете дарение',
		'SubscribeToFoundation' => 'Да Помощ Speedealing проект, за да се абонирате към фундамента'
);
?>