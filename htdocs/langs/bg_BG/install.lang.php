...
$install = array(
		...
		'ErrorPHPDoesNotSupportSessions' => 'Вашият PHP инсталация не поддържа сесии. Тази функция е длъжен да направи Speedealing работа. Проверете си PHP настройка.',
		'ErrorPHPDoesNotSupportGD' => 'Вашият PHP инсталация не поддържа графична функция GD. Не графиката ще бъде на разположение.',
		'ErrorPHPDoesNotSupportUTF8' => 'Вашият PHP инсталация не поддържа UTF8 функции. Speedealing не може да работи правилно. Решаване на този преди да инсталирате Speedealing.',
		...
		'SystemIsUpgraded' => 'Speedealing е обновена успешно.',
		'YouNeedToPersonalizeSetup' => 'Трябва да конфигурирате Speedealing според вашите нужди (външен вид, функции, ...). За да направите това, моля последвайте линка по-долу:',
		'AdminLoginCreatedSuccessfuly' => '<b>&quot;%s&quot;</b> speedealing администратор вход, създаден успешно.',
		'GoToSpeedealing' => 'Go to Speedealing',
		'GoToSetupArea' => 'Отиди на Speedealing (настройка площ)',
		...
		'AdminLoginAlreadyExists' => '<b>&quot;%s</b> speedealing администраторски акаунт вече съществува. Върни се обратно, ако искате да създадете друга.',
		'WarningRemoveInstallDir' => 'Внимание, от съображения за сигурност, след инсталиране или надграждане е пълна, за да се избегне използването инсталирате инструменти отново, трябва да добавите файл наречен <b>install.lock</b> в документа Speedealing директория, за да се избегнат злоупотребите от него.',
		...
		'Upgrade' => 'Обнови',
		'UpgradeDesc' => 'Използвайте този режим, ако сте заменят старите файлове Speedealing с файлове от по-нова версия. Това ще обнови вашата база данни и данни.',
		'Start' => 'Начало',
		...
		'KeepDefaultValuesWamp' => 'Можете да използвате настройка Speedealing програма от DoliWamp, така че стойности, предложени тук вече са оптимизирани. Ги промените, само ако знаете какво правите.',
		'KeepDefaultValuesDeb' => 'Можете да използвате съветника от настройката Speedealing Linux пакет (Ubuntu, Debian, Fedora ...), така че стойностите, предложени тук вече са оптимизирани. Само паролата на собственика на базата данни, за да се създаде, трябва да бъде завършена. Промяна на други параметри, само ако знаете какво правите.',
		'KeepDefaultValuesMamp' => 'Можете да използвате настройка Speedealing програма от DoliMamp, така че стойности, предложени тук вече са оптимизирани. Ги промените, само ако знаете какво правите.',
		'KeepDefaultValuesProxmox' => 'Можете да използвате съветника от настройката Speedealing виртуална Proxmox уред, така че стойностите, предложени тук вече са оптимизирани. Ги промените, само ако знаете какво правите.',
