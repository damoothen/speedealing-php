...
$agenda = array(
		...
		'ListOfEvents' => 'List of Speedealing sündmused',
		...
		'AgendaAutoActionDesc' => 'Määratlege siin üritusi, mille jaoks soovite Speedealing luua automaatselt ürituse kava. Kui midagi on märgitud (vaikimisi), vaid käsitsi tegevused lisatakse päevakorda.',
		'AgendaSetupOtherDesc' => 'See leht pakub võimalusi ekspordi võimaldamiseks oma Speedealing üritused arvesse välise kalender (thunderbird, Google Calendar, ...)',
		'AgendaExtSitesDesc' => 'See leht võimaldab tuvastada väliseid kalendreid näha oma sündmusi sisse Speedealing päevakorda.',
		'ActionsEvents' => 'Sündmused, mis Speedealing loob tegevuse kava automaatselt',
