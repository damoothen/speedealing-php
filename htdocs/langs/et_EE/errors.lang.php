...
$errors = array(
		...
		'ErrorUserCannotBeDelete' => 'Kasutaja ei ole võimalik kustutada. Võib olla see on seotud kohta Speedealing üksused.',
		'ErrorFieldsRequired' => 'Mõned nõutud väljad ei ole täidetud.',
		'ErrorFailedToCreateDir' => 'Suutnud luua kataloogi. Kontrollige, et veebiserveri kasutaja õigusi kirjutada Speedealing dokumentide kataloogi. Kui parameeter <b>safe_mode</b> on lubatud see PHP, kontrollige, et Speedealing php faile omab veebi server kasutaja (või grupi).',
		...
		'ErrorLDAPSetupNotComplete' => 'Speedealing-LDAP sobitamine ei ole täielik.',
		...
		'ErrorDatabaseParameterWrong' => 'Database setup parameeter <b>&quot;%s&quot;</b> on väärtus ei sobi kasutada Speedealing (peab olema väärtus <b>&quot;%s&quot;).</b>',
		...
		'ErrorForbidden2' => 'Loa see login saab määratleda oma Speedealing administraator menüüst %s-> %s.',
		'ErrorForbidden3' => 'Tundub, et Speedealing ei kasutata läbi kinnitatud istungil. Heitke pilk Speedealing setup dokumentatsiooni teada, kuidas juhtida autentsuse (htaccess, mod_auth või muud ...).',
