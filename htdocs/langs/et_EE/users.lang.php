...
$users = array(
		...
		'SubjectNewPassword' => 'Teie uus salasõna Speedealing',
		...
		'ExportDataset_user_1' => 'Speedealing kasutajad ja omadused',
		'DomainUser' => 'Domain kasutaja %s',
		'Reactivate' => 'Aktiveerida',
		'CreateInternalUserDesc' => 'Seda vormi saab creat kasutaja sisemise oma firma / sihtasutus. Creat väline kasutaja (kliendi, tarnija, ...), kasutage nuppu &quot;Create Speedealing kasutaja kolmanda osapoole kontaktikaardil.',
		'InternalExternalDesc' => '<b>Sisemine</b> kasutaja on kasutaja, mis on osa teie ettevõtte / sihtasutus. <br> <b>Väline</b> kasutaja on klient, tarnija või muu. <br><br> Mõlemal juhul õigused on määratletud õigusi Speedealing ka väline kasutajal võib olla erinevaid menu manager kui sisemine kasutaja (Vt Kodu - Setup - Display)',
		...
		'ConfirmCreateContact' => 'Oled kindel, et soovite luua Speedealing moodustavad selle kontakti?',
		'ConfirmCreateLogin' => 'Oled kindel, et soovite luua Speedealing moodustavad selle liige?',
