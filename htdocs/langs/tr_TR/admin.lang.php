...
$admin = array(
		...
		'SearchFilter' => 'Arama filtresi seçenekleri',
		...
		'LanguageBrowserParameter' => '%s Parametresi',
		...
		'ExtendedInsert' => 'Genişletilmiş ARAYAEKLE (INSERT)',
		'NoLockBeforeInsert' => 'ARAYAEKLE etrafında kilit komutu yok',
		'DelayedInsert' => 'Gecikmeli ARAYAEKLE (INSERT)',
		...
		'SubmitTranslation' => 'Bu dil için çeviri tam değilse ya da hatalar bulursanız, bunları düzenleyerek <b>langs/%s</b> dizinine düzeltirsiniz, ve değiştirilmiş dosyaları www.dolibarr.org forumuna gönderebilirsiniz.',
		...
		'ModuleFamilyFinancial' => 'Mali Modüller (Muhasebe/Maliye)',
		'ModuleFamilyECM' => 'Elektronik İçerik Yönetimi',
		...
		'UrlGenerationParameters' => 'URL leri güvenli kılmak için parametreler',
		...
		'Module54Desc' => 'Sözleşmeler ve hizmetlerin yönetimi',
		'Module55Name' => 'Barkodlar',
		'Module55Desc' => 'Barkodların yönetimi',
		...
		'Module70Desc' => 'Müdahalelerin yönetimi',
		'Module75Name' => 'Giderler ve gezi harcamaları',
		'Module75Desc' => 'Giderleri ve gezi harcamaları yönetimi',
		...
		'Module100Desc' => 'Herhangi bir dış web sitesini Dolibarr menülerine ekleyin ve bir Dolibarr çerçevesi içinde görün',
		...
		'Module2300Desc' => 'Menülerin yönetimi',
		...
		'Permission28' => 'Ticari teklifleri dışaaktar',
		'Permission31' => 'Ürünleri oku',
		'Permission32' => 'Ürünler oluştur/düzenle',
		...
		'Permission141' => 'Projeleri oku (ilgilisi olmadığım özel proje olsa da)',
		'Permission142' => 'Proje oluştur/değiştir (ilgilisi olmadığım özel proje olsa da)',
		'Permission144' => 'Proje sil (ilgilisi olmadığım özel proje olsa da)',
		'Permission146' => 'Sağlayıcıları oku',
		'Permission147' => 'İstatistikleri oku',
		'Permission151' => 'Ödeme talimatlarını oku',
		'Permission152' => 'Ödeme talimatı kur',
		'Permission153' => 'Ödeme talimatı fişleri',
		...
		'Permission292' => 'Tarifelerin izinlerini kur',
		...
		'Permission1234' => 'Tedarikçi faturalar sil',
		...
		'DictionnarySocialContributions' => 'Sosyal sigorta primi türleri',
		...
		'Pear' => 'Eşleştirme (pear)',
		'PearPackages' => 'Eşleştirme (P2P) paketleri',
		'Database' => 'Veritabanı',
		...
		'SetupDescription4' => '<b>Kurulum->Modüller<b> menüsündeki parametreler gereklidir, çünkü Dolibarr sabit bir ERP/CRM olmayıp bir çok modülden oluşan, daha çoğuna ya da daha azına bağımlıdır. Ancak istediğiniz modülleri etkinleştirdikten sonra özellikleri menülerde görebilirsiniz.',
		...
		'LimitsSetup' => 'Sınırlar/Hassasiyet kurulumu',
		...
		'YouMustRunCommandFromCommandLineAfterLoginToUser' => 'Bu komutu <b>%s</b> kullanıcısı ile bir kabuğa (to a shell) giriş yaptıktan sonra komut satırından çalıştırabilir ya da parolayı elde etmek için komut satırının sonuna –W seçeneğini ekleyebilirsiniz.',
		...
		////////// Proposals //////////
		'PropalSetup' => 'Ticari teklifler modülü kurulumu',
		...
		'UseSearchToSelectProduct' => 'Bir ürün seçmek için arama formu kullanın (liste kutusu yerine).<br>Çok sayıda ürün de olsa (>100 000), Kurulum-->Diğer menüsünde PRODUCT_DONOTSEARCH_ANYWHERE değişmezini 0 yaparak hızı arttırabilirsiniz. Arama bundan sonra dizinin başlangıcıyla sınırlı olacaktır.',
		...
		'PathToGeoIPMaxmindCountryDataFile' => 'Ülke çevirisi için Maxmind ip içeren dosya yolu <br> Örnek:. / Usr / local / share / GeoIP / GeoIP.dat',
