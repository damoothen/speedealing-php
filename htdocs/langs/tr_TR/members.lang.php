...
$members = array(
		...
		'SetLinkToUser' => 'Bir Speedealing kullanıcısına bağlantı',
		'SetLinkToThirdParty' => 'Bir Speedealing üçüncü partisine bağlantı',
		...
		'FollowingLinksArePublic' => 'Aşağıdaki bağlantılar açık sayfalar olup herhangi bir Speedealing izni ile korunmamaktadır. Onlar biçimlendirilmiş sayfalar olmayıp üye veritabanının nasıl listelendiğine örnek olarak verilmiştir.',
		'PublicMemberList' => 'Genel üye listesi',
		'BlankSubscriptionForm' => 'Genel oto-abonelik formu',
		'BlankSubscriptionFormDesc' => 'Speedealing can provide you a public URL to allow external visitors to ask to subscribe to the foundation. If an online payment module is enabled, a payment form will also be automatically provided.',
