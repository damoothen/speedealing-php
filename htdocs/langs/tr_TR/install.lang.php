...
$install = array(
		...
		'ErrorPHPDoesNotSupportSessions' => 'PHP kurulumunuz oturumları desteklemiyor. Bu özellik Speedealing \'ın çalışması için gereklidir. PHP kurulumunuzu kontrol edin.',
		'ErrorPHPDoesNotSupportGD' => 'PHP kurulumunuz GD grafik işlevini desteklemiyor. Hiçbir grafik görüntülenemeyecektir.',
		'ErrorPHPDoesNotSupportUTF8' => 'PHP kurulumunuz UTF8 işlevlerini desteklemiyor. Speedealing düzgün çalışamaz. Speedealing\'ı yüklemeden önce bunu çözün.',
		...
		'SystemIsUpgraded' => 'Speedealing başarıyla yükseltildi.',
		'YouNeedToPersonalizeSetup' => 'İhtiyaçlarınıza uygun olarak Speedealing\'ı yapılandırabilirsiniz (görünüş, özellikler, ...). Bunu yapmak için aşağıdaki linki izleyin:',
		'AdminLoginCreatedSuccessfuly' => 'Speedealing yönetici girişi \'<b>%s</b>\' başarıyla oluşturuldu.',
		'GoToSpeedealing' => 'Go to Speedealing',
		'GoToSetupArea' => 'Speedealing\'a git (kurulum alanı)',
		...
		'AdminLoginAlreadyExists' => 'Speedealing yönetici hesabı \'<b>%s</b>\' zaten var.',
		'WarningRemoveInstallDir' => 'Uyarı, güvenlik nedeniyle, kurulum veya yükseltme tamamlandığında, araçların yeniden kurulumunu önlemek için  <b>install.lock</b> adlı bir dosyayı kötü amaçlı kullanımları önlemek için Speedealing belge dizinine eklemelisiniz.',
		...
		'Upgrade' => 'Yükseltme',
		'UpgradeDesc' => 'Eğer eski Speedealing dosyalarını daha yeni bir sürümün dosyaları ile değiştirdiyseniz bu biçimi kullanın. Bu, veritabanını ve veriyi yükseltecektir.',
		'Start' => 'Başlat',
		...
		'KeepDefaultValuesWamp' => 'Speedealing kurulum sihirbazını DoliWamp\'tan kullanın, burada önerilen değerler hali hazırda optimize edilmiştir. Onları yalnızca ne yapacağınızı biliyorsanız değiştirin.',
		'KeepDefaultValuesDeb' => 'Speedealing kurulum sihirbazını bir Linux paketinden kullanın, burada önerilen değerler hali hazırda optimize edilmiştir. Yalnızca veritabanı sahibi parolası oluşturulması tamamlanmalıdır. Diğer parametreleri yalnızca ne yapacağınızı biliyorsanız değiştirin.',
		'KeepDefaultValuesMamp' => 'Speedealing kurulum sihirbazını DoliMamp\'tan kullanın, burada önerilen değerler hali hazırda optimize edilmiştir. Onları yalnızca ne yapacağınızı biliyorsanız değiştirin.',
		'KeepDefaultValuesProxmox' => 'Speedealing kurulum sihirbazını bir Proxmox sanal aygıtından kullanın,  burada önerilen değerler hali hazırda optimize edilmiştir. Onları yalnızca ne yapacağınızı biliyorsanız değiştirin.',
