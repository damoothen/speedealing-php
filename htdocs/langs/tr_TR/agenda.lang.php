...
$agenda = array(
		...
		'ListOfEvents' => 'Speedealing eylemleri listesi',
		...
		'AgendaAutoActionDesc' => 'Burada Speedealing\'ın otomatik olarak gündemde oluşturmasını istediğiniz olayları tanımlayın. İşaretli bir şey yoksa (varsayılan olarak) sadece el ile girilen eylemler gündeme dahil edilecektir.',
		'AgendaSetupOtherDesc' => 'Bu sayfa Speedealing eylemlerinin dış bir takvime aktarılması için seçenekler sağlar. (thunderbird, google calendar, ...)',
		'AgendaExtSitesDesc' => 'Bu sayfa takvimlerin dış kaynaklarında Speedealing gündemindeki etkinliklerinin görünmesini sağlar.',
		'ActionsEvents' => 'Speedealing\'ın otomatik olarak gündemde bir etkinlik oluşturacağı eylemler',
