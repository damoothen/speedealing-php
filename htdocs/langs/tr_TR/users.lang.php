...
$users = array(
		...
		'SubjectNewPassword' => 'Speedealing için yeni şifreniz',
		...
		'ExportDataset_user_1' => 'Speedealing kullanıcıları ve özellikleri',
		'DomainUser' => 'Etki alanı kullanıcısı %s',
		'Reactivate' => 'Yeniden etkinleştir',
		'CreateInternalUserDesc' => 'Bu form firmanıza/kuruluşunuza bir iç kullanıcı oluşturmanızı sağlar. Bir dış kullanıcı oluşturmak için (müşteri, tedarikçi,…) üçüncü parti kişi kartındaki \'Speedealing kullanıcısı oluştur\' düğmesini kullanın.',
		'InternalExternalDesc' => 'Bir <b>iç</b> kullanıcı firmanızın/kuruluşunuzun bir parçasıdır. <br>Bir<b>dış</b> kullanıcı bir müşteri, tedarikçi veya bir başkasıdır.<br><br>Her iki durumda da, izinler Speedealing’daki hakları tanımlar, aynı zamanda dış kullanıcı iç kullanıcıdan farklı bir menü yöeticisine sahiptir (Giriş->Kurulum->Görünüm’e bakın)',
		...
		'ConfirmCreateContact' => 'Bu kişi için bir Speedealing hesabı oluşturmak istediğinizden emin misiniz?',
		'ConfirmCreateLogin' => 'Bu üye için Speedealing hesabı oluşturmak istediğinizden emin misiniz?',
