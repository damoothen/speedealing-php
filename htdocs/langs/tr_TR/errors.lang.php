...
$errors = array(
		...
		'ErrorUserCannotBeDelete' => 'Kullanıcı silinemez. Belki Speedealing öğeleri ile ilişkili olabilir.',
		'ErrorFieldsRequired' => 'Bazı gerekli alanlar doldurulmamış.',
		'ErrorFailedToCreateDir' => 'Dizin oluşturulamadı. Web sunucusu kullanıcısının Speedealing belgeleri dizinine yazma izinlerini denetleyin. Eğer bu parametre <b>guvenli_mod</b> bu PHP üzerinde etkinleştirilmişse, Speedealing php dosyalarının web sunucusu kullanıcısına (ya da grubuna) sahip olduğunu denetleyin.',
		...
		'ErrorLDAPSetupNotComplete' => 'Speedealing-LDAP eşleşmesi tamamlanmamış.',
		...
		'ErrorDatabaseParameterWrong' => 'Veritabanı kurulum parametresi \'<b>%s</b>\' Speedealing\'da kullanmak için uyumlu olmayan bir değere sahiptir (değerin \'<b>%s</b>\' olması gerekir)',
		...
		'ErrorForbidden2' => 'Bu giriş için izin Speedealing yöneticiniz tarafından %s->%s menüsünden tanımlanabilir.',
		'ErrorForbidden3' => 'Speedealing bir kimlik doğrulama oturumu üzerinden kullanılmamış gibi görünüyor. Kimlik doğrulama nasıl yönetileceğini öğrenmek Speedealing kurulum belgelerine bir göz atın (htaccess, mod_auth veya diğer ...).',
