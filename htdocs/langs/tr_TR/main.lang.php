...
$main = array(
		...
		'ErrorConfigParameterNotDefined' => 'Parametre <b>%s</b> Speedealing yapılandırma dosyasında <b>conf.php</b> tanımlı değil.',
		...
		'PrecisionUnitIsLimitedToXDecimals' => 'Speedealing birim fiyatlar için hassasiyeti <b>%s</b> ondalık olarak sınırlandırmıştır.',
		'DoTest' => 'Deneme',
		'ToFilter' => 'Süzgeç',
		...
		'ThisLimitIsDefinedInSetup' => 'Speedealing sınırı (Giriş->Kurulum->Güvenlik menüsü):%s Kb, PHP sınırı:%s Kb',
