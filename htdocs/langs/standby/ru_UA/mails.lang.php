...
$mails = array(
		...
		'MailingDesc' => 'На этой странице можно отправить emailings к группе людей.',
		'MailingResult' => 'Отправка сообщений результате',
		...
		'ConfirmResetMailing' => 'Предупреждение, по электронной почте переинициализация <b>%s,</b> вы позволите сделать массовой отправки этого письма в другой раз. Вы уверены, что это то, что вы хотите сделать?',
