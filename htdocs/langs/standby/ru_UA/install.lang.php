...
$install = array(
		...
		'KeepDefaultValuesMamp' => 'Вы можете использовать мастер установки из Dolibarr DoliMamp, поэтому значения предлагаемых здесь уже оптимизированы. Изменение их, только если вы знаете, что вы делаете.',
