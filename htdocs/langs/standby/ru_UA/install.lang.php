...
$install = array(
		...
		'SpeedealingWelcome' => 'Добро пожаловать в Speedealing',
		...
		'ErrorPHPDoesNotSupportSessions' => 'Ваш PHP установки не поддерживает сессий. Эта функция необходима, чтобы сделать Speedealing работает. Проверьте ваш PHP установки.',
		'ErrorPHPDoesNotSupportGD' => 'Ваш PHP установки не поддерживает графические функции GD. Нет графа будут доступны.',
		'ErrorPHPDoesNotSupportUTF8' => 'Ваш PHP установки не поддерживает UTF8 функций. Speedealing не может работать корректно. Решите эту Перед установкой Speedealing.',
		...
		'Login' => 'Войти',
		'AdminLogin' => 'Войти для владельца базы данных Speedealing.',
		'Password' => 'Пароль',
		...
		'YouNeedToPersonalizeSetup' => 'Необходимо настроить Speedealing соответствии с вашими потребностями (внешний вид, особенности, ...). Для этого, пожалуйста, перейдите по следующей ссылке:',
		'AdminLoginCreatedSuccessfuly' => '<b>%s</b> Speedealing администратора Войти создан успешно.',
		...
		'SpeedealingAdminLogin' => 'Speedealing администратора Войти',
		'AdminLoginAlreadyExists' => '<b>%s</b> Speedealing учетной записи администратора уже существует. Возвращайтесь, если вы хотите создать еще один.',
		'WarningRemoveInstallDir' => 'Предупреждение, по соображениям безопасности после того, как установка или обновление завершено, вы должны удалить <b>каталог установки или добавить файл с именем install.lock в каталог документа Speedealing для того, чтобы избежать проникновения вредоносного использования.</b>',
		...
		'UpgradeDesc' => 'Используйте этот режим, если вы заменили старые файлы Speedealing с файлами из более новой версии. Это позволит обновить базу данных и данных.',
		'Start' => 'Начало',
		...
		'KeepDefaultValuesWamp' => 'Вы можете использовать мастер установки из Speedealing DoliWamp, поэтому значения предлагаемых здесь уже оптимизированы. Изменение их, только если вы знаете, что вы делаете.',
		'KeepDefaultValuesDeb' => 'Вы можете использовать мастер Speedealing установки из Linux-пакет (Ubuntu, Debian, Fedora ...), поэтому значения предлагаемых здесь уже оптимизированы. Только пароль владельца базы данных для создания должны быть заполнены. Изменение других параметров, только если вы знаете что вы делаете.',
		'KeepDefaultValuesMamp' => 'Вы можете использовать мастер установки из Speedealing DoliMamp, поэтому значения предлагаемых здесь уже оптимизированы. Изменение их, только если вы знаете, что вы делаете.',
