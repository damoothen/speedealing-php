...
$errors = array(
		...
		'ErrorForbidden2' => 'Разрешение на это Логин может быть определена вашим Speedealing администратора из меню %s-> %s.',
		'ErrorForbidden3' => 'Кажется, что Speedealing не используется по авторизованной сессии. Взгляните на документацию установки Speedealing знать, как управлять аутентификацией (htaccess, mod_auth или другие ...).',
