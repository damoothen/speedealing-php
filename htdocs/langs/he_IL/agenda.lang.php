...
$agenda = array(
		...
		'ListOfEvents' => 'רשימת אירועים Speedealing',
		...
		'AgendaAutoActionDesc' => 'הגדר כאן אירועים שעבורם ברצונך Speedealing ליצור באופן אוטומטי אירוע בסדר היום. אם שום דבר לא נבדק (כברירת מחדל), רק בפעולות ידניות ייכלל בסדר היום.',
		'AgendaSetupOtherDesc' => 'דף זה מספק אפשרויות כדי לאפשר יצוא של אירועים Speedealing שלך לתוך לוח השנה חיצוני (Thunderbird, Google Calendar, ...)',
		'AgendaExtSitesDesc' => 'דף זה מאפשר להכריז על מקורות חיצוניים של לוחות שנה כדי לראות את האירועים שלהם לתוך סדר היום Speedealing.',
		'ActionsEvents' => 'אירועים אשר Speedealing יהיה ליצור פעולה אוטומטית על סדר היום',
