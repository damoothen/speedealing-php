...
$exports = array(
		...
		'FieldsInTargetDatabase' => 'היעד שדות Speedealing מסד הנתונים (* = חובה)',
		'Field' => 'שדה',
		'NoFields' => 'אין שדות',
		...
		'DataComeFromIdFoundFromRef' => 'ערך שעולה ממספר <b>%s</b> שדה של קובץ המקור ישמש למצוא את מספר הזיהוי של אובייקט ההורה להשתמש (אז <b>%s</b> Objet כי יש REF. מקובץ המקור חייב קיים לתוך Speedealing).',
