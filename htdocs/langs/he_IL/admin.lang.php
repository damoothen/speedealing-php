...
$admin = array(
		...
		'InstrucToEncodePass' => 'כדי שהסיסמה מקודד לקובץ <b>conf.php,</b> להחליף את הקו <br> <b>$ Dolibarr_main_db_pass = &quot;...&quot;</b> <br> על ידי <br> <b>$ Dolibarr_main_db_pass = &quot;crypted: %s&quot;</b>',
		'InstrucToClearPass' => 'כדי שהסיסמה מפוענח (ברור) לקובץ <b>conf.php,</b> להחליף את הקו <br> <b>$ Dolibarr_main_db_pass = &quot;crypted: ...&quot;</b> <br> על ידי <br> <b>$ Dolibarr_main_db_pass = &quot;%s&quot;</b>',
		...
		'SubmitTranslation' => 'אם התרגום לשפה זו אינה שלמה או אתה מוצא שגיאות, ניתן לתקן זאת על ידי עריכת קבצים לתוך <b>לאנגס / ספריה %s</b> ולשלוח קבצים ששונו בפורום www.dolibarr.org.',
		...
		'GenericMaskCodes2' => '<b>{Cccc}</b> קוד לקוח <br> <b>{Cccc000}</b> קוד לקוח על דמויות נ ואחריו מונה השופט הלקוח ללא לקזז zeroized עם הדלפק העולמי. <br> <b>{Tttt}</b> קוד של סוג החברה על דמויות N (ראה dictionnary, החברה סוגים). <br>',
		...
		'Permission75' => 'הגדרת סוגים ותכונות של חברי',
		...
		'Permission113' => 'הגדרת חשבונות (financiel ליצור, לנהל קטגוריות)',
		'Permission114' => 'איחוד עסקאות',
		...
		'UpdateRequired' => 'המערכת יש לעדכן. לשם כך, לחץ על <a href="%s">Update כעת</a> .',
		'Upgrade' => 'שדרוג',
		...
		'SetupDescription4' => 'פרמטרים של <b>הגדרת</b> תפריט <b>-> מודולים</b> נדרשים משום Dolibarr אינו קבוע ERP / CRM, אך סכום של מספר מודולים, כולם עצמאיים פחות או יותר. זה רק לאחר הפעלת מודולים אתה מעניין, כי אתה תראה תכונות הופיעו תפריטים.',
		...
		'BackupDesc2' => '* שמירת התוכן של ספריית מסמכים <b>(%s)</b> המכיל את כל הקבצים שנטענו שנוצר (אתה יכול לעשות zip למשל).',
		...
		'ModuleCompanyCodeAquarium' => 'חזור קוד חשבון נבנה על ידי: <br> %s ואחריו קוד צד שלישי הספק את קוד חשבון הספק, <br> %s ואחריו קוד לקוח צד שלישי עבור קוד חשבון הלקוח.',
		...
		'WebCalTestOk' => 'חיבור &quot;%s של שרת&quot; %s &quot;מסד נתונים עם מוצלחת&quot; %s של המשתמש.',
		...
		'HideTreadedOrders' => 'הסתר את ההזמנות שטופלו או בוטלו ברשימה',
		...
		'LDAPBindOK' => 'חבר / Authentificate אל שרת LDAP sucessfull (שרת = %s, פורט = %s, מנהל = %s, סיסמה = %s)',
		'LDAPBindKO' => 'חבר / Authentificate לשרת LDAP נכשל (שרת = %s, פורט = %s, מנהל = %s, סיסמה = %s)',
		'LDAPUnbindSuccessfull' => 'נתק מוצלחת',
		...
		'UseSearchToSelectProduct' => 'להשתמש בטופס החיפוש כדי לבחור מוצר (במקום באמצעות תיבת רשימה). <br> גם אם יש לך מספר רב של המוצר (&gt; 100 000), תוכל להגדיל את המהירות על ידי הגדרת PRODUCT_DONOTSEARCH_ANYWHERE מתמיד 1 בהתקנת-> אחר. חיפוש לאחר מכן ניתן יהיה להתחיל מוגבל של מחרוזת.',
		...
		'SummaryOfVatExigibilityUsedByDefault' => 'בימי exigibility מע&quot;מ כברירת מחדל על פי אפשרות choosed:',
		'OnDelivery' => 'על משלוח',
		'OnPayment' => 'על התשלום',
		'OnInvoice' => 'בחשבונית',
