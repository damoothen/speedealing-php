...
$members = array(
		...
		'SetLinkToUser' => 'קישור המשתמש Speedealing',
		'SetLinkToThirdParty' => 'קישור לצד Speedealing 3',
		...
		'FollowingLinksArePublic' => 'הקישורים הבאים הם דפים פתוחים לא מוגנים על ידי רשות כלשהי Speedealing. הם לא formated עמודים, כאמור למשל להראות כיצד לרשום באתר חברים.',
		'PublicMemberList' => 'חבר אישי רשימה',
		'BlankSubscriptionForm' => 'טופס אישי אוטומטי מנוי',
		'BlankSubscriptionFormDesc' => 'Speedealing יכול לספק לך כתובת אתר ציבורי כדי לאפשר למבקרים חיצוניים לבקש להירשם לקרן. אם מודול תשלום מקוון מופעל, טופס תשלום גם לספק באופן אוטומטי.',
		...
		'Particuliers' => 'אישי',
		'Entreprises' => 'חברות',
		'DOLIBARRFOUNDATION_PAYMENT_FORM' => 'כדי לבצע תשלום המנוי שלך באמצעות העברה בנקאית, ראה עמוד <a target="_blank" href="http://wiki.speedealing.org/index.php/Subscribe#To_subscribe_making_a_bank_transfer">http://wiki.speedealing.org/index.php/Subscribe</a> . <br> לשלם באמצעות כרטיס אשראי או PayPal, לחץ על לחצן בחלק התחתון של דף זה. <br>',
