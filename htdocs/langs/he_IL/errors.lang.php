...
$errors = array(
		...
		'ErrorUserCannotBeDelete' => 'המשתמש לא ניתן למחוק. יכול להיות שזה קשור על גופים Speedealing.',
		'ErrorFieldsRequired' => 'בתחומים מסוימים הנדרשים לא מולאו.',
		'ErrorFailedToCreateDir' => 'נכשל נסיון ליצור ספרייה. יש לבדוק כי השרת משתמש אינטרנט בעל הרשאות לכתוב לתוך ספריית מסמכים Speedealing. אם <b>safe_mode</b> פרמטר מופעלת על PHP זו, ודא Speedealing PHP קבצים הבעלים למשתמש שרת אינטרנט (או קבוצה).',
		...
		'ErrorLDAPSetupNotComplete' => 'Speedealing-LDAP ההתאמה אינה שלמה.',
		...
		'ErrorDatabaseParameterWrong' => '<b>&quot;%s</b> \'הגדרת מסד הנתונים פרמטר יש ערך אינו תואם לשימוש Speedealing (חייב להיות&quot; <b>%s\'</b> ערך).',
		...
		'ErrorForbidden2' => 'אישור כניסה זו יכולה להיות מוגדרת על ידי מנהל המערכת Speedealing מהתפריט %s-> %s.',
		'ErrorForbidden3' => 'נראה כי Speedealing אינו משמש דרך פעולת אימות. תסתכל על תיעוד ההתקנה Speedealing לדעת כיצד לנהל את אימותי (htaccess, mod_auth או אחר ...).',
