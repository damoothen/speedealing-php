...
$main = array(
		...
		'ErrorConfigParameterNotDefined' => '<b>%s</b> הפרמטר אינו מוגדר בתוך הקובץ <b>conf.php</b> Speedealing config.',
		...
		'PrecisionUnitIsLimitedToXDecimals' => 'Speedealing היה ההתקנה להגביל הדיוק של מחירי היחידות <b>%s</b> שברים עשרוניים.',
		'DoTest' => 'מבחן',
		'ToFilter' => 'סנן',
		...
		'ThisLimitIsDefinedInSetup' => 'Speedealing גבול (תפריט בית הגדרת אבטחה): %s KB, PHP גבול: %s Kb',
