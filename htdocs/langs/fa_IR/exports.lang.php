...
$exports = array(
		...
		'FieldsInTargetDatabase' => 'Speedealing المجالات المستهدفة في قاعدة البيانات',
		'Field' => 'حقل',
		'NoFields' => 'لا الحقول',
		...
		'DataComeFromIdFoundFromRef' => 'من حقل رقم <b>%s</b> ملف مصدر سوف تستخدم القيمة التي تأتي للعثور على معرف الكائن الأصل لاستخدام (هكذا <b>%s</b> objet الذي يحتوي على المرجع من الملف المصدر يجب أن يوجد في Speedealing).',
