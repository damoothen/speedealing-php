...
$errors = array(
		...
		'ErrorForbidden2' => 'إذن لدخول هذا يمكن تعريف بلدكم من قائمة مدير Speedealing ٪ ق -> ٪ s.',
		'ErrorForbidden3' => 'يبدو أن Speedealing لا يستخدم من صحتها من خلال هذه الدورة. إلقاء نظرة على Speedealing إعداد الوثائق لمعرفة كيفية ادارة التوثيقات (htaccess ، mod_auth أو غيرها...).',
