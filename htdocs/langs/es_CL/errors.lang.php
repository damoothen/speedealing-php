...
$errors = array(
		...
		'ErrorUserCannotBeDelete' => 'User can not be deleted. May be it is associated on Speedealing entities.',
		'ErrorFieldsRequired' => 'Some required fields were not filled.',
		'ErrorFailedToCreateDir' => 'Failed to create a directory. Check that Web server user has permissions to write into Speedealing documents directory. If parameter <b>safe_mode</b> is enabled on this PHP, check that Speedealing php files owns to web server user (or group).',
		...
		'ErrorLDAPSetupNotComplete' => 'Speedealing-LDAP matching is not complete.',
		...
		'ErrorDatabaseParameterWrong' => 'Database setup parameter \'<b>%s</b>\' has a value not compatible to use Speedealing (must have value \'<b>%s</b>\').',
		...
		'ErrorForbidden2' => 'Permission for this login can be defined by your Speedealing administrator from menu %s->%s.',
		'ErrorForbidden3' => 'It seems that Speedealing is not used through an authenticated session. Take a look at Speedealing setup documentation to know how to manage authentications (htaccess, mod_auth or other...).',
		...
		'WarningConfFileMustBeReadOnly' => 'Warning, your config file (<b>conf/conf.php</b>) can be overwritten by the web server. This is a serious security hole. Modify permissions on file to be in read only mode for operating system user used by Web server. If you use Windows and FAT format for your disk, you must know that this file system does not allow to add permissions on file, so can\'t be completely safe.',
