...
$exports = array(
		...
		'FieldsInTargetDatabase' => 'Mål feltene i Speedealing database (*= obligatorisk)',
		'Field' => 'Field',
		'NoFields' => 'Ingen felt',
		...
		'DataComeFromIdFoundFromRef' => 'Verdi som kommer fra feltet antall <b>%s</b> av kildefilen vil bli brukt til å finne id av overordnede objektet som skal brukes (Så Objet <b>%s</b> som har dommeren. Fra kildefilen må finnes i Speedealing).',
		'DataComeFromIdFoundFromCodeId' => 'Kode som kommer fra feltnummer <b>%s</b> av kildefilen vil bli brukt til å finne id overordnede objektet til å bruke (Så koden fra kildefilen må finnes i dictionnary <b>%s).</b> Merk at hvis du vet id, kan du også bruke den til kildefilen istedenfor kode. Import bør arbeide i begge tilfeller.',
