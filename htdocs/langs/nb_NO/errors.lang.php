...
$errors = array(
		...
		'ErrorUserCannotBeDelete' => 'Brukeren kan ikke slettes. Det kan være at den er knyttet til elementer i Speedealing.',
		'ErrorFieldsRequired' => 'Noen påkrevde felt er ikke fylt ut.',
		'ErrorFailedToCreateDir' => 'Kunne ikke påårette mappen. Kontroller at webserverbrukeren har skriverettigheter i dokumentmappen i Speedealing. Hvis <b>safe_mode</b> er akivert i PHP, sjekk at webserveren eier eller er med i gruppen for Speedealing php-filer.',
		...
		'ErrorLDAPSetupNotComplete' => 'Speedealing-LDAP oppsett er ikke komplett.',
		...
		'ErrorDatabaseParameterWrong' => 'Database setup parameter <b>\'%s</b> "har en verdi ikke forenlig å bruke Speedealing (må ha verdi\' <b>%s</b> \').',
		...
		'ErrorForbidden2' => 'Tillatelse for denne innloggingen kan settes av Speedealing-administratoren fra menyen %s->%s.',
		'ErrorForbidden3' => 'Det ser ut til at Speedealing ikke brukes gjennom en autensitert sesjon. Du kan lese mer i dokumentasjonen om hvordan du håndterer autensitering (htaccess, mod_auth eller andre...).',
