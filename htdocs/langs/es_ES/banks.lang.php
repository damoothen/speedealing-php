...
$banks = array(
		...
		'TransferDesc' => 'Al crear una transferencia de una de sus cuentas bancarias hacia otra, Speedealing crea dos registros contables (uno de débito en una cuenta y otro de crédito, del mismo importe, en la otra cuenta. Se utiliza para los dos registros la misma etiqueta de transferencia y la misma fecha)',
		'TransferFrom' => 'De',
		'TransferTo' => 'Hacia',
