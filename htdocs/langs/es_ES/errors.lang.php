...
$errors = array(
		...
		'ErrorUserCannotBeDelete' => 'El usuario no puede ser eliminado. Quizá esté asociado a elementos de Speedealing.',
		...
		'ErrorLDAPSetupNotComplete' => 'La configuración Speedealing-LDAP es incompleta.',
		...
		'ErrorDatabaseParameterWrong' => 'El parámetro de configuración de la base de datos \'<b>%s</b>\' tiene un valor no compatible para una instalación de Speedealing (debe tener el valor \'<b>%s</b>\').',
		...
		'ErrorForbidden2' => 'Los permisos para este usuario pueden ser asignados por el administrador Speedealing mediante el menú %s-> %s.',
		'ErrorForbidden3' => 'Speedealing no parece funcionar en una sesión autentificada. Consulte la documentación de instalación de Speedealing para saber cómo administrar las autenticaciones (htaccess, mod_auth u otro...).',
		...
		'ErrorFileRequired' => 'Se requiere un archivo de paquete Speedealing en formato zip',
