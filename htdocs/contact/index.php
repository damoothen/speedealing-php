...
if (empty($conf->global->SOCIETE_DISABLE_CONTACTS)) {
    ...
    if ($conf->categorie->enabled) {
        ...
        print'<td>';
        print'<a  href="javascript:void(0);" onclick="fnShowHide(7);">' . $langs->trans("DateModificationShort") . '&nbsp;</a>';
        print'</td>';
        print'<td>';
        print'<a  href="javascript:void(0);" onclick="fnShowHide(8);">' . $langs->trans("ContactVisibility") . '&nbsp;</a>';
        print'</td>';
        print'<td>';
