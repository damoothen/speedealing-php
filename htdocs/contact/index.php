...
if (empty($conf->global->SOCIETE_DISABLE_CONTACTS)) {
    ...
    if ($conf->categorie->enabled) {
        ...
        print'</td>';
        print'<td>';
        print'<a style="color:grey;" href="javascript:void(0);" onclick="fnShowHide(9);">' . $langs->trans("DateModificationShort") . '&nbsp;</a>';
        print'</td>';
        print'<td>';
        print'<a style="color:grey;" href="javascript:void(0);" onclick="fnShowHide(10);">' . $langs->trans("ContactVisibility") . '&nbsp;</a>';
        print'</td>';
        print'<td>';
        ...
        print'<td>';
        print'<a style="color:grey;" href="javascript:void(0);" onclick="fnShowHide(8);">' . $langs->trans("DateModificationShort") . '&nbsp;</a>';
        print'</td>';
        print'<td>';
        print'<a style="color:grey;" href="javascript:void(0);" onclick="fnShowHide(9);">' . $langs->trans("ContactVisibility") . '&nbsp;</a>';
        print'</td>';
        print'<td>';
    ...
    if ($conf->categorie->enabled) {
        ...
        print'<td>';
        print'<a style="color:grey;" href="javascript:void(0);" onclick="fnShowHide(7);">' . $langs->trans("DateModificationShort") . '&nbsp;</a>';
        print'</td>';
        print'<td>';
        print'<a style="color:grey;" href="javascript:void(0);" onclick="fnShowHide(8);">' . $langs->trans("ContactVisibility") . '&nbsp;</a>';
        print'</td>';
        print'<td>';
        print'<a  href="javascript:void(0);" onclick="fnShowHide(9);">' . $langs->trans("Action") . '&nbsp;</a>';
        print'</td>';
    }
}
print'</tr>';
...
if (empty($conf->global->SOCIETE_DISABLE_CONTACTS)) {
    ...
    if ($conf->categorie->enabled) {
        ...
        print'<td id="7"><input  style="margin-top:1px;"  type="text" placeholder="' . $langs->trans("Search DateModificationShort") . '" class="inputSearch"/></td>';
    }
}
...
print "</table>";
print '<br>';
include_once'../lib/datatables/js/initDatatablesContact.js.php';
