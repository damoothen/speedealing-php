...
;(function ( $, window, document, undefined ) {
  ...
  popup = {
    ...
    facebook: function(opt){
      window.open("https://www.facebook.com/sharer.php?u="+encodeURIComponent((opt.buttons.facebook.url !== '' ? opt.buttons.facebook.url : opt.url))+"&t="+opt.text+"", "", "toolbar=0, status=0, width=900, height=500");
    },
