...
class UserGroup extends nosqlDocument {
	...
	function _load_ldap_info() {
		...
		// Champs
		if ($this->nom && $conf->global->LDAP_GROUP_FIELD_FULLNAME)
			$info[$conf->global->LDAP_GROUP_FIELD_FULLNAME] = $this->nom;
		//if ($this->nom && $conf->global->LDAP_GROUP_FIELD_NAME) $info[$conf->global->LDAP_GROUP_FIELD_NAME] = $this->nom;
		if ($this->note && $conf->global->LDAP_GROUP_FIELD_DESCRIPTION)
