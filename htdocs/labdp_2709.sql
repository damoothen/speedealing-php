...
INSERT INTO `llx_accountingsystem` VALUES ('PCG99-ABREGE',1,'The simple accountancy french plan','2011-09-15',NULL,'2011-09-15 16:09:44',0);
...
INSERT INTO `llx_actioncomm` VALUES (1,1,'2011-09-15 18:12:54','2011-09-15 18:12:54',NULL,NULL,50,'Société Lady Gaga ajoutée dans Dolibarr','2011-09-15 18:12:54','2011-09-15 16:12:54',1,NULL,NULL,NULL,1,NULL,0,NULL,1,0,0,1,-1,'',NULL,NULL,'Société Lady Gaga ajoutée dans Dolibarr\nAuteur: adminbdp',NULL,1,'societe');
...
CREATE TABLE `llx_advanced_extrafields` (
  ...
  PRIMARY KEY (`rowid`),
  UNIQUE KEY `idx_advanced_extrafields_elementtype` (`elementtype`,`entity`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `llx_advanced_extrafields_data`
--

DROP TABLE IF EXISTS `llx_advanced_extrafields_data`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `llx_advanced_extrafields_data` (
  `rowid` int(11) NOT NULL AUTO_INCREMENT,
  `tms` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  ...
  `data` text,
  PRIMARY KEY (`rowid`),
  UNIQUE KEY `idx_advanced_extrafields_data_fk_advanced_extrafields` (`fk_element`,`fk_extrafields`),
  KEY `fk_advanced_extrafields_data_fk_advanced_extrafields` (`fk_extrafields`),
  CONSTRAINT `fk_advanced_extrafields_data_fk_advanced_extrafields` FOREIGN KEY (`fk_extrafields`) REFERENCES `llx_advanced_extrafields` (`rowid`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `llx_advanced_extrafields_data`
--

LOCK TABLES `llx_advanced_extrafields_data` WRITE;
/*!40000 ALTER TABLE `llx_advanced_extrafields_data` DISABLE KEYS */;
/*!40000 ALTER TABLE `llx_advanced_extrafields_data` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `llx_advanced_extrafields_structure`
--

DROP TABLE IF EXISTS `llx_advanced_extrafields_structure`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `llx_advanced_extrafields_structure` (
  `rowid` int(11) NOT NULL AUTO_INCREMENT,
  `fk_extrafields` int(11) NOT NULL,
  ...
  PRIMARY KEY (`rowid`),
  UNIQUE KEY `idx_advanced_extrafields_structure_fk_advanced_extrafields` (`fk_extrafields`,`lang`),
  CONSTRAINT `fk_advanced_extrafields_structure_fk_advanced_extrafields` FOREIGN KEY (`fk_extrafields`) REFERENCES `llx_advanced_extrafields` (`rowid`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `llx_advanced_extrafields_structure`
--

LOCK TABLES `llx_advanced_extrafields_structure` WRITE;
/*!40000 ALTER TABLE `llx_advanced_extrafields_structure` DISABLE KEYS */;
/*!40000 ALTER TABLE `llx_advanced_extrafields_structure` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `llx_boxes_def` VALUES (1,'box_clients.php',1,'2011-09-15 16:10:39',NULL),(2,'box_prospect.php',1,'2011-09-15 16:10:39',NULL),(3,'box_contacts.php',1,'2011-09-15 16:10:39',NULL),(5,'box_services_vendus.php',1,'2011-09-15 16:11:37',NULL),(6,'box_factures_imp.php',1,'2011-09-15 16:11:41',NULL),(7,'box_factures.php',1,'2011-09-15 16:11:41',NULL),(8,'box_produits.php',1,'2011-09-15 16:11:47',NULL),(9,'box_actions.php',1,'2011-09-15 16:11:55',NULL);
...
INSERT INTO `llx_c_actioncomm` VALUES (1,'AC_TEL','2','Phone call',NULL,1,NULL,13,2),(2,'AC_FAX','2','Send Fax',NULL,1,NULL,5,3),(3,'AC_PROP','2','Send commercial proposal by email','propal',0,NULL,1,10),(4,'AC_EMAIL','2','Send Email',NULL,1,NULL,1,4),(5,'RDV_RDV','1','Rendez-vous',NULL,1,NULL,11,1),(8,'AC_COM','0','Send customer order by email','order',0,NULL,1,8),(9,'AC_FAC','0','Send customer invoice by email','invoice',0,NULL,1,6),(10,'AC_SHIP','0','Send shipping by email','shipping',1,NULL,0,11),(11,'AC_LEAD','0','Lead change','lead',0,NULL,1,0),(12,'AC_PROSPECT','0','Prospect change','agenda',0,NULL,1,0),(20,'AC_PRDV','2','Prendre rendez-vous','',1,NULL,15,0),(21,'AC_CRR','2','Compte-rendu','',1,NULL,4,0),(22,'AC_DOC','2','Envoye documentation','',1,NULL,6,0),(23,'RDV_TELC','1','Conference Telephonique','',1,NULL,12,0),(24,'RDV_WEB','1','Web conference','',1,NULL,10,0),(25,'AC_NEWSUS','0','Nouveau suspect','',1,NULL,6,0),(26,'AC_QUALIF','0','Qualification','',1,NULL,12,0),(27,'AC_SUSP','0','Jamais contacté -> prospect','',1,NULL,10,0),(30,'AC_SUP_ORD','0','Send supplier order by email','order_supplier',0,NULL,1,9),(31,'AC_SUP_INV','0','Send supplier invoice by email','invoice_supplier',0,NULL,1,7),(50,'AC_OTH','2','Other',NULL,0,NULL,0,5);
...
INSERT INTO `llx_c_forme_juridique` VALUES (1,0,0,'-',0,1,NULL),(2,2301,23,'Monotributista',0,1,NULL),(3,2302,23,'Sociedad Civil',0,1,NULL),(4,2303,23,'Sociedades Comerciales',0,1,NULL),(5,2304,23,'Sociedades de Hecho',0,1,NULL),(6,2305,23,'Sociedades Irregulares',0,1,NULL),(7,2306,23,'Sociedad Colectiva',0,1,NULL),(8,2307,23,'Sociedad en Comandita Simple',0,1,NULL),(9,2308,23,'Sociedad de Capital e Industria',0,1,NULL),(10,2309,23,'Sociedad Accidental o en participación',0,1,NULL),(11,2310,23,'Sociedad de Responsabilidad Limitada',0,1,NULL),(12,2311,23,'Sociedad Anónima',0,1,NULL),(13,2312,23,'Sociedad Anónima con Participación Estatal Mayoritaria',0,1,NULL),(14,2313,23,'Sociedad en Comandita por Acciones (arts. 315 a 324, LSC)',0,1,NULL),(15,11,1,'Artisan Commerçant (EI)',0,1,NULL),(16,12,1,'Commerçant (EI)',0,1,NULL),(17,13,1,'Artisan (EI)',0,1,NULL),(18,14,1,'Officier public ou ministériel',0,1,NULL),(19,15,1,'Profession libérale (EI)',0,1,NULL),(20,16,1,'Exploitant agricole',0,1,NULL),(21,17,1,'Agent commercial',0,1,NULL),(22,18,1,'Associé Gérant de société',0,1,NULL),(23,19,1,'Personne physique',0,1,NULL),(24,21,1,'Indivision',0,1,NULL),(25,22,1,'Société créée de fait',0,1,NULL),(26,23,1,'Société en participation',0,1,NULL),(27,27,1,'Paroisse hors zone concordataire',0,1,NULL),(28,29,1,'Groupement de droit privé non doté de la personnalité morale',0,1,NULL),(29,31,1,'Personne morale de droit étranger, immatriculée au RCS',0,1,NULL),(30,32,1,'Personne morale de droit étranger, non immatriculée au RCS',0,1,NULL),(31,35,1,'Régime auto-entrepreneur',0,1,NULL),(32,41,1,'Établissement public ou régie à caractère industriel ou commercial',0,1,NULL),(33,51,1,'Société coopérative commerciale particulière',0,1,NULL),(34,52,1,'Société en nom collectif',0,1,NULL),(35,53,1,'Société en commandite',0,1,NULL),(36,54,1,'Société à responsabilité limitée (SARL)',0,1,NULL),(37,55,1,'Société anonyme à conseil d administration',0,1,NULL),(38,56,1,'Société anonyme à directoire',0,1,NULL),(39,57,1,'Société par actions simplifiée',0,1,NULL),(40,58,1,'Entreprise Unipersonnelle à Responsabilité Limitée (EURL)',0,1,NULL),(41,61,1,'Caisse d\'épargne et de prévoyance',0,1,NULL),(42,62,1,'Groupement d\'intérêt économique (GIE)',0,1,NULL),(43,63,1,'Société coopérative agricole',0,1,NULL),(44,64,1,'Société non commerciale d assurances',0,1,NULL),(45,65,1,'Société civile',0,1,NULL),(46,69,1,'Personnes de droit privé inscrites au RCS',0,1,NULL),(47,71,1,'Administration de l état',0,1,NULL),(48,72,1,'Collectivité territoriale',0,1,NULL),(49,73,1,'Établissement public administratif',0,1,NULL),(50,74,1,'Personne morale de droit public administratif',0,1,NULL),(51,81,1,'Organisme gérant régime de protection social à adhésion obligatoire',0,1,NULL),(52,82,1,'Organisme mutualiste',0,1,NULL),(53,83,1,'Comité d entreprise',0,1,NULL),(54,84,1,'Organisme professionnel',0,1,NULL),(55,85,1,'Organisme de retraite à adhésion non obligatoire',0,1,NULL),(56,91,1,'Syndicat de propriétaires',0,1,NULL),(57,92,1,'Association loi 1901 ou assimilé',0,1,NULL),(58,93,1,'Fondation',0,1,NULL),(59,99,1,'Personne morale de droit privé',0,1,NULL),(60,200,2,'Indépendant',0,1,NULL),(61,201,2,'SPRL - Société à responsabilité limitée',0,1,NULL),(62,202,2,'SA   - Société Anonyme',0,1,NULL),(63,203,2,'SCRL - Société coopérative à responsabilité limitée',0,1,NULL),(64,204,2,'ASBL - Association sans but Lucratif',0,1,NULL),(65,205,2,'SCRI - Société coopérative à responsabilité illimitée',0,1,NULL),(66,206,2,'SCS  - Société en commandite simple',0,1,NULL),(67,207,2,'SCA  - Société en commandite par action',0,1,NULL),(68,208,2,'SNC  - Société en nom collectif',0,1,NULL),(69,209,2,'GIE  - Groupement d intérêt économique',0,1,NULL),(70,210,2,'GEIE - Groupement européen d intérêt économique',0,1,NULL),(71,500,5,'Limited liability corporation (GmbH)',0,1,NULL),(72,501,5,'Stock corporation (AG)',0,1,NULL),(73,502,5,'Partnerships general or limited (GmbH & CO. KG)',0,1,NULL),(74,503,5,'Sole proprietor / Private business',0,1,NULL),(75,301,3,'Società semplice',0,1,NULL),(76,302,3,'Società in nome collettivo s.n.c.',0,1,NULL),(77,303,3,'Società in accomandita semplice s.a.s.',0,1,NULL),(78,304,3,'Società per azioni s.p.a.',0,1,NULL),(79,305,3,'Società a responsabilità limitata s.r.l.',0,1,NULL),(80,306,3,'Società in accomandita per azioni s.a.p.a.',0,1,NULL),(81,307,3,'Società cooperativa',0,1,NULL),(82,308,3,'Società consortile',0,1,NULL),(83,309,3,'Società europea',0,1,NULL),(84,310,3,'Società cooperativa europea',0,1,NULL),(85,311,3,'Società unipersonale',0,1,NULL),(86,312,3,'Società di professionisti',0,1,NULL),(87,313,3,'Società di fatto',0,1,NULL),(88,314,3,'Società occulta',0,1,NULL),(89,315,3,'Società apparente',0,1,NULL),(90,316,3,'Impresa individuale ',0,1,NULL),(91,317,3,'Impresa coniugale',0,1,NULL),(92,318,3,'Impresa familiare',0,1,NULL),(93,600,6,'Raison Individuelle',0,1,NULL),(94,601,6,'Société Simple',0,1,NULL),(95,602,6,'Société en nom collectif',0,1,NULL),(96,603,6,'Société en commandite',0,1,NULL),(97,604,6,'Société anonyme (SA)',0,1,NULL),(98,605,6,'Société en commandite par actions',0,1,NULL),(99,606,6,'Société à responsabilité limitée (SARL)',0,1,NULL),(100,607,6,'Société coopérative',0,1,NULL),(101,608,6,'Association',0,1,NULL),(102,609,6,'Fondation',0,1,NULL),(103,700,7,'Sole Trader',0,1,NULL),(104,701,7,'Partnership',0,1,NULL),(105,702,7,'Private Limited Company by shares (LTD)',0,1,NULL),(106,703,7,'Public Limited Company',0,1,NULL),(107,704,7,'Workers Cooperative',0,1,NULL),(108,705,7,'Limited Liability Partnership',0,1,NULL),(109,706,7,'Franchise',0,1,NULL),(110,1000,10,'Société à responsabilité limitée (SARL)',0,1,NULL),(111,1001,10,'Société en Nom Collectif (SNC)',0,1,NULL),(112,1002,10,'Société en Commandite Simple (SCS)',0,1,NULL),(113,1003,10,'société en participation',0,1,NULL),(114,1004,10,'Société Anonyme (SA)',0,1,NULL),(115,1005,10,'Société Unipersonnelle à Responsabilité Limitée (SUARL)',0,1,NULL),(116,1006,10,'Groupement d\'intérêt économique (GEI)',0,1,NULL),(117,1007,10,'Groupe de sociétés',0,1,NULL),(118,401,4,'Empresario Individual',0,1,NULL),(119,402,4,'Comunidad de Bienes',0,1,NULL),(120,403,4,'Sociedad Civil',0,1,NULL),(121,404,4,'Sociedad Colectiva',0,1,NULL),(122,405,4,'Sociedad Limitada',0,1,NULL),(123,406,4,'Sociedad Anónima',0,1,NULL),(124,407,4,'Sociedad Comandataria por Acciones',0,1,NULL),(125,408,4,'Sociedad Comandataria Simple',0,1,NULL),(126,409,4,'Sociedad Laboral',0,1,NULL),(127,410,4,'Sociedad Cooperativa',0,1,NULL),(128,411,4,'Sociedad de Garantía Recíproca',0,1,NULL),(129,412,4,'Entidad de Capital-Riesgo',0,1,NULL),(130,413,4,'Agrupación de Interés Económico',0,1,NULL),(131,414,4,'Sociedad de Inversión Mobiliaria',0,1,NULL),(132,415,4,'Agrupación sin Ánimo de Lucro',0,1,NULL),(133,15201,152,'Mauritius Private Company Limited By Shares',0,1,NULL),(134,15202,152,'Mauritius Company Limited By Guarantee',0,1,NULL),(135,15203,152,'Mauritius Public Company Limited By Shares',0,1,NULL),(136,15204,152,'Mauritius Foreign Company',0,1,NULL),(137,15205,152,'Mauritius GBC1 (Offshore Company)',0,1,NULL),(138,15206,152,'Mauritius GBC2 (International Company)',0,1,NULL),(139,15207,152,'Mauritius General Partnership',0,1,NULL),(140,15208,152,'Mauritius Limited Partnership',0,1,NULL),(141,15209,152,'Mauritius Sole Proprietorship',0,1,NULL),(142,15210,152,'Mauritius Trusts',0,1,NULL),(143,15401,154,'Sociedad en nombre colectivo',0,1,NULL),(144,15402,154,'Sociedad en comandita simple',0,1,NULL),(145,15403,154,'Sociedad de responsabilidad limitada',0,1,NULL),(146,15404,154,'Sociedad anónima',0,1,NULL),(147,15405,154,'Sociedad en comandita por acciones',0,1,NULL),(148,15406,154,'Sociedad cooperativa',0,1,NULL);
...
INSERT INTO `llx_c_shipment_mode` VALUES (1,'2011-09-15 16:09:44','CATCH','Catch','Catch by client',1,NULL),(2,'2011-09-15 16:09:44','TRANS','Transporter','Generic transporter',1,NULL),(3,'2011-09-15 16:09:44','COLSUI','Colissimo Suivi','Colissimo Suivi',0,NULL),(4,'2011-09-15 16:09:44','LETTREMAX','Lettre Max','Courrier Suivi et Lettre Max',0,NULL);
...
INSERT INTO `llx_c_stcomm` VALUES (-1,'ST_NO','Ne pas contacter',-1,1),(0,'ST_NEVER','Jamais contacté',0,1),(1,'ST_TODO','A contacter',0,0),(2,'ST_PEND','Contact en cours',0,0),(3,'ST_DONE','Contactée',0,0),(4,'ST_PFROI','Prospect froid',1,1),(5,'ST_PTIED','Prospect tiède',1,0),(6,'ST_PCHAU','Prospect chaud',1,1),(7,'ST_CINF3','Client -3 mois',2,1),(8,'ST_CREC','Client récurrent',2,0),(9,'ST_CFID','Client fidèle',2,1),(10,'ST_CPAR','Client partenaire',2,0);
...
CREATE TABLE `llx_categorie_contact` (
  ...
  PRIMARY KEY (`fk_categorie`,`fk_contact`),
  KEY `idx_categorie_contact_fk_categorie` (`fk_categorie`),
  KEY `idx_categorie_contact_fk_contact` (`fk_contact`),
...
--
-- Table structure for table `llx_categorie_lead`
--

DROP TABLE IF EXISTS `llx_categorie_lead`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `llx_categorie_lead` (
  `fk_categorie` int(11) NOT NULL,
  `fk_lead` int(11) NOT NULL,
  PRIMARY KEY (`fk_categorie`,`fk_lead`),
  KEY `idx_categorie_lead_fk_categorie` (`fk_categorie`),
  KEY `idx_categorie_lead_fk_lead` (`fk_lead`),
  CONSTRAINT `fk_categorie_lead_categorie_rowid` FOREIGN KEY (`fk_categorie`) REFERENCES `llx_categorie` (`rowid`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `llx_categorie_lead`
--

LOCK TABLES `llx_categorie_lead` WRITE;
/*!40000 ALTER TABLE `llx_categorie_lead` DISABLE KEYS */;
/*!40000 ALTER TABLE `llx_categorie_lead` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `llx_const` VALUES (2,'MAIN_FEATURES_LEVEL',0,'0','chaine',1,'Level of features to show (0=stable only, 1=stable+experimental, 2=stable+experimental+development','2011-09-15 16:09:44'),(3,'SYSLOG_FILE',0,'DOL_DATA_ROOT/dolibarr.log','chaine',0,'Directory where to write log file','2011-09-15 16:09:44'),(4,'SYSLOG_LEVEL',0,'7','chaine',0,'Level of debug info to show','2011-09-15 16:09:44'),(5,'MAIN_MAIL_SMTP_SERVER',0,'','chaine',0,'Host or ip address for SMTP server','2011-09-15 16:09:44'),(6,'MAIN_MAIL_SMTP_PORT',0,'','chaine',0,'Port for SMTP server','2011-09-15 16:09:44'),(7,'MAIN_UPLOAD_DOC',0,'2048','chaine',0,'Max size for file upload (0 means no upload allowed)','2011-09-15 16:09:44'),(9,'MAIN_MAIL_EMAIL_FROM',1,'dolibarr-robot@domain.com','chaine',0,'EMail emetteur pour les emails automatiques Dolibarr','2011-09-15 16:09:44'),(10,'MAIN_SIZE_LISTE_LIMIT',0,'25','chaine',0,'Longueur maximum des listes','2011-09-15 16:09:44'),(11,'MAIN_SHOW_WORKBOARD',0,'1','yesno',0,'Affichage tableau de bord de travail Dolibarr','2011-09-15 16:09:44'),(12,'MAIN_MENU_STANDARD',1,'eldy_backoffice.php','chaine',0,'Module de gestion de la barre de menu pour utilisateurs internes','2011-09-15 16:09:44'),(13,'MAIN_MENUFRONT_STANDARD',1,'eldy_frontoffice.php','chaine',0,'Module de gestion de la barre de menu pour utilisateurs externes','2011-09-15 16:09:44'),(14,'MAIN_MENU_SMARTPHONE',1,'eldy_backoffice.php','chaine',0,'Module de gestion de la barre de menu smartphone pour utilisateurs internes','2011-09-15 16:09:44'),(15,'MAIN_MENUFRONT_SMARTPHONE',1,'eldy_frontoffice.php','chaine',0,'Module de gestion de la barre de menu smartphone pour utilisateurs externes','2011-09-15 16:09:44'),(17,'MAIN_DELAY_ACTIONS_TODO',1,'7','chaine',0,'Tolérance de retard avant alerte (en jours) sur actions planifiées non réalisées','2011-09-15 16:09:44'),(18,'MAIN_DELAY_ORDERS_TO_PROCESS',1,'2','chaine',0,'Tolérance de retard avant alerte (en jours) sur commandes clients non traitées','2011-09-15 16:09:44'),(19,'MAIN_DELAY_SUPPLIER_ORDERS_TO_PROCESS',1,'7','chaine',0,'Tolérance de retard avant alerte (en jours) sur commandes fournisseurs non traitées','2011-09-15 16:09:44'),(20,'MAIN_DELAY_PROPALS_TO_CLOSE',1,'31','chaine',0,'Tolérance de retard avant alerte (en jours) sur propales à cloturer','2011-09-15 16:09:44'),(21,'MAIN_DELAY_PROPALS_TO_BILL',1,'7','chaine',0,'Tolérance de retard avant alerte (en jours) sur propales non facturées','2011-09-15 16:09:44'),(22,'MAIN_DELAY_CUSTOMER_BILLS_UNPAYED',1,'31','chaine',0,'Tolérance de retard avant alerte (en jours) sur factures client impayées','2011-09-15 16:09:44'),(23,'MAIN_DELAY_SUPPLIER_BILLS_TO_PAY',1,'2','chaine',0,'Tolérance de retard avant alerte (en jours) sur factures fournisseur impayées','2011-09-15 16:09:44'),(24,'MAIN_DELAY_NOT_ACTIVATED_SERVICES',1,'0','chaine',0,'Tolérance de retard avant alerte (en jours) sur services à activer','2011-09-15 16:09:44'),(25,'MAIN_DELAY_RUNNING_SERVICES',1,'0','chaine',0,'Tolérance de retard avant alerte (en jours) sur services expirés','2011-09-15 16:09:44'),(26,'MAIN_DELAY_MEMBERS',1,'31','chaine',0,'Tolérance de retard avant alerte (en jours) sur cotisations adhérent en retard','2011-09-15 16:09:44'),(27,'MAIN_DELAY_TRANSACTIONS_TO_CONCILIATE',1,'62','chaine',0,'Tolérance de retard avant alerte (en jours) sur rapprochements bancaires à faire','2011-09-15 16:09:44'),(28,'SOCIETE_NOLIST_COURRIER',0,'1','yesno',0,'Liste les fichiers du repertoire courrier','2011-09-15 16:09:44'),(29,'SOCIETE_CODECLIENT_ADDON',1,'mod_codeclient_leopard','yesno',0,'Module to control third parties codes','2011-09-15 16:09:44'),(30,'SOCIETE_CODECOMPTA_ADDON',1,'mod_codecompta_panicum','yesno',0,'Module to control third parties codes','2011-09-15 16:09:44'),(31,'MAILING_EMAIL_FROM',1,'dolibarr@domain.com','chaine',0,'EMail emmetteur pour les envois d emailings','2011-09-15 16:09:44'),(32,'MAIN_MODULE_USER',0,'1',NULL,0,NULL,'2011-09-15 16:09:59'),(33,'MAIN_VERSION_LAST_INSTALL',0,'3.2.0-alpha','chaine',0,'Dolibarr version when install','2011-09-15 16:09:59'),(41,'MAIN_INFO_SOCIETE_PAYS',1,'1:FR:France','chaine',0,'','2011-09-15 16:10:28'),(42,'MAIN_INFO_SOCIETE_NOM',1,'LABDP','chaine',0,'','2011-09-15 16:10:28'),(43,'MAIN_INFO_SOCIETE_DEPARTEMENT',1,'0','chaine',0,'','2011-09-15 16:10:28'),(44,'MAIN_MONNAIE',1,'EUR','chaine',0,'','2011-09-15 16:10:28'),(45,'MAIN_INFO_SOCIETE_FORME_JURIDIQUE',1,'0','chaine',0,'','2011-09-15 16:10:28'),(46,'SOCIETE_FISCAL_MONTH_START',1,'0','chaine',0,'','2011-09-15 16:10:28'),(47,'FACTURE_TVAOPTION',1,'reel','chaine',0,'','2011-09-15 16:10:28'),(51,'COMPANY_ADDON_PDF_ODT_PATH',1,'DOL_DATA_ROOT/doctemplates/thirdparties','chaine',0,NULL,'2011-09-15 16:10:39'),(52,'MAIN_MODULE_MULTICOMPANY',0,'1',NULL,0,NULL,'2011-09-15 16:11:25'),(54,'CONTRACT_ADDON',1,'mod_contract_serpis','chaine',0,'Nom du gestionnaire de numerotation des contrats','2011-09-15 16:11:37'),(55,'MAIN_MODULE_SERVICE',1,'1',NULL,0,NULL,'2011-09-15 16:11:37'),(56,'MAIN_MODULE_FACTURE',1,'1',NULL,0,NULL,'2011-09-15 16:11:41'),(57,'FACTURE_ADDON_PDF',1,'crabe','chaine',0,NULL,'2011-09-15 16:11:41'),(58,'FACTURE_ADDON',1,'terre','chaine',0,NULL,'2011-09-15 16:11:41'),(59,'FACTURE_ADDON_PDF_ODT_PATH',1,'DOL_DATA_ROOT/doctemplates/invoices','chaine',0,NULL,'2011-09-15 16:11:41'),(60,'MAIN_MODULE_SOCIETE',1,'1',NULL,0,NULL,'2011-09-15 16:11:41'),(61,'MAIN_MODULE_PRODUCT',1,'1',NULL,0,NULL,'2011-09-15 16:11:47'),(63,'MAIN_MODULE_AGENDA',1,'1',NULL,0,NULL,'2011-09-15 16:11:55'),(64,'MAIN_AGENDA_ACTIONAUTO_COMPANY_CREATE',1,'1','chaine',0,NULL,'2011-09-15 16:11:55'),(65,'MAIN_AGENDA_ACTIONAUTO_CONTRACT_VALIDATE',1,'1','chaine',0,NULL,'2011-09-15 16:11:55'),(66,'MAIN_AGENDA_ACTIONAUTO_PROPAL_VALIDATE',1,'1','chaine',0,NULL,'2011-09-15 16:11:55'),(67,'MAIN_AGENDA_ACTIONAUTO_PROPAL_SENTBYMAIL',1,'1','chaine',0,NULL,'2011-09-15 16:11:55'),(68,'MAIN_AGENDA_ACTIONAUTO_ORDER_VALIDATE',1,'1','chaine',0,NULL,'2011-09-15 16:11:55'),(69,'MAIN_AGENDA_ACTIONAUTO_ORDER_SENTBYMAIL',1,'1','chaine',0,NULL,'2011-09-15 16:11:55'),(70,'MAIN_AGENDA_ACTIONAUTO_BILL_VALIDATE',1,'1','chaine',0,NULL,'2011-09-15 16:11:55'),(71,'MAIN_AGENDA_ACTIONAUTO_BILL_PAYED',1,'1','chaine',0,NULL,'2011-09-15 16:11:55'),(72,'MAIN_AGENDA_ACTIONAUTO_BILL_CANCEL',1,'1','chaine',0,NULL,'2011-09-15 16:11:55'),(73,'MAIN_AGENDA_ACTIONAUTO_BILL_SENTBYMAIL',1,'1','chaine',0,NULL,'2011-09-15 16:11:55'),(74,'MAIN_AGENDA_ACTIONAUTO_ORDER_SUPPLIER_VALIDATE',1,'1','chaine',0,NULL,'2011-09-15 16:11:55'),(75,'MAIN_AGENDA_ACTIONAUTO_BILL_SUPPLIER_VALIDATE',1,'1','chaine',0,NULL,'2011-09-15 16:11:55'),(76,'MAIN_AGENDA_ACTIONAUTO_SHIPPING_VALIDATE',1,'1','chaine',0,NULL,'2011-09-15 16:11:55'),(77,'MAIN_AGENDA_ACTIONAUTO_SHIPPING_SENTBYMAIL',1,'1','chaine',0,NULL,'2011-09-15 16:11:55'),(78,'MAIN_MODULE_EXTRAFIELDS',1,'1',NULL,0,NULL,'2011-09-15 16:12:03'),(79,'MAIN_MODULE_EXTRAFIELDS_TABS_0',1,'company_admin:+advancedextrafields:ExtraFields:@extrafields:$conf->extrafields->enabled:/extrafields/admin/thirdparty_extrafields.php','chaine',0,NULL,'2011-09-15 16:12:03'),(80,'MAIN_MODULE_EXTRAFIELDS_TABS_1',1,'company_admin:-attributes:ExtraFields','chaine',0,NULL,'2011-09-15 16:12:03'),(81,'MAIN_MODULE_EXTRAFIELDS_HOOKS',1,'thirdparty_extrafields','chaine',0,NULL,'2011-09-15 16:12:03'),(82,'MAIN_MODULE_DOCGEN',1,'1',NULL,0,NULL,'2011-09-15 16:12:07'),(83,'MAIN_MODULE_GOOGLE',1,'1',NULL,0,NULL,'2011-09-15 16:12:12'),(84,'MAIN_MODULE_GOOGLE_TABS_0',1,'agenda:+gcal:MenuAgendaGoogle:@google:$conf->google->enabled && $conf->global->GOOGLE_ENABLE_AGENDA:/google/index.php','chaine',0,NULL,'2011-09-15 16:12:12'),(85,'MAIN_MODULE_GOOGLE_TRIGGERS',1,'1','chaine',0,NULL,'2011-09-15 16:12:12'),(86,'MAIN_MODULE_DROPBOX',1,'1',NULL,0,NULL,'2011-09-15 16:12:15'),(87,'MAIN_MODULE_DROPBOX_CSS',1,'/dropbox/css/dropbox.css.php','chaine',0,'Style sheet for module Dropbox','2011-09-15 16:12:15'),(88,'MAIN_MODULE_DROPBOX_TABS_0',1,'thirdparty:+dropbox:Dropbox:@dropbox:$conf->dropbox->enabled:/dropbox/document.php?socid=__ID__','chaine',0,NULL,'2011-09-15 16:12:15'),(89,'MAIN_MODULE_DROPBOX_TABS_1',1,'thirdparty:-document:Documents','chaine',0,NULL,'2011-09-15 16:12:15'),(90,'MAIN_MODULE_DROPBOX_TRIGGERS',1,'1','chaine',0,NULL,'2011-09-15 16:12:15'),(91,'MAIN_MODULE_DROPBOX_CONSUMER_KEY',1,'cfubi3rqhxog5lz','chaine',0,'Don\'t change this value','2011-09-15 16:12:15'),(92,'MAIN_MODULE_DROPBOX_CONSUMER_SECRET',1,'fni2ia8nyos6uo5','chaine',0,'Don\'t change this value','2011-09-15 16:12:15'),(108,'MAIN_INFO_SOCIETE_PAYS',2,'1:FR:France','chaine',0,'','2011-09-15 16:14:28'),(109,'MAIN_INFO_SOCIETE_NOM',2,'Client top','chaine',0,'','2011-09-15 16:14:28'),(110,'MAIN_INFO_SOCIETE_DEPARTEMENT',2,'0','chaine',0,'','2011-09-15 16:14:28'),(111,'MAIN_MONNAIE',2,'EUR','chaine',0,'','2011-09-15 16:14:28'),(113,'MAIN_MAIL_EMAIL_FROM',2,'dolibarr-robot@domain.com','chaine',0,'EMail emetteur pour les emails automatiques Dolibarr','2011-09-15 16:14:28'),(114,'MAIN_MENU_STANDARD',2,'eldy_backoffice.php','chaine',0,'Module de gestion de la barre de menu du haut pour utilisateurs internes','2011-09-15 16:14:28'),(115,'MAIN_MENUFRONT_STANDARD',2,'eldy_frontoffice.php','chaine',0,'Module de gestion de la barre de menu du haut pour utilisateurs externes','2011-09-15 16:14:28'),(116,'MAIN_MENU_SMARTPHONE',2,'iphone_backoffice.php','chaine',0,'Module de gestion de la barre de menu smartphone pour utilisateurs internes','2011-09-15 16:14:28'),(117,'MAIN_MENUFRONT_SMARTPHONE',2,'iphone_frontoffice.php','chaine',0,'Module de gestion de la barre de menu smartphone pour utilisateurs externes','2011-09-15 16:14:28'),(119,'MAIN_DELAY_ACTIONS_TODO',2,'7','chaine',0,'Tolérance de retard avant alerte (en jours) sur actions planifiées non réalisées','2011-09-15 16:14:28'),(120,'MAIN_DELAY_ORDERS_TO_PROCESS',2,'2','chaine',0,'Tolérance de retard avant alerte (en jours) sur commandes clients non traitées','2011-09-15 16:14:28'),(121,'MAIN_DELAY_SUPPLIER_ORDERS_TO_PROCESS',2,'7','chaine',0,'Tolérance de retard avant alerte (en jours) sur commandes fournisseurs non traitées','2011-09-15 16:14:28'),(122,'MAIN_DELAY_PROPALS_TO_CLOSE',2,'31','chaine',0,'Tolérance de retard avant alerte (en jours) sur propales à cloturer','2011-09-15 16:14:28'),(123,'MAIN_DELAY_PROPALS_TO_BILL',2,'7','chaine',0,'Tolérance de retard avant alerte (en jours) sur propales non facturées','2011-09-15 16:14:28'),(124,'MAIN_DELAY_CUSTOMER_BILLS_UNPAYED',2,'31','chaine',0,'Tolérance de retard avant alerte (en jours) sur factures client impayées','2011-09-15 16:14:28'),(125,'MAIN_DELAY_SUPPLIER_BILLS_TO_PAY',2,'2','chaine',0,'Tolérance de retard avant alerte (en jours) sur factures fournisseur impayées','2011-09-15 16:14:28'),(126,'MAIN_DELAY_NOT_ACTIVATED_SERVICES',2,'0','chaine',0,'Tolérance de retard avant alerte (en jours) sur services à activer','2011-09-15 16:14:28'),(127,'MAIN_DELAY_RUNNING_SERVICES',2,'0','chaine',0,'Tolérance de retard avant alerte (en jours) sur services expirés','2011-09-15 16:14:28'),(128,'MAIN_DELAY_MEMBERS',2,'31','chaine',0,'Tolérance de retard avant alerte (en jours) sur cotisations adhérent en retard','2011-09-15 16:14:28'),(129,'MAIN_DELAY_TRANSACTIONS_TO_CONCILIATE',2,'62','chaine',0,'Tolérance de retard avant alerte (en jours) sur rapprochements bancaires à faire','2011-09-15 16:14:28'),(130,'SOCIETE_CODECLIENT_ADDON',2,'mod_codeclient_leopard','yesno',0,'Module to control third parties codes','2011-09-15 16:14:28'),(131,'SOCIETE_CODECOMPTA_ADDON',2,'mod_codecompta_panicum','yesno',0,'Module to control third parties codes','2011-09-15 16:14:28'),(132,'MAILING_EMAIL_FROM',2,'dolibarr@domain.com','chaine',0,'EMail emmetteur pour les envois d emailings','2011-09-15 16:14:28'),(133,'MAIN_INFO_SOCIETE_PAYS',3,'1:FR:France','chaine',0,'','2011-09-15 16:14:45'),(134,'MAIN_INFO_SOCIETE_NOM',3,'Client top2','chaine',0,'','2011-09-15 16:14:45'),(135,'MAIN_INFO_SOCIETE_DEPARTEMENT',3,'0','chaine',0,'','2011-09-15 16:14:45'),(136,'MAIN_MONNAIE',3,'EUR','chaine',0,'','2011-09-15 16:14:45'),(137,'MAIN_LANG_DEFAULT',3,'fr_FR','chaine',0,'','2011-09-15 16:14:45'),(138,'MAIN_MAIL_EMAIL_FROM',3,'dolibarr-robot@domain.com','chaine',0,'EMail emetteur pour les emails automatiques Dolibarr','2011-09-15 16:14:45'),(139,'MAIN_MENU_STANDARD',3,'eldy_backoffice.php','chaine',0,'Module de gestion de la barre de menu du haut pour utilisateurs internes','2011-09-15 16:14:45'),(140,'MAIN_MENUFRONT_STANDARD',3,'eldy_frontoffice.php','chaine',0,'Module de gestion de la barre de menu du haut pour utilisateurs externes','2011-09-15 16:14:45'),(141,'MAIN_MENU_SMARTPHONE',3,'iphone_backoffice.php','chaine',0,'Module de gestion de la barre de menu smartphone pour utilisateurs internes','2011-09-15 16:14:45'),(142,'MAIN_MENUFRONT_SMARTPHONE',3,'iphone_frontoffice.php','chaine',0,'Module de gestion de la barre de menu smartphone pour utilisateurs externes','2011-09-15 16:14:45'),(143,'MAIN_THEME',3,'eldy','chaine',0,'Default theme','2011-09-15 16:14:45'),(144,'MAIN_DELAY_ACTIONS_TODO',3,'7','chaine',0,'Tolérance de retard avant alerte (en jours) sur actions planifiées non réalisées','2011-09-15 16:14:45'),(145,'MAIN_DELAY_ORDERS_TO_PROCESS',3,'2','chaine',0,'Tolérance de retard avant alerte (en jours) sur commandes clients non traitées','2011-09-15 16:14:45'),(146,'MAIN_DELAY_SUPPLIER_ORDERS_TO_PROCESS',3,'7','chaine',0,'Tolérance de retard avant alerte (en jours) sur commandes fournisseurs non traitées','2011-09-15 16:14:45'),(147,'MAIN_DELAY_PROPALS_TO_CLOSE',3,'31','chaine',0,'Tolérance de retard avant alerte (en jours) sur propales à cloturer','2011-09-15 16:14:45'),(148,'MAIN_DELAY_PROPALS_TO_BILL',3,'7','chaine',0,'Tolérance de retard avant alerte (en jours) sur propales non facturées','2011-09-15 16:14:45'),(149,'MAIN_DELAY_CUSTOMER_BILLS_UNPAYED',3,'31','chaine',0,'Tolérance de retard avant alerte (en jours) sur factures client impayées','2011-09-15 16:14:45'),(150,'MAIN_DELAY_SUPPLIER_BILLS_TO_PAY',3,'2','chaine',0,'Tolérance de retard avant alerte (en jours) sur factures fournisseur impayées','2011-09-15 16:14:45'),(151,'MAIN_DELAY_NOT_ACTIVATED_SERVICES',3,'0','chaine',0,'Tolérance de retard avant alerte (en jours) sur services à activer','2011-09-15 16:14:45'),(152,'MAIN_DELAY_RUNNING_SERVICES',3,'0','chaine',0,'Tolérance de retard avant alerte (en jours) sur services expirés','2011-09-15 16:14:45'),(153,'MAIN_DELAY_MEMBERS',3,'31','chaine',0,'Tolérance de retard avant alerte (en jours) sur cotisations adhérent en retard','2011-09-15 16:14:45'),(154,'MAIN_DELAY_TRANSACTIONS_TO_CONCILIATE',3,'62','chaine',0,'Tolérance de retard avant alerte (en jours) sur rapprochements bancaires à faire','2011-09-15 16:14:45'),(155,'SOCIETE_CODECLIENT_ADDON',3,'mod_codeclient_leopard','yesno',0,'Module to control third parties codes','2011-09-15 16:14:45'),(156,'SOCIETE_CODECOMPTA_ADDON',3,'mod_codecompta_panicum','yesno',0,'Module to control third parties codes','2011-09-15 16:14:45'),(157,'MAILING_EMAIL_FROM',3,'dolibarr@domain.com','chaine',0,'EMail emmetteur pour les envois d emailings','2011-09-15 16:14:45'),(158,'MULTICOMPANY_HIDE_LOGIN_COMBOBOX',1,'1','chaine',0,'','2011-09-15 16:14:55'),(159,'MULTICOMPANY_TRANSVERSE_MODE',1,'1','chaine',0,'','2011-09-15 16:14:57'),(160,'MAIN_USE_JQUERY_THEME',1,'bdp','',1,'','2011-09-15 16:17:00'),(176,'MAIN_LANG_DEFAULT',1,'fr_FR','chaine',0,'','2011-09-15 16:17:53'),(177,'MAIN_MULTILANGS',1,'0','chaine',0,'','2011-09-15 16:17:53'),(178,'MAIN_SIZE_LISTE_LIMIT',1,'25','chaine',0,'','2011-09-15 16:17:53'),(179,'MAIN_DISABLE_JAVASCRIPT',1,'0','chaine',0,'','2011-09-15 16:17:53'),(180,'MAIN_USE_PREVIEW_TABS',1,'0','chaine',0,'','2011-09-15 16:17:53'),(181,'MAIN_START_WEEK',1,'1','chaine',0,'','2011-09-15 16:17:53'),(182,'MAIN_SHOW_LOGO',1,'1','chaine',0,'','2011-09-15 16:17:53'),(183,'MAIN_FIRSTNAME_NAME_POSITION',1,'0','chaine',0,'','2011-09-15 16:17:53'),(184,'MAIN_THEME',1,'bdp','chaine',0,'','2011-09-15 16:17:53'),(185,'MAIN_SEARCHFORM_CONTACT',1,'1','chaine',0,'','2011-09-15 16:17:53'),(186,'MAIN_SEARCHFORM_SOCIETE',1,'1','chaine',0,'','2011-09-15 16:17:53'),(187,'MAIN_SEARCHFORM_PRODUITSERVICE',1,'1','chaine',0,'','2011-09-15 16:17:53'),(188,'MAIN_SEARCHFORM_ADHERENT',1,'0','chaine',0,'','2011-09-15 16:17:53'),(206,'MAIN_LANG_DEFAULT',2,'fr_FR','chaine',0,'','2011-09-22 13:13:59'),(207,'MAIN_MULTILANGS',2,'0','chaine',0,'','2011-09-22 13:13:59'),(208,'MAIN_SIZE_LISTE_LIMIT',2,'25','chaine',0,'','2011-09-22 13:13:59'),(209,'MAIN_DISABLE_JAVASCRIPT',2,'0','chaine',0,'','2011-09-22 13:13:59'),(210,'MAIN_USE_PREVIEW_TABS',2,'0','chaine',0,'','2011-09-22 13:13:59'),(211,'MAIN_START_WEEK',2,'1','chaine',0,'','2011-09-22 13:13:59'),(212,'MAIN_SHOW_LOGO',2,'0','chaine',0,'','2011-09-22 13:13:59'),(213,'MAIN_FIRSTNAME_NAME_POSITION',2,'0','chaine',0,'','2011-09-22 13:13:59'),(214,'MAIN_THEME',2,'bdp','chaine',0,'','2011-09-22 13:13:59'),(215,'MAIN_SEARCHFORM_CONTACT',2,'0','chaine',0,'','2011-09-22 13:13:59'),(216,'MAIN_SEARCHFORM_SOCIETE',2,'0','chaine',0,'','2011-09-22 13:13:59'),(217,'MAIN_SEARCHFORM_PRODUITSERVICE',2,'0','chaine',0,'','2011-09-22 13:13:59'),(218,'MAIN_SEARCHFORM_ADHERENT',2,'0','chaine',0,'','2011-09-22 13:13:59'),(219,'MAIN_HELPCENTER_DISABLELINK',0,'1','chaine',0,'','2011-09-22 13:13:59'),(220,'MAIN_HELP_DISABLELINK',0,'1','chaine',0,'','2011-09-22 13:13:59');
...
--
-- Table structure for table `llx_docgen_forms`
--

DROP TABLE IF EXISTS `llx_docgen_forms`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `llx_docgen_forms` (
  `rowid` int(11) NOT NULL AUTO_INCREMENT,
  `entity` int(11) NOT NULL DEFAULT '1',
  `fk_extrafields` int(11) DEFAULT NULL,
  ...
  PRIMARY KEY (`rowid`),
  UNIQUE KEY `uk_docgen_forms` (`label`,`entity`),
  KEY `fk_docgen_forms_fk_user_create` (`fk_user_create`),
  KEY `fk_docgen_forms_fk_user_modif` (`fk_user_modif`),
  CONSTRAINT `fk_docgen_forms_fk_user_create` FOREIGN KEY (`fk_user_create`) REFERENCES `llx_user` (`rowid`),
  CONSTRAINT `fk_docgen_forms_fk_user_modif` FOREIGN KEY (`fk_user_modif`) REFERENCES `llx_user` (`rowid`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `llx_docgen_forms`
--

LOCK TABLES `llx_docgen_forms` WRITE;
/*!40000 ALTER TABLE `llx_docgen_forms` DISABLE KEYS */;
/*!40000 ALTER TABLE `llx_docgen_forms` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `llx_docgen_target`
--

DROP TABLE IF EXISTS `llx_docgen_target`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `llx_docgen_target` (
  `rowid` int(11) NOT NULL AUTO_INCREMENT,
  `fk_docgen_forms` int(11) NOT NULL,
  `fk_element` int(11) NOT NULL,
  `elementtype` varchar(255) NOT NULL,
  `datec` datetime DEFAULT NULL,
  `fk_user_create` int(11) DEFAULT NULL,
  PRIMARY KEY (`rowid`),
  KEY `idx_docgen_target` (`fk_docgen_forms`),
  KEY `fk_docgen_target_fk_user_create` (`fk_user_create`),
  CONSTRAINT `fk_docgen_target_fk_docgen_forms` FOREIGN KEY (`fk_docgen_forms`) REFERENCES `llx_docgen_forms` (`rowid`),
  CONSTRAINT `fk_docgen_target_fk_user_create` FOREIGN KEY (`fk_user_create`) REFERENCES `llx_user` (`rowid`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `llx_docgen_target`
--

LOCK TABLES `llx_docgen_target` WRITE;
/*!40000 ALTER TABLE `llx_docgen_target` DISABLE KEYS */;
/*!40000 ALTER TABLE `llx_docgen_target` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `llx_dolibarr_modules` VALUES (0,1,1,'2011-09-15 18:09:59','dolibarr'),(1,1,1,'2011-09-15 18:11:41','dolibarr'),(30,1,1,'2011-09-15 18:11:41','dolibarr'),(50,1,1,'2011-09-15 18:11:47','dolibarr'),(53,1,1,'2011-09-15 18:11:37','dolibarr'),(2400,1,1,'2011-09-15 18:11:55','dolibarr'),(5000,1,1,'2011-09-15 18:11:25','3.2.0'),(11000,1,1,'2011-09-15 18:12:12','3.1'),(62000,1,1,'2011-09-15 18:12:07','dolibarr'),(62100,1,1,'2011-09-15 18:12:03','dolibarr'),(70000,1,1,'2011-09-15 18:12:15','1.0');
...
INSERT INTO `llx_entity` VALUES (1,'2011-09-15 16:11:25','Entit&eacute; ma&icirc;tre','Entit&eacute; ma&icirc;tre, ne peut pas &ecirc;tre supprim&eacute;e','2011-09-15 18:11:25',1,1,1),(2,'2011-09-15 16:14:33','Client 1','','2011-09-15 18:14:28',1,1,1),(3,'2011-09-15 16:14:50','Client2','','2011-09-15 18:14:45',1,1,1);
...
INSERT INTO `llx_menu` VALUES (1,'all',1,'agenda','top','agenda','1',0,NULL,NULL,100,'/comm/action/index.php','','Agenda','agenda',NULL,'$user->rights->agenda->myactions->read','$conf->agenda->enabled',2,'2011-09-15 16:11:55'),(2,'all',1,'agenda','left','agenda','0',1,NULL,NULL,100,'/comm/action/index.php?mainmenu=agenda&amp;leftmenu=agenda','','Actions','agenda',NULL,'$user->rights->agenda->myactions->read','$conf->agenda->enabled',2,'2011-09-15 16:11:55'),(3,'all',1,'agenda','left','agenda','0',2,NULL,NULL,101,'/comm/action/fiche.php?mainmenu=agenda&amp;leftmenu=agenda&amp;action=create','','NewAction','commercial',NULL,'($user->rights->agenda->myactions->create||$user->rights->agenda->allactions->create)','$conf->agenda->enabled',2,'2011-09-15 16:11:55'),(4,'all',1,'agenda','left','agenda','0',2,NULL,NULL,102,'/comm/action/index.php?mainmenu=agenda&amp;leftmenu=agenda','','Calendar','agenda',NULL,'$user->rights->agenda->myactions->read','$conf->agenda->enabled',2,'2011-09-15 16:11:55'),(5,'all',1,'agenda','left','agenda','0',4,NULL,NULL,103,'/comm/action/index.php?mainmenu=agenda&amp;leftmenu=agenda&amp;status=todo&amp;filter=mine','','MenuToDoMyActions','agenda',NULL,'$user->rights->agenda->myactions->read','$conf->agenda->enabled',2,'2011-09-15 16:11:55'),(6,'all',1,'agenda','left','agenda','0',4,NULL,NULL,104,'/comm/action/index.php?mainmenu=agenda&amp;leftmenu=agenda&amp;status=done&amp;filter=mine','','MenuDoneMyActions','agenda',NULL,'$user->rights->agenda->myactions->read','$conf->agenda->enabled',2,'2011-09-15 16:11:55'),(7,'all',1,'agenda','left','agenda','0',4,NULL,NULL,105,'/comm/action/index.php?mainmenu=agenda&amp;leftmenu=agenda&amp;status=todo','','MenuToDoActions','agenda',NULL,'$user->rights->agenda->allactions->read','$user->rights->agenda->allactions->read',2,'2011-09-15 16:11:55'),(8,'all',1,'agenda','left','agenda','0',4,NULL,NULL,106,'/comm/action/index.php?mainmenu=agenda&amp;leftmenu=agenda&amp;status=done','','MenuDoneActions','agenda',NULL,'$user->rights->agenda->allactions->read','$user->rights->agenda->allactions->read',2,'2011-09-15 16:11:55'),(9,'all',1,'agenda','left','agenda','0',2,NULL,NULL,112,'/comm/action/listactions.php?mainmenu=agenda&amp;leftmenu=agenda','','List','agenda',NULL,'$user->rights->agenda->myactions->read','$conf->agenda->enabled',2,'2011-09-15 16:11:55'),(10,'all',1,'agenda','left','agenda','0',9,NULL,NULL,113,'/comm/action/listactions.php?mainmenu=agenda&amp;leftmenu=agenda&amp;status=todo&amp;filter=mine','','MenuToDoMyActions','agenda',NULL,'$user->rights->agenda->myactions->read','$conf->agenda->enabled',2,'2011-09-15 16:11:55'),(11,'all',1,'agenda','left','agenda','0',9,NULL,NULL,114,'/comm/action/listactions.php?mainmenu=agenda&amp;leftmenu=agenda&amp;status=done&amp;filter=mine','','MenuDoneMyActions','agenda',NULL,'$user->rights->agenda->myactions->read','$conf->agenda->enabled',2,'2011-09-15 16:11:55'),(12,'all',1,'agenda','left','agenda','0',9,NULL,NULL,115,'/comm/action/listactions.php?mainmenu=agenda&amp;leftmenu=agenda&amp;status=todo','','MenuToDoActions','agenda',NULL,'$user->rights->agenda->allactions->read','$user->rights->agenda->allactions->read',2,'2011-09-15 16:11:55'),(13,'all',1,'agenda','left','agenda','0',9,NULL,NULL,116,'/comm/action/listactions.php?mainmenu=agenda&amp;leftmenu=agenda&amp;status=done','','MenuDoneActions','agenda',NULL,'$user->rights->agenda->allactions->read','$user->rights->agenda->allactions->read',2,'2011-09-15 16:11:55'),(14,'all',1,'agenda','left','agenda','0',2,NULL,NULL,120,'/comm/action/rapport/index.php?mainmenu=agenda&amp;leftmenu=agenda','','Reportings','agenda',NULL,'$user->rights->agenda->allactions->read','$conf->agenda->enabled',2,'2011-09-15 16:11:55'),(15,'all',1,'docgen','top','docgen','1',0,NULL,NULL,100,'/docgen/index.php','','Docgen','docgen@docgen',NULL,'$user->rights->docgen->read','$conf->docgen->enabled',0,'2011-09-15 16:12:07'),(16,'all',1,'docgen','left','docgen','0',15,NULL,NULL,101,'/docgen/index.php','','ModelsManagement','docgen@docgen',NULL,'$user->rights->docgen->read','1',0,'2011-09-15 16:12:07'),(17,'all',1,'docgen','left','docgen','0',16,NULL,NULL,102,'/docgen/models.php?action=create','','NewModel','docgen@docgen',NULL,'$user->rights->docgen->write','1',0,'2011-09-15 16:12:07'),(18,'all',1,'docgen','left','docgen','0',16,NULL,NULL,103,'/docgen/list.php','','ModelsList','docgen@docgen',NULL,'$user->rights->docgen->read','1',0,'2011-09-15 16:12:07'),(19,'all',1,'dropbox','top','dropbox','1',0,NULL,NULL,100,'/dropbox/document.php','','Dropbox','@dropbox',NULL,'$user->rights->dropbox->read','$conf->dropbox->enabled',0,'2011-09-15 16:12:15');
...
INSERT INTO `llx_rights_def` VALUES (11,'Lire les factures','facture',1,'lire',NULL,'a',1),(12,'Creer/modifier les factures','facture',1,'creer',NULL,'a',0),(13,'Dévalider les factures','facture',1,'invoice_advance','unvalidate','a',0),(14,'Valider les factures','facture',1,'valider',NULL,'a',0),(15,'Envoyer les factures par mail','facture',1,'invoice_advance','send','a',0),(16,'Emettre des paiements sur les factures','facture',1,'paiement',NULL,'a',0),(19,'Supprimer les factures','facture',1,'supprimer',NULL,'a',0),(31,'Lire les produits','produit',1,'lire',NULL,'r',1),(32,'Creer/modifier les produits','produit',1,'creer',NULL,'w',0),(34,'Supprimer les produits','produit',1,'supprimer',NULL,'d',0),(38,'Exporter les produits','produit',1,'export',NULL,'r',0),(121,'Lire les societes','societe',1,'lire',NULL,'r',1),(122,'Creer modifier les societes','societe',1,'creer',NULL,'w',0),(125,'Supprimer les societes','societe',1,'supprimer',NULL,'d',0),(126,'Exporter les societes','societe',1,'export',NULL,'r',0),(251,'Consulter les autres utilisateurs','user',1,'user','lire','r',0),(251,'Consulter les autres utilisateurs','user',2,'user','lire','r',0),(252,'Consulter les permissions des autres utilisateurs','user',1,'user_advance','readperms','r',0),(252,'Consulter les permissions des autres utilisateurs','user',2,'user_advance','readperms','r',0),(253,'Creer/modifier utilisateurs internes et externes','user',1,'user','creer','w',0),(253,'Creer/modifier utilisateurs internes et externes','user',2,'user','creer','w',0),(254,'Creer/modifier utilisateurs externes seulement','user',1,'user_advance','write','w',0),(254,'Creer/modifier utilisateurs externes seulement','user',2,'user_advance','write','w',0),(255,'Modifier le mot de passe des autres utilisateurs','user',1,'user','password','w',0),(255,'Modifier le mot de passe des autres utilisateurs','user',2,'user','password','w',0),(256,'Supprimer ou desactiver les autres utilisateurs','user',1,'user','supprimer','d',0),(256,'Supprimer ou desactiver les autres utilisateurs','user',2,'user','supprimer','d',0),(262,'Consulter tous les tiers par utilisateurs internes (sinon uniquement si contact commercial). Non effectif pour utilisateurs externes (tjs limités à eux-meme).','societe',1,'client','voir','r',1),(281,'Lire les contacts','societe',1,'contact','lire','r',1),(282,'Creer modifier les contacts','societe',1,'contact','creer','w',0),(283,'Supprimer les contacts','societe',1,'contact','supprimer','d',0),(286,'Exporter les contacts','societe',1,'contact','export','d',0),(341,'Consulter ses propres permissions','user',1,'self_advance','readperms','r',1),(341,'Consulter ses propres permissions','user',2,'self_advance','readperms','r',1),(342,'Creer/modifier ses propres infos utilisateur','user',1,'self','creer','w',1),(342,'Creer/modifier ses propres infos utilisateur','user',2,'self','creer','w',1),(343,'Modifier son propre mot de passe','user',1,'self','password','w',1),(343,'Modifier son propre mot de passe','user',2,'self','password','w',1),(344,'Modifier ses propres permissions','user',1,'self_advance','writeperms','w',1),(344,'Modifier ses propres permissions','user',2,'self_advance','writeperms','w',1),(351,'Consulter les groupes','user',1,'group_advance','read','r',0),(351,'Consulter les groupes','user',2,'group_advance','read','r',0),(352,'Consulter les permissions des groupes','user',1,'group_advance','readperms','r',0),(352,'Consulter les permissions des groupes','user',2,'group_advance','readperms','r',0),(353,'Creer/modifier les groupes et leurs permissions','user',1,'group_advance','write','w',0),(353,'Creer/modifier les groupes et leurs permissions','user',2,'group_advance','write','w',0),(354,'Supprimer ou desactiver les groupes','user',1,'group_advance','delete','d',0),(354,'Supprimer ou desactiver les groupes','user',2,'group_advance','delete','d',0),(358,'Exporter les utilisateurs','user',1,'user','export','r',0),(358,'Exporter les utilisateurs','user',2,'user','export','r',0),(531,'Lire les services','service',1,'lire',NULL,'r',1),(532,'Creer/modifier les services','service',1,'creer',NULL,'w',0),(534,'Supprimer les services','service',1,'supprimer',NULL,'d',0),(538,'Exporter les services','service',1,'export',NULL,'r',0),(1321,'Exporter les factures clients, attributs et reglements','facture',1,'facture','export','r',0),(2401,'Read actions/tasks linked to his account','agenda',1,'myactions','read','r',1),(2402,'Create/modify actions/tasks linked to his account','agenda',1,'myactions','create','w',0),(2403,'Delete actions/tasks linked to his account','agenda',1,'myactions','delete','w',0),(2411,'Read actions/tasks of others','agenda',1,'allactions','read','r',0),(2412,'Create/modify actions/tasks of others','agenda',1,'allactions','create','w',0),(2413,'Delete actions/tasks of others','agenda',1,'allactions','delete','w',0),(5001,'Consulter les infos société','multicompany',1,'read',NULL,'r',1),(5001,'Consulter les infos société','multicompany',2,'read',NULL,'r',1),(5002,'Modifier la fiche société','multicompany',1,'write',NULL,'w',0),(5002,'Modifier la fiche société','multicompany',2,'write',NULL,'w',0),(62001,'Read documents','docgen',1,'read',NULL,'r',1),(62002,'Create/edit documents','docgen',1,'write',NULL,'w',0),(62003,'Delete documents','docgen',1,'delete',NULL,'w',0),(62101,'Read extrafields','extrafields',1,'read',NULL,'r',1),(62102,'Create/edit extrafields','extrafields',1,'write',NULL,'w',0),(62103,'Delete extrafields','extrafields',1,'delete',NULL,'w',0),(70001,'Read Dropbox directories','dropbox',1,'read',NULL,'r',0);
...
CREATE TABLE `llx_societe` (
  ...
  `description` text,
  `fk_stcomm` smallint(6) NOT NULL DEFAULT '0',
  `note` text,
...
INSERT INTO `llx_societe` VALUES (1,'Lady Gaga',1,NULL,NULL,0,NULL,'2011-09-15 16:12:54','2011-09-15 18:12:54','2011-09-15 18:12:54',1,NULL,NULL,NULL,NULL,'',NULL,NULL,0,1,NULL,NULL,NULL,NULL,0,NULL,0,NULL,0,'','','','','',0,NULL,0,NULL,0,NULL,3,0,NULL,NULL,0,0,0,1,1,0,NULL,NULL,1,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,0,0);
...
INSERT INTO `llx_societe_commerciaux` VALUES (1,1,1);
...
INSERT INTO `llx_user` VALUES (1,0,NULL,NULL,'2011-09-15 18:09:59','2011-09-15 19:50:15','adminbdp','adminbdp','414c08875ce496ccede16489c19c5d2f',NULL,NULL,'admin','admin','','','','','',1,'','','',1,1,NULL,NULL,NULL,'','2011-09-27 09:54:54','2011-09-22 15:13:11',NULL,'',NULL,1,NULL,NULL),(2,1,NULL,NULL,'2011-09-15 18:15:52','2011-09-15 19:52:27','User1','toto','f71dbe52628a3f83a77ab494817525c6',NULL,NULL,'User1','User1','','','','','',0,'','','',1,1,NULL,NULL,NULL,'','2011-09-15 21:52:39',NULL,NULL,'',NULL,1,NULL,NULL);
...
INSERT INTO `llx_user_rights` VALUES (48,1,11),(41,1,12),(42,1,13),(44,1,14),(45,1,15),(47,1,16),(49,1,19),(71,1,31),(68,1,32),(70,1,34),(72,1,38),(56,1,121),(53,1,122),(55,1,125),(57,1,126),(30,1,161),(25,1,162),(27,1,163),(29,1,164),(31,1,165),(58,1,262),(64,1,281),(61,1,282),(63,1,283),(65,1,286),(1,1,341),(2,1,342),(3,1,343),(4,1,344),(37,1,531),(34,1,532),(36,1,534),(38,1,538),(50,1,1321),(76,1,2401),(75,1,2402),(77,1,2403),(81,1,2411),(80,1,2412),(82,1,2413),(21,1,5001),(22,1,5002),(91,1,62001),(90,1,62002),(92,1,62003),(86,1,62101),(85,1,62102),(87,1,62103),(93,1,70001),(94,2,11),(95,2,31),(96,2,121),(97,2,262),(98,2,281),(99,2,341),(100,2,342),(101,2,343),(102,2,344),(103,2,531),(104,2,2401),(105,2,5001),(106,2,62001),(107,2,62101);
...
INSERT INTO `llx_usergroup` VALUES (1,'Gestionnaires',1,'2011-09-15 18:15:13','2011-09-15 16:15:13','');
...
INSERT INTO `llx_usergroup_user` VALUES (1,2,2,1);
...
-- Dump completed on 2011-09-27 10:36:53
